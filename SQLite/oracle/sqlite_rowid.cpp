...
bool SQL_ROWID::is_oracle_valid_stmt_2(const string& query){
    if (
        ((findStringIter(query, "CREATE TABLE") - query.begin()) < 5 ) ||
...
void SQL_ROWID::rewrite_valid_stmt_from_ori(string& query, string& rew_1, string& rew_2, string& rew_3, unsigned multi_run_id)
{
    rew_1 = "";
    rew_2 = "";
    rew_3 = "";
