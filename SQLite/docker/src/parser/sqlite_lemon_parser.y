...
A = new IR(kTypename, OP3("", "ID|STRING", ""), (IR*)B);
root_ir = (IR*)(A);
}
...
A = new IR(kCcons, OP3("DEFAULT", "ID|INDEXED", ""), (IR*)C);
root_ir = (IR*)(A);
}
...
A = new IR(kExpr, OP3("", "COLLATE ID|STRING", ""), (IR*)B);
root_ir = (IR*)(A);
}
...
A = new IR(kExpr, OP3("ID|INDEXED LP", "", "RP"), (IR*)D, (IR*)E);
root_ir = (IR*)(A);
}
...
A = new IR(kUnknown, OP3("ID|INDEXED LP", "", "RP"), (IR*)D, (IR*)E);
A = new IR(kExpr, OP3("", "", ""), (IR*)A, (IR*)G);
root_ir = (IR*)(A);
}

expr(A) ::= ID|INDEXED LP STAR RP filter_over(F) . {
A = new IR(kExpr, OP3("ID|INDEXED LP STAR RP", "", ""), (IR*)F);
root_ir = (IR*)(A);
}
