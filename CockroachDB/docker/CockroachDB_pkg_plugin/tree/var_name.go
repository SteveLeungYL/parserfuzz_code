...
func (node UnqualifiedStar) LogCurrentNode(depth int) *SQLRightIR {
...
// SQLRight Code Injection.
func (node *ColumnItem) LogCurrentNode(depth int) *SQLRightIR {
