...
const (
	...
	TypeIdentifier
	TypeAlterChangeFeed
	TypeAlterChangefeedCmds
	TypeAlterChangefeedAddTarget
	TypeChangefeedTargets
	TypeKVOptions
	TypeKVOption
	TypeAlterChangefeedDropTarget
	TypeAlterChangefeedSetOptions
	TypeAlterChangefeedUnsetOptions
	TypeNameList
	TypeAlterBackup
	TypeAlterBackupCmds
	TypeAlterBackupKMS
	TypeBackupKMS
	TypeStringOrPlaceholderOptList
	TypeAlterBackupSchedule
	TypeAlterBackupScheduleCmds
	TypeAlterBackupScheduleSetLabel
	TypeAlterBackupScheduleSetInto
	TypeAlterBackupScheduleSetWith
	TypeAlterBackupScheduleSetRecurring
	TypeAlterBackupScheduleSetFullBackup
	TypeAlterBackupScheduleSetScheduleOption
	TypeOptIfExists
	TypeOptIfNotExists
	TypeAlterIndex
	TypeAlterIndexCmds
	TypeAlterIndexPartitionBy
	TypeAlterIndexVisible
	TypeAlterDatabaseOwner
	TypeAlterDatabaseAddRegion
	TypeAlterDatabaseDropRegion
	TypeAlterDatabaseSurvivalGoal
	TypeSurvivalGoal
	TypeAlterDatabasePlacement
	TypeDataPlacement
	TypeAlterDatabaseAddSuperRegion
	TypeAlterDatabaseDropSuperRegion
	TypeAlterDatabaseAlterSuperRegion
	TypeAlterDatabaseSecondaryRegion
	TypeAlterDatabaseDropSecondaryRegion
	TypeAlterDatabaseSetZoneConfigExtension
	TypeOptForRole
	TypeAlterDefaultPrivileges
	TypeRoleSpecList
	TypeRoleSpec
	TypeRoleSpecType
	TypeObjectNamePrefixList
	TypeObjectNamePrefix
	TypeGrantTarget
	TypeAbbreviatedGrant
	TypeAbbreviatedRevoke
	TypeFunctionOptions
	TypeFuncObj
	TypeFuncArgs
	TypeFuncArg
	...
	TypeStringLiteral
	TypeOptDefaultValue
	TypeFunctionNullInputBehavior
	TypeFunctionVolatility
	TypeFunctionLeakproof
	TypeFunctionLanguage
	TypeFunctionBodyStr
	TypeAlterFunctionRename
	TypeAlterFunctionSetSchema
	TypeAlterFunctionDepExtension
	TypeAlterSchema
	TypeAlterSchemaRename
	TypeAlterSchemaOwner
	TypeAlterTable
	TypeAlterTableAddColumn
	TypeAlterTableAddConstraint
	TypeResolvableTypeReference
	TypeUsingCluster
	TypeAlterTableAlterPrimaryKey
	TypeAlterTableDropColumn
	TypeAlterTableDropConstraint
	TypeAlterTableValidateConstraint
	TypeAlterTableRenameColumn
	TypeAlterTableRenameConstraint
	TypeAlterTableSetDefault
	TypeAlterTableSetOnUpdate
	TypeOptNot
	TypeAlterTableSetNotNull
	TypeAlterTableDropNotNull
	TypeAlterTableDropStored
	TypeAlterTablePartitionByTable
	TypeAlterTableSetAudit
	TypeAuditMode
	TypeAlterTableInjectStats
	TypeAlterTableSetStorageParams
	TypeAlterTableResetStorageParams
	TypeAlterTableLocality
	TypeAlterTableSetSchema
	TypeAlterTableOwner
	TypeLocality
	TypeCreateDatabase
	TypeIndexElem
	...
	TypeDefaultExpr
	TypeOnUpdateExpr
	TypeGeneratedIdentity
	TypeReferenceCluster
	TypeColumnTableDef
	TypeIndexTableDef
	TypeUniqueConstraintTableDef
	TypeOptTableDefs
	TypeCreateTable
	TypeCreateSchema
	TypeCreateSequence
	...
	TypeOptMaterialized
	TypeCreateView
	TypeRefreshMaterializedView
	TypeCreateStats
	TypeFloatLiteral
	TypeCreateStatsOptions
	TypeCreateExtension
	TypeCreateExternalConnection
	TypeLabelSpec
	TypeRecurrence
	TypeScheduledBackup
	TypeBackup
	...
	TypeBackupOptions
	TypeRestoreOptions
	TypeBackupTargetList
	TypeAsOfClause
	TypeTenantID
	TypeTablePatterns
	TypeAllTablesSelector
	TypeUnresolvedName
	TypeTenantAllOrID
	TypeAlterTenantSetClusterSetting
	TypeShowTenantClusterSetting
	TypeShowTenantClusterSettingList
	TypeSetVar
	TypeSetClusterSetting
	TypeSetTransaction
	TypeSetSessionAuthorizationDefault
	TypeSetSessionCharacteristics
	TypeSetTracing
	TypeOptIsolationLevel
	TypeUserPriority
	TypeReadWriteMode
	TypeDeferrable
	TypeTransactionModes
	TypeBeginTransaction
	TypeCommitTransaction
	TypeRollbackTransaction
	TypeSavepoint
	TypeReleaseSavepoint
	TypeRollbackToSavepoint
	TypeShowVar
	TypeShowClusterSetting
	TypeShowClusterSettingList
	TypeShowBackup
	TypeShowColumns
	TypeShowDatabases
	TypeShowEnums
	TypeShowTypes
	TypeShowTraceForSession
	TypeShowIndexes
	TypeShowDatabaseIndexes
	TypeShowQueries
	TypeShowJobs
	TypeShowChangefeedJobs
	TypeShowSurvivalGoal
	TypeShowRegions
	TypeShowSessions
	TypeShowSchemas
	TypeShowSequences
	TypeShowTables
	TypeShowTransactions
	TypeShowConstraints
	TypeShowGrants
	TypeShowRoleGrants
	TypeShowCreate
	TypeShowCreateAllSchemas
	TypeShowCreateAllTables
	TypeShowCreateAllTypes
	TypeShowCreateSchedules
	TypeShowSyntax
	TypeShowTransactionStatus
	TypeShowLastQueryStatistics
	TypeShowFullTableScans
	TypeShowSavepointStatus
	TypeShowUsers
	TypeShowRoles
	TypeShowRanges
	TypeShowRangeForRow
	TypeShowFingerprints
	TypeShowTableStats
	TypeShowHistogram
	TypeShowPartitions
	TypeScheduleState
	TypeShowSchedules
	TypeShowDefaultPrivileges
	TypeShowTransferState
	TypeShowCompletions
	TypeShowCreateFunction
	TypeShowCreateExternalConnections
	TypeGrantTargetList
	TypeGrant
	TypeGrantRole
	TypeFuncObjs
	...
	TypeIsNotNullExpr
	TypeParenExpr
	TypeExprFmtWithParen
	TypeBinExprFmtWithParenAndSubOp
	...
	TypeCastExpr
	TypeIndirectionExpr
	TypeAnnotateTypeExpr
	TypeCollateExpr
	TypeColumnAccessExpr
	TypeSelect
	TypeParenSelect
	TypeSelectClause
	TypeOptDistinct
	...
	TypeWindow
	TypeWindowDef
	TypeWindowFrameBound
	TypeWindowFrameMode
	TypeWindowFrameExclusion
	TypeWindowFrame
	TypeLockingClause
	TypeTableNames
	TypeWaitPolicy
	TypeLockingItem
	TypeLockingStrength
	TypeLockingWaitPolicy
	TypeWith
	TypeOptRecursive
	TypeCTECluster
	TypeAlterType
	TypeAlterTypeAddValue
	TypeAlterTypeRenameValue
	TypeAlterTypeDropValue
	TypeAlterTypeRename
	TypeAlterTypeSetSchema
	TypeAlterTypeOwner
	TypeAlterRole
	TypeAlterRoleSet
	TypeAlterSequence
	...
	TypeCancelQueries
	TypeCancelSessions
	TypeControlSchedules
	TypeControlJobsOfType
	TypeControlJobsForSchedules
	TypePrepare
	TypeCannedOptPlan
	TypeOptDiscardRows
	TypeExecute
	...
	TypeCloseCursor
	TypeCommentOnColumn
	TypeCommentOnConstraint
	TypeCommentOnDatabase
	TypeCommentOnSchema
	TypeCommentOnIndex
	TypeCommentOnTable
	TypeTableIndexName
	...
	TypeCopyFormat
	TypeCopyOptions
	TypeCreateChangefeed
	TypeChangefeedTarget
	TypeCreateFunction
	TypeRoutineReturn
	TypeDelete
	TypeReturningExprs
	TypeReturningNothing
	TypeNoReturningClause
	TypeDropBehavior
	TypeDropDatabase
	TypeDropIndex
	TypeDropTable
	...
	TypeScrub
	TypeScrubOptions
	TypeScrubOptionIndex
	TypeScrubOptionPhysical
	TypeScrubOptionConstraint
	TypeZoneSpecifier
	TypeShowZoneConfig
	TypeSetZoneConfig
	TypeZoneConfigSettings
	TypeStreamIngestion
	TypeTruncate
	TypeUnionClause
	TypeInsert
	TypeImport
	TypeValuesClause
	TypeLiteralValuesClause
	TypeUpdate
	TypeUpdateExprs
	TypeUpdateExpr
	TypeReferenceActions
	TypeForeignKeyConstraintTableDef
	TypeMatching
	TypeCheckConstraintTableDef
	TypeFamilyTableDef
	TypeDArray
	TypedNull
	TypeDTuple
...
type SQLRightInterface interface {
	...
	LogCurrentNode(depth int) *SQLRightIR
}
...
type Statement interface {
	...
	// SQLRight inject code in CockroachDB golang.
	SQLRightInterface
