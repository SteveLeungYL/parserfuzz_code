...
SELECT * FROM y;
WITH t AS (    SELECT FROM y    WHERE a <= 10 )SELECT * FROM t;
SELECT * FROM y;
...
SELECT * FROM bug6051;
WITH t1 AS ( SELECT FROM bug6051 )INSERT INTO bug6051 SELECT * FROM t1;
SELECT * FROM bug6051;
CREATE TEMP TABLE bug6051_2 (i int);
CREATE RULE bug6051_ins AS ON INSERT TO bug6051 DO INSTEAD INSERT INTO bug6051_2 SELECT NEW.i;
WITH t1 AS (SELECT * FROM v0)INSERT INTO bug6051 SELECT * FROM t1;
SELECT * FROM bug6051;
...
SELECT * FROM y;
WITH t AS ( SELECT * FROM v9)INSERT INTO y SELECT -a FROM t RETURNING *;
SELECT * FROM y;
...
SELECT * FROM parent;
WITH wcte AS ( INSERT INTO int8_tbl VALUES ( 42, 47 ) RETURNING q2 )DELETE FROM a USING wcte WHERE aa = q2;
