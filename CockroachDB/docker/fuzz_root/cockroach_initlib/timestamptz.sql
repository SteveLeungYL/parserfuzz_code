...
SELECT '4714-11-23 23:59:59+00 BC'::timestamptz;
  SELECT '' AS "48", d1 FROM TIMESTAMPTZ_TBL   WHERE d1 > timestamp with time zone '1997-01-02';
  SELECT '' AS "48", d1 FROM TIMESTAMPTZ_TBL   WHERE d1 > timestamp with time zone '1997-01-02';
...
SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'Australia/Sydney') as sydney_trunc;
  SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'GMT') as gmt_trunc;
  SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'VET') as vet_trunc;
  SELECT '' AS "54", d1 - timestamp with time zone '1997-01-02' AS diff  FROM TIMESTAMPTZ_TBL  WHERE d1 BETWEEN timestamp with time zone '1902-01-01' AND timestamp with time zone '2038-01-01';
  SELECT '' AS "54", d1 - timestamp with time zone '1997-01-02' AS diff  FROM TIMESTAMPTZ_TBL  WHERE d1 BETWEEN timestamp with time zone '1902-01-01' AND timestamp with time zone '2038-01-01';
