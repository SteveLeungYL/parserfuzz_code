...
GRANT SELECT ON atest12sbv TO PUBLIC;
 ...
 SELECT * FROM atest12 x, atest12 y  WHERE x.a = y.b and abs(y.a) <<< 5;
...
CREATE OPERATOR >>> (procedure = leak2, leftarg = integer, rightarg = integer,                     restrict = scalargtsel);
 ...
 SELECT * FROM atest12v x, atest12v y WHERE x.a = y.b;
 SELECT * FROM atest12sbv x, atest12sbv y WHERE x.a = y.b;
 SELECT * FROM atest12v x, atest12v y  WHERE x.a = y.b and abs(y.a) <<< 5;
 SELECT * FROM atest12sbv x, atest12sbv y  WHERE x.a = y.b and abs(y.a) <<< 5;
SET SESSION AUTHORIZATION regress_priv_user1;
