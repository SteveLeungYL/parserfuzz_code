...
create table lparted_by_int2_16384 partition of lparted_by_int2 for values in (16384);
 select * from lparted_by_int2 where a = 100000000000000;
create table rparted_by_int2 (a smallint) partition by range (a);
create table rparted_by_int2_1 partition of rparted_by_int2 for values from (1) to (10);
create table rparted_by_int2_16384 partition of rparted_by_int2 for values from (10) to (16384);
 select * from rparted_by_int2 where a > 100000000000000;
...
begin    for ln in        execute format(' %s',             1)    loop        ln := regexp_replace(ln, 'Workers Launched: \d+', 'Workers Launched: N');
...
select * from stable_qual_pruning  where a = any(array['2010-02-01', '2020-01-01']::timestamp[]);
select * from stable_qual_pruning  where a = any(array['2000-02-01', '2010-01-01']::timestamp[]);
select * from stable_qual_pruning  where a = any(array['2000-02-01', localtimestamp]::timestamp[]);
select * from stable_qual_pruning  where a = any(array['2010-02-01', '2020-01-01']::timestamptz[]);
select * from stable_qual_pruning  where a = any(array['2000-02-01', '2010-01-01']::timestamptz[]);
select * from stable_qual_pruning  where a = any(null::timestamptz[]);
...
create table hp_prefix_test_p2 partition of hp_prefix_test for values with (modulus 2, remainder 1);
 select * from hp_prefix_test where a = 1 and b is null and c = 1 and d = 1;
