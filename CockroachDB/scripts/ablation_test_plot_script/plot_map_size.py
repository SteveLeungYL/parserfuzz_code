...
def plot_sql_mapsize(file_name, markevery, line_style, is_downsampling = True):
    ...
    for i in [0]:
        ...
        for cur_map in file['map_size']:
            cur_map = cur_map[:-1]
            cur_map = 262.0 / 100.0 * float(cur_map)
...
plot_sql_mapsize("./parserfuzz/plot_data_0", markevery = 20, line_style = 0)
plot_sql_mapsize("./parserfuzz_nofav/plot_data_0", markevery = 20, line_style = 1)
plot_sql_mapsize("./parserfuzz_nofavnomab/plot_data_0", markevery = 20, line_style = 2)
plot_sql_mapsize("./parserfuzz_nofavnomabnoacc/plot_data_0", markevery = 20, line_style = 3)
plot_sql_mapsize("./parserfuzz_nofavnomabnoaccnocat/plot_data_0", markevery = 20, line_style = 4)
...
plt.ylabel('Code Branch Coverage (k)', fontsize = 20)
