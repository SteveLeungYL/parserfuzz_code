...
internal_error_bug_patterns = [
        ...
        "timestamptz, expected timestamp",
        "invalid var index",
        "index out of range",
...
sample_bug_number_gen_time_file("./parserfuzz")
sample_bug_number_gen_time_file("./parserfuzz_nofav")
sample_bug_number_gen_time_file("./parserfuzz_nofavnomab")
sample_bug_number_gen_time_file("./parserfuzz_nofavnomabnoacc")
sample_bug_number_gen_time_file("./parserfuzz_nofavnomabnoaccnocat")

plot_sql_bugs("./parserfuzz", markevery=20, line_style=0)
plot_sql_bugs("./parserfuzz_nofav", markevery=20, line_style=1)
plot_sql_bugs("./parserfuzz_nofavnomab", markevery=20, line_style=2)
plot_sql_bugs("./parserfuzz_nofavnomabnoacc", markevery=20, line_style=3)
plot_sql_bugs("./parserfuzz_nofavnomabnoaccnocat", markevery=20, line_style=4)
...
plt.legend(['ParserFuzz', 'ParserFuzz_noFav', 'ParserFuzz_noFavNoMab', 'ParserFuzz_noFavNoMabNoAcc', 'ParserFuzz_noFavNoMabNoAccNoCat'], fontsize=13, loc=4)
