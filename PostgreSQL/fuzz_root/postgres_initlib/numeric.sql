...
INSERT INTO fract_only VALUES (3, '1.0');	INSERT INTO fract_only VALUES (4, '-0.9999');
INSERT INTO fract_only VALUES (5, '0.99994');
INSERT INTO fract_only VALUES (6, '0.99995');  INSERT INTO fract_only VALUES (7, '0.00001');
...
-5.2-0.00000000010.00000000000111.9999999999999922.00000000000001344.555.567899.999999999999991010.0000000000001\.UPDATE width_bucket_test SET operand_f8 = operand_num::float8;
...
SELECT width_bucket(0.0::float8, 'Infinity'::float8, 5, 10); SELECT width_bucket(0.0::float8, 5, '-Infinity'::float8, 20); SELECT width_bucket('Infinity'::float8, 1, 10, 10),       width_bucket('-Infinity'::float8, 1, 10, 10);
...
select min_scale(numeric 'NaN') is NULL; select min_scale(0);                     select min_scale(0.00);                  select min_scale(1.0);                   select min_scale(1.1);                   select min_scale(1.12);                  select min_scale(1.123);                 select min_scale(1.1234);                select min_scale(1.12345);               select min_scale(1.1000);                select min_scale(1e100);                 select trim_scale(numeric 'NaN');
...
SELECT SUM((-9999)::numeric) FROM generate_series(1, 100000);
SELECT a, b, gcd(a, b), gcd(a, -b), gcd(-b, a), gcd(-b, -a)FROM (VALUES (0::numeric, 0::numeric),             (0::numeric, numeric 'NaN'),             (0::numeric, 46375::numeric),             (433125::numeric, 46375::numeric),             (43312.5::numeric, 4637.5::numeric),             (4331.250::numeric, 463.75000::numeric)) AS v(a, b);
SELECT a,b, lcm(a, b), lcm(a, -b), lcm(-b, a), lcm(-b, -a)FROM (VALUES (0::numeric, 0::numeric),             (0::numeric, numeric 'NaN'),             (0::numeric, 13272::numeric),             (13272::numeric, 13272::numeric),             (423282::numeric, 13272::numeric),             (42328.2::numeric, 1327.2::numeric),             (4232.820::numeric, 132.72000::numeric)) AS v(a, b);
