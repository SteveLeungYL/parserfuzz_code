...
ALTER TABLE articles DROP CONSTRAINT articles_pkey RESTRICT; ALTER TABLE articles_in_category DROP CONSTRAINT articles_in_category_pkey RESTRICT; DROP VIEW fdv2;
...
ALTER TABLE articles DROP CONSTRAINT articles_pkey RESTRICT; DROP VIEW fdv3;
CREATE TEMP VIEW fdv4 ASSELECT * FROM articles WHERE title IN (SELECT title FROM articles GROUP BY id);
ALTER TABLE articles DROP CONSTRAINT articles_pkey RESTRICT; DROP VIEW fdv4;
