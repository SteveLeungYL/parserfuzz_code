...
CREATE USER regress_priv_user5;	CREATE GROUP regress_priv_group1;
CREATE GROUP regress_priv_group2 WITH USER regress_priv_user1, regress_priv_user2;
ALTER GROUP regress_priv_group1 ADD USER regress_priv_user4;
ALTER GROUP regress_priv_group2 ADD USER regress_priv_user2;	ALTER GROUP regress_priv_group2 DROP USER regress_priv_user2;
...
SELECT session_user, current_user;
SELECT * FROM atest1; SELECT * FROM atest2; INSERT INTO atest1 VALUES (2, 'two'); INSERT INTO atest2 VALUES ('foo', true); INSERT INTO atest1 SELECT 1, b FROM atest1; UPDATE atest1 SET a = 1 WHERE a = 2; UPDATE atest2 SET col2 = NOT col2; SELECT * FROM atest1 FOR UPDATE; SELECT * FROM atest2 FOR UPDATE; DELETE FROM atest2; TRUNCATE atest2; BEGIN;
LOCK atest2 IN ACCESS EXCLUSIVE MODE; COMMIT;
COPY atest2 FROM stdin; GRANT ALL ON atest1 TO PUBLIC; SELECT * FROM atest1 WHERE ( b IN ( SELECT col1 FROM atest2 ) );
SELECT * FROM atest2 WHERE ( col1 IN ( SELECT b FROM atest1 ) );
SET SESSION AUTHORIZATION regress_priv_user3;
SELECT session_user, current_user;
SELECT * FROM atest1; SELECT * FROM atest2; INSERT INTO atest1 VALUES (2, 'two'); INSERT INTO atest2 VALUES ('foo', true); INSERT INTO atest1 SELECT 1, b FROM atest1; UPDATE atest1 SET a = 1 WHERE a = 2; UPDATE atest2 SET col2 = NULL; UPDATE atest2 SET col2 = NOT col2; UPDATE atest2 SET col2 = true FROM atest1 WHERE atest1.a = 5; SELECT * FROM atest1 FOR UPDATE; SELECT * FROM atest2 FOR UPDATE; DELETE FROM atest2; TRUNCATE atest2; BEGIN;
LOCK atest2 IN ACCESS EXCLUSIVE MODE; COMMIT;
COPY atest2 FROM stdin; SELECT * FROM atest1 WHERE ( b IN ( SELECT col1 FROM atest2 ) );
SELECT * FROM atest2 WHERE ( col1 IN ( SELECT b FROM atest1 ) );
SET SESSION AUTHORIZATION regress_priv_user4;
COPY atest2 FROM stdin; bar	true\.SELECT * FROM atest1; SET SESSION AUTHORIZATION regress_priv_user1;
...
SET SESSION AUTHORIZATION regress_priv_user1;
SELECT * FROM atest3; DELETE FROM atest3; BEGIN;
...
ROLLBACK;
SET SESSION AUTHORIZATION regress_priv_user3;
CREATE VIEW atestv1 AS SELECT * FROM atest1; CREATE VIEW atestv2 AS SELECT * FROM atest2;
CREATE VIEW atestv3 AS SELECT * FROM atest3; CREATE VIEW atestv0 AS SELECT 0 as x WHERE false; SELECT * FROM atestv1; SELECT * FROM atestv2; GRANT SELECT ON atestv1, atestv3 TO regress_priv_user4;
GRANT SELECT ON atestv2 TO regress_priv_user2;
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT * FROM atestv1; SELECT * FROM atestv2; SELECT * FROM atestv3; SELECT * FROM atestv0; select * from  ((select a.q1 as x from int8_tbl a offset 0)   union all   (select b.q2 as x from int8_tbl b offset 0)) sswhere false;
...
CREATE VIEW atestv4 AS SELECT * FROM atestv3; SELECT * FROM atestv4; GRANT SELECT ON atestv4 TO regress_priv_user2;
SET SESSION AUTHORIZATION regress_priv_user2;
SELECT * FROM atestv3; SELECT * FROM atestv4; SELECT * FROM atest2; SELECT * FROM atestv2; SET SESSION AUTHORIZATION regress_priv_user1;
...
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT * FROM atest5; SELECT one FROM atest5; COPY atest5 (one) TO stdout; SELECT two FROM atest5; COPY atest5 (two) TO stdout; SELECT atest5 FROM atest5; COPY atest5 (one,two) TO stdout; SELECT 1 FROM atest5; SELECT 1 FROM atest5 a JOIN atest5 b USING (one); SELECT 1 FROM atest5 a JOIN atest5 b USING (two); SELECT 1 FROM atest5 a NATURAL JOIN atest5 b; SELECT * FROM (atest5 a JOIN atest5 b USING (one)) j; SELECT j.* FROM (atest5 a JOIN atest5 b USING (one)) j; SELECT (j.*) IS NULL FROM (atest5 a JOIN atest5 b USING (one)) j; SELECT one FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT j.one FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT two FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT j.two FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT y FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT j.y FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)) j; SELECT * FROM (atest5 a JOIN atest5 b USING (one)); SELECT a.* FROM (atest5 a JOIN atest5 b USING (one)); SELECT (a.*) IS NULL FROM (atest5 a JOIN atest5 b USING (one)); SELECT two FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)); SELECT a.two FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)); SELECT y FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)); SELECT b.y FROM (atest5 a JOIN atest5 b(one,x,y,z) USING (one)); SELECT y FROM (atest5 a LEFT JOIN atest5 b(one,x,y,z) USING (one)); SELECT b.y FROM (atest5 a LEFT JOIN atest5 b(one,x,y,z) USING (one)); SELECT y FROM (atest5 a FULL JOIN atest5 b(one,x,y,z) USING (one)); SELECT b.y FROM (atest5 a FULL JOIN atest5 b(one,x,y,z) USING (one)); SELECT 1 FROM atest5 WHERE two = 2; SELECT * FROM atest1, atest5; SELECT atest1.* FROM atest1, atest5; SELECT atest1.*,atest5.one FROM atest1, atest5; SELECT atest1.*,atest5.one FROM atest1 JOIN atest5 ON (atest1.a = atest5.two); SELECT atest1.*,atest5.one FROM atest1 JOIN atest5 ON (atest1.a = atest5.one); SELECT one, two FROM atest5; SET SESSION AUTHORIZATION regress_priv_user1;
GRANT SELECT (one,two) ON atest6 TO regress_priv_user4;
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT one, two FROM atest5 NATURAL JOIN atest6; SET SESSION AUTHORIZATION regress_priv_user1;
GRANT SELECT (two) ON atest5 TO regress_priv_user4;
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT one, two FROM atest5 NATURAL JOIN atest6; INSERT INTO atest5 (two) VALUES (3); COPY atest5 FROM stdin; COPY atest5 (two) FROM stdin; 1\.INSERT INTO atest5 (three) VALUES (4); INSERT INTO atest5 VALUES (5,5,5); UPDATE atest5 SET three = 10; UPDATE atest5 SET one = 8; UPDATE atest5 SET three = 5, one = 2; INSERT INTO atest5(two) VALUES (6) ON CONFLICT (two) DO UPDATE set three = 10;
...
INSERT INTO atest5(two) VALUES (6) ON CONFLICT (two) DO UPDATE set one = 8; INSERT INTO atest5(three) VALUES (4) ON CONFLICT (two) DO UPDATE set three = 10; INSERT INTO atest5(four) VALUES (4); SET SESSION AUTHORIZATION regress_priv_user1;
GRANT INSERT (four) ON atest5 TO regress_priv_user4;
SET SESSION AUTHORIZATION regress_priv_user4;
INSERT INTO atest5(four) VALUES (4) ON CONFLICT (four) DO UPDATE set three = 3; INSERT INTO atest5(four) VALUES (4) ON CONFLICT ON CONSTRAINT atest5_four_key DO UPDATE set three = 3; INSERT INTO atest5(four) VALUES (4); SET SESSION AUTHORIZATION regress_priv_user1;
GRANT SELECT (four) ON atest5 TO regress_priv_user4;
SET SESSION AUTHORIZATION regress_priv_user4;
INSERT INTO atest5(four) VALUES (4) ON CONFLICT (four) DO UPDATE set three = 3; INSERT INTO atest5(four) VALUES (4) ON CONFLICT ON CONSTRAINT atest5_four_key DO UPDATE set three = 3; SET SESSION AUTHORIZATION regress_priv_user1;
REVOKE ALL (one) ON atest5 FROM regress_priv_user4;
GRANT SELECT (one,two,blue) ON atest6 TO regress_priv_user4;
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT one FROM atest5; UPDATE atest5 SET one = 1; SELECT atest6 FROM atest6; COPY atest6 TO stdout; SET SESSION AUTHORIZATION regress_priv_user1;
...
SET SESSION AUTHORIZATION regress_priv_user2;
INSERT INTO t1 (c1, c2) VALUES (1, 1); UPDATE t1 SET c2 = 1; INSERT INTO t1 (c1, c2) VALUES (null, null); INSERT INTO t1 (c3) VALUES (null); INSERT INTO t1 (c1) VALUES (5); UPDATE t1 SET c3 = 10; SET SESSION AUTHORIZATION regress_priv_user1;
DROP TABLE t1;
...
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT atest6 FROM atest6; SELECT one FROM atest5 NATURAL JOIN atest6; SET SESSION AUTHORIZATION regress_priv_user1;
...
SET SESSION AUTHORIZATION regress_priv_user4;
SELECT * FROM atest6; SELECT 1 FROM atest6; SET SESSION AUTHORIZATION regress_priv_user3;
DELETE FROM atest5 WHERE one = 1; DELETE FROM atest5 WHERE two = 2; SET SESSION AUTHORIZATION regress_priv_user1;
...
SET SESSION AUTHORIZATION regress_priv_user2;
SELECT fx FROM atestp2; SELECT fy FROM atestp2; SELECT atestp2 FROM atestp2; SELECT tableoid FROM atestp2; SELECT fy FROM atestc; SET SESSION AUTHORIZATION regress_priv_user1;
GRANT SELECT(fy,tableoid) ON atestc TO regress_priv_user2;
SET SESSION AUTHORIZATION regress_priv_user2;
SELECT fx FROM atestp2; SELECT fy FROM atestp2; SELECT atestp2 FROM atestp2; SELECT tableoid FROM atestp2; SET SESSION AUTHORIZATION regress_priv_user1;
REVOKE ALL ON atestc FROM regress_priv_user2;
GRANT ALL ON atestp1 TO regress_priv_user2;
SET SESSION AUTHORIZATION regress_priv_user2;
SELECT f2 FROM atestp1; SELECT f2 FROM atestc; DELETE FROM atestp1; DELETE FROM atestc; UPDATE atestp1 SET f1 = 1; UPDATE atestc SET f1 = 1; TRUNCATE atestp1; TRUNCATE atestc; BEGIN;
LOCK atestp1;
END;
BEGIN;
LOCK atestc;
...
GRANT USAGE ON LANGUAGE sql TO regress_priv_user1; GRANT USAGE ON LANGUAGE c TO PUBLIC; SET SESSION AUTHORIZATION regress_priv_user1;
GRANT USAGE ON LANGUAGE sql TO regress_priv_user2; CREATE FUNCTION priv_testfunc1(int) RETURNS int AS 'select 2 *  1;
' LANGUAGE sql;
' LANGUAGE sql;
...
REVOKE ALL ON FUNCTION priv_testproc1(int) FROM PUBLIC; REVOKE ALL ON PROCEDURE priv_testproc1(int) FROM PUBLIC;
GRANT EXECUTE ON PROCEDURE priv_testproc1(int) TO regress_priv_user2;
GRANT USAGE ON FUNCTION priv_testfunc1(int) TO regress_priv_user3; GRANT USAGE ON FUNCTION priv_testagg1(int) TO regress_priv_user3; GRANT USAGE ON PROCEDURE priv_testproc1(int) TO regress_priv_user3; GRANT ALL PRIVILEGES ON FUNCTION priv_testfunc1(int) TO regress_priv_user4;
...
SET SESSION AUTHORIZATION regress_priv_user2;
SELECT priv_testfunc1(5), priv_testfunc2(5); CREATE FUNCTION priv_testfunc3(int) RETURNS int AS 'select 2 *  1;
' LANGUAGE sql;
' LANGUAGE sql;
SELECT priv_testagg1(x) FROM (VALUES (1), (2), (3)) _(x); CALL priv_testproc1(6); SET SESSION AUTHORIZATION regress_priv_user3;
SELECT priv_testfunc1(5); SELECT priv_testagg1(x) FROM (VALUES (1), (2), (3)) _(x); CALL priv_testproc1(6); SELECT col1 FROM atest2 WHERE col2 = true; SELECT priv_testfunc4(true); SET SESSION AUTHORIZATION regress_priv_user4;
SELECT priv_testfunc1(5); SELECT priv_testagg1(x) FROM (VALUES (1), (2), (3)) _(x); CALL priv_testproc1(6); DROP FUNCTION priv_testfunc1(int); DROP AGGREGATE priv_testagg1(int); DROP PROCEDURE priv_testproc1(int); \c -DROP FUNCTION priv_testfunc1(int); GRANT ALL PRIVILEGES ON LANGUAGE sql TO PUBLIC;
BEGIN;
SELECT '{1}'::int4[]::int8[];
REVOKE ALL ON FUNCTION int8(integer) FROM PUBLIC;
SELECT '{1}'::int4[]::int8[]; SET SESSION AUTHORIZATION regress_priv_user4;
SELECT '{1}'::int4[]::int8[]; ROLLBACK;
...
GRANT USAGE ON TYPE _priv_testtype1 TO regress_priv_user2; GRANT USAGE ON DOMAIN priv_testtype1 TO regress_priv_user2; CREATE DOMAIN priv_testdomain1 AS int;
REVOKE USAGE on DOMAIN priv_testdomain1 FROM PUBLIC;
GRANT USAGE ON DOMAIN priv_testdomain1 TO regress_priv_user2;
GRANT USAGE ON TYPE priv_testdomain1 TO regress_priv_user2; SET SESSION AUTHORIZATION regress_priv_user1;
...
DROP TABLE test11b;
DROP TYPE priv_testtype1; DROP DOMAIN priv_testdomain1; SET SESSION AUTHORIZATION regress_priv_user5;
TRUNCATE atest2; TRUNCATE atest3; select has_table_privilege(NULL,'pg_authid','select');
...
GRANT regress_priv_group2 TO regress_priv_user5; SET ROLE regress_priv_group2;
GRANT regress_priv_group2 TO regress_priv_user5; SET SESSION AUTHORIZATION regress_priv_user1;
GRANT regress_priv_group2 TO regress_priv_user5; SELECT dogrant_ok();			SET ROLE regress_priv_group2;
GRANT regress_priv_group2 TO regress_priv_user5; SET SESSION AUTHORIZATION regress_priv_group2;
GRANT regress_priv_group2 TO regress_priv_user5; CREATE FUNCTION dogrant_fails() RETURNS void LANGUAGE sql SECURITY DEFINER AS	'GRANT regress_priv_group2 TO regress_priv_user5';
SELECT dogrant_fails();			DROP FUNCTION dogrant_fails();
SET SESSION AUTHORIZATION regress_priv_user4;
...
GRANT SELECT, INSERT ON LARGE OBJECT 1001 TO PUBLIC;	GRANT SELECT, UPDATE ON LARGE OBJECT 1001 TO nosuchuser;	GRANT SELECT, UPDATE ON LARGE OBJECT  999 TO PUBLIC;	\c -SET SESSION AUTHORIZATION regress_priv_user2;
SELECT lo_create(2001);
SELECT lo_create(2002);
SELECT loread(lo_open(1001, x'20000'::int), 32);	SELECT lowrite(lo_open(1001, x'40000'::int), 'abcd');	SELECT loread(lo_open(1001, x'40000'::int), 32);
SELECT loread(lo_open(1002, x'40000'::int), 32);	SELECT loread(lo_open(1003, x'40000'::int), 32);
SELECT loread(lo_open(1004, x'40000'::int), 32);
SELECT lowrite(lo_open(1001, x'20000'::int), 'abcd');
SELECT lowrite(lo_open(1002, x'20000'::int), 'abcd');	SELECT lowrite(lo_open(1003, x'20000'::int), 'abcd');	SELECT lowrite(lo_open(1004, x'20000'::int), 'abcd');
GRANT SELECT ON LARGE OBJECT 1005 TO regress_priv_user3;
GRANT UPDATE ON LARGE OBJECT 1006 TO regress_priv_user3;	REVOKE ALL ON LARGE OBJECT 2001, 2002 FROM PUBLIC;
GRANT ALL ON LARGE OBJECT 2001 TO regress_priv_user3;
SELECT lo_unlink(1001);		SELECT lo_unlink(2002);
...
SELECT loread(lo_open(1003, x'40000'::int), 32);	SELECT loread(lo_open(1005, x'40000'::int), 32);
SELECT lo_truncate(lo_open(1005, x'20000'::int), 10);	SELECT lo_truncate(lo_open(2001, x'20000'::int), 10);
\c -SET lo_compat_privileges = false;	SET SESSION AUTHORIZATION regress_priv_user4;
SELECT loread(lo_open(1002, x'40000'::int), 32);	SELECT lowrite(lo_open(1002, x'20000'::int), 'abcd');	SELECT lo_truncate(lo_open(1002, x'20000'::int), 10);	SELECT lo_put(1002, 1, 'abcd');				SELECT lo_unlink(1002);					SELECT lo_export(1001, '/dev/null');			SELECT lo_import('/dev/null');				SELECT lo_import('/dev/null', 2003);			\c -SET lo_compat_privileges = true;	SET SESSION AUTHORIZATION regress_priv_user4;
SELECT loread(lo_open(1002, x'40000'::int), 32);
SELECT lowrite(lo_open(1002, x'20000'::int), 'abcd');
SELECT lo_truncate(lo_open(1002, x'20000'::int), 10);
SELECT lo_unlink(1002);
SELECT lo_export(1001, '/dev/null');			\c -SELECT * FROM pg_largeobject LIMIT 0;
SET SESSION AUTHORIZATION regress_priv_user1;
SELECT * FROM pg_largeobject LIMIT 0;			\c -CREATE SCHEMA testns;
GRANT ALL ON SCHEMA testns TO regress_priv_user1;
CREATE TABLE testns.acltest1 (x int);
SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'INSERT'); ALTER DEFAULT PRIVILEGES IN SCHEMA testns,testns GRANT SELECT ON TABLES TO public,public;
SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'INSERT'); DROP TABLE testns.acltest1;
CREATE TABLE testns.acltest1 (x int);
SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'INSERT'); ALTER DEFAULT PRIVILEGES IN SCHEMA testns GRANT INSERT ON TABLES TO regress_priv_user1;
DROP TABLE testns.acltest1;
CREATE TABLE testns.acltest1 (x int);
SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'INSERT'); ALTER DEFAULT PRIVILEGES IN SCHEMA testns REVOKE INSERT ON TABLES FROM regress_priv_user1;
DROP TABLE testns.acltest1;
CREATE TABLE testns.acltest1 (x int);
SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.acltest1', 'INSERT'); ALTER DEFAULT PRIVILEGES FOR ROLE regress_priv_user1 REVOKE EXECUTE ON FUNCTIONS FROM public;
ALTER DEFAULT PRIVILEGES IN SCHEMA testns GRANT USAGE ON SCHEMAS TO regress_priv_user2; BEGIN;
ALTER DEFAULT PRIVILEGES GRANT USAGE ON SCHEMAS TO regress_priv_user2;
CREATE SCHEMA testns2;
SELECT has_schema_privilege('regress_priv_user2', 'testns2', 'USAGE'); SELECT has_schema_privilege('regress_priv_user2', 'testns2', 'CREATE'); ALTER DEFAULT PRIVILEGES REVOKE USAGE ON SCHEMAS FROM regress_priv_user2;
CREATE SCHEMA testns3;
SELECT has_schema_privilege('regress_priv_user2', 'testns3', 'USAGE'); SELECT has_schema_privilege('regress_priv_user2', 'testns3', 'CREATE'); ALTER DEFAULT PRIVILEGES GRANT ALL ON SCHEMAS TO regress_priv_user2;
CREATE SCHEMA testns4;
SELECT has_schema_privilege('regress_priv_user2', 'testns4', 'USAGE'); SELECT has_schema_privilege('regress_priv_user2', 'testns4', 'CREATE'); ALTER DEFAULT PRIVILEGES REVOKE ALL ON SCHEMAS FROM regress_priv_user2;
COMMIT;
CREATE SCHEMA testns5;
SELECT has_schema_privilege('regress_priv_user2', 'testns5', 'USAGE'); SELECT has_schema_privilege('regress_priv_user2', 'testns5', 'CREATE'); SET ROLE regress_priv_user1;
CREATE FUNCTION testns.foo() RETURNS int AS 'select 1' LANGUAGE sql;
CREATE AGGREGATE testns.agg1(int) (sfunc = int4pl, stype = int4);
CREATE PROCEDURE testns.bar() AS 'select 1' LANGUAGE sql;
SELECT has_function_privilege('regress_priv_user2', 'testns.foo()', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user2', 'testns.agg1(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user2', 'testns.bar()', 'EXECUTE'); ALTER DEFAULT PRIVILEGES IN SCHEMA testns GRANT EXECUTE ON ROUTINES to public;
...
CREATE PROCEDURE testns.bar() AS 'select 1' LANGUAGE sql;
SELECT has_function_privilege('regress_priv_user2', 'testns.foo()', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user2', 'testns.agg1(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user2', 'testns.bar()', 'EXECUTE'); DROP FUNCTION testns.foo();
DROP AGGREGATE testns.agg1(int);
DROP PROCEDURE testns.bar();
...
SELECT has_type_privilege('regress_priv_user2', 'testns.priv_testdomain1', 'USAGE'); ALTER DEFAULT PRIVILEGES IN SCHEMA testns GRANT USAGE ON TYPES to public;
DROP DOMAIN testns.priv_testdomain1;
CREATE DOMAIN testns.priv_testdomain1 AS int;
SELECT has_type_privilege('regress_priv_user2', 'testns.priv_testdomain1', 'USAGE'); DROP DOMAIN testns.priv_testdomain1;
RESET ROLE;
...
SELECT has_table_privilege('regress_priv_user1', 'testns.t1', 'SELECT'); GRANT ALL ON ALL TABLES IN SCHEMA testns TO regress_priv_user1;
SELECT has_table_privilege('regress_priv_user1', 'testns.t1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.t2', 'SELECT'); REVOKE ALL ON ALL TABLES IN SCHEMA testns FROM regress_priv_user1;
SELECT has_table_privilege('regress_priv_user1', 'testns.t1', 'SELECT'); SELECT has_table_privilege('regress_priv_user1', 'testns.t2', 'SELECT'); CREATE FUNCTION testns.priv_testfunc(int) RETURNS int AS 'select 3 *  1;
' LANGUAGE sql;
' LANGUAGE sql;
...
SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testfunc(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testagg(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testproc(int)', 'EXECUTE'); REVOKE ALL ON ALL FUNCTIONS IN SCHEMA testns FROM PUBLIC;
SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testfunc(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testagg(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testproc(int)', 'EXECUTE'); REVOKE ALL ON ALL PROCEDURES IN SCHEMA testns FROM PUBLIC;
SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testproc(int)', 'EXECUTE'); GRANT ALL ON ALL ROUTINES IN SCHEMA testns TO PUBLIC;
SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testfunc(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testagg(int)', 'EXECUTE'); SELECT has_function_privilege('regress_priv_user1', 'testns.priv_testproc(int)', 'EXECUTE'); DROP SCHEMA testns CASCADE;
...
BEGIN;
LOCK TABLE lock_table IN ROW EXCLUSIVE MODE; ROLLBACK;
BEGIN;
LOCK TABLE lock_table IN ACCESS SHARE MODE; COMMIT;
BEGIN;
LOCK TABLE lock_table IN ACCESS EXCLUSIVE MODE; ROLLBACK;
\cREVOKE SELECT ON lock_table FROM regress_locktable_user;
GRANT INSERT ON lock_table TO regress_locktable_user;
SET SESSION AUTHORIZATION regress_locktable_user;
BEGIN;
LOCK TABLE lock_table IN ROW EXCLUSIVE MODE; COMMIT;
BEGIN;
LOCK TABLE lock_table IN ACCESS SHARE MODE; ROLLBACK;
BEGIN;
LOCK TABLE lock_table IN ACCESS EXCLUSIVE MODE; ROLLBACK;
...
LOCK TABLE lock_table IN ACCESS SHARE MODE; ROLLBACK;
BEGIN;
LOCK TABLE lock_table IN ACCESS EXCLUSIVE MODE; COMMIT;
