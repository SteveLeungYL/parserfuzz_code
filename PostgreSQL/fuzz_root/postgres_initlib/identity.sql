...
ALTER TABLE itest3 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;  SELECT table_name, column_name, column_default, is_nullable, is_identity, identity_generation, identity_start, identity_increment, identity_maximum, identity_minimum, identity_cycle FROM information_schema.columns WHERE table_name LIKE 'itest_' ORDER BY 1, 2;
SELECT sequence_name FROM information_schema.sequences WHERE sequence_name LIKE 'itest%';
SELECT pg_get_serial_sequence('itest1', 'a');
\d itest1_a_seqCREATE TABLE itest4 (a int, b text);
ALTER TABLE itest4 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;  ALTER TABLE itest4 ALTER COLUMN a SET NOT NULL;
ALTER TABLE itest4 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;  ALTER TABLE itest4 ALTER COLUMN a DROP NOT NULL;  ALTER TABLE itest4 ALTER COLUMN a ADD GENERATED ALWAYS AS IDENTITY;  ALTER TABLE itest4 ALTER COLUMN b ADD GENERATED ALWAYS AS IDENTITY;  ALTER TABLE itest4 ALTER COLUMN b SET DEFAULT '';
...
SELECT * FROM itest1;
UPDATE itest2 SET a = 101 WHERE a = 1;  UPDATE itest2 SET a = DEFAULT WHERE a = 2;  SELECT * FROM itest2;
...
ALTER TABLE itest4 ALTER COLUMN a DROP IDENTITY;  ALTER TABLE itest4 ALTER COLUMN a DROP IDENTITY IF EXISTS;  INSERT INTO itest4 DEFAULT VALUES;  ALTER TABLE itest4 ALTER COLUMN a DROP NOT NULL;
INSERT INTO itest4 DEFAULT VALUES;
SELECT * FROM itest4;
...
\d itest3ALTER TABLE itest3 ALTER COLUMN a TYPE text;  ALTER TABLE itest3  ADD COLUMN c int GENERATED BY DEFAULT AS IDENTITY,  ALTER COLUMN c SET GENERATED ALWAYS;
\d itest3CREATE TABLE itest6 (a int GENERATED ALWAYS AS IDENTITY, b text);
...
ALTER TABLE itest6 ALTER COLUMN b SET INCREMENT BY 2;  ALTER SEQUENCE itest6_a_seq OWNED BY NONE;
...
ALTER TABLE itest7d ADD COLUMN b int GENERATED ALWAYS AS IDENTITY;  SELECT table_name, column_name, is_nullable, is_identity, identity_generation FROM information_schema.columns WHERE table_name LIKE 'itest7%' ORDER BY 1, 2;
...
TABLE itest8;
\d+ itest8\d itest8_f2_seq\d itest8_f3_seq\d itest8_f4_seq\d itest8_f5_seqDROP TABLE itest8;
CREATE TYPE itest_type AS (f1 integer, f2 text, f3 bigint);
CREATE TABLE itest12 OF itest_type (f1 WITH OPTIONS GENERATED ALWAYS AS IDENTITY); DROP TYPE itest_type CASCADE;
CREATE TABLE itest_parent (f1 date NOT NULL, f2 text, f3 bigint) PARTITION BY RANGE (f1);
CREATE TABLE itest_child PARTITION OF itest_parent (    f3 WITH OPTIONS GENERATED ALWAYS AS IDENTITY) FOR VALUES FROM ('2016-07-01') TO ('2016-08-01'); DROP TABLE itest_parent;
...
CREATE TABLE itest15 (id integer GENERATED ALWAYS AS IDENTITY NULL); CREATE TABLE itest15 (id integer NULL GENERATED ALWAYS AS IDENTITY); CREATE TABLE itest15 (id integer GENERATED ALWAYS AS IDENTITY NOT NULL);
DROP TABLE itest15;
