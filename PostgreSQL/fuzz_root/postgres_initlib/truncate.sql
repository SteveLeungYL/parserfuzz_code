...
INSERT INTO trunc_d VALUES (1);
INSERT INTO trunc_e VALUES (1,1);
TRUNCATE TABLE trunc_c CASCADE;  SELECT * FROM truncate_a   UNION ALL SELECT * FROM trunc_c   UNION ALL SELECT * FROM trunc_b   UNION ALL SELECT * FROM trunc_d;
SELECT * FROM trunc_e;
...
SELECT nextval('truncate_a_id1'); CREATE TABLE truncparted (a int, b char) PARTITION BY LIST (a);
...
TRUNCATE TABLE truncprim;	select tp_ins_data();
