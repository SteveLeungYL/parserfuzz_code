...
INSERT INTO enumtest_child VALUES ('blue');  DELETE FROM enumtest_parent;  CREATE TYPE bogus AS ENUM('good', 'bad', 'ugly');
...
SAVEPOINT x;
SELECT 'new'::bogus;  ROLLBACK TO x;
SELECT enum_first(null::bogus);  SELECT enum_last(null::bogus);  ROLLBACK TO x;
SELECT enum_range(null::bogus);  ROLLBACK TO x;
COMMIT;
SELECT 'new'::bogus;  SELECT enumlabel, enumsortorderFROM pg_enumWHERE enumtypid = 'bogus'::regtypeORDER BY 2;
BEGIN;
...
select enum_range(null::bogon);  ROLLBACK;
