...
SELECT '1 second 2 seconds'::interval;              SELECT '10 milliseconds 20 milliseconds'::interval; SELECT '5.5 seconds 3 milliseconds'::interval;      SELECT '1:20:05 5 microseconds'::interval;          SELECT '1 day 1 day'::interval;                     SELECT interval '1-2';  SELECT interval '999' second;  SELECT interval '999' minute;
...
SELECT interval '1 -2:03' minute to second;
SELECT interval '1 -2:03:04' minute to second;
SELECT interval '123 11' day to hour; SELECT interval '123 11' day; SELECT interval '123 11'; SELECT interval '123 2:03 -2:04'; SELECT interval(0) '1 day 01:23:45.6789';
SELECT interval(2) '1 day 01:23:45.6789';
SELECT interval '12:34.5678' minute to second(2);  SELECT interval '1.234' second;
