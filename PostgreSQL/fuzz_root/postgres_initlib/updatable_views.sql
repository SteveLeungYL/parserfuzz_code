...
INSERT INTO rw_view14 VALUES (null, 3, 'Row 3'); INSERT INTO rw_view14 (a, b) VALUES (3, 'Row 3'); UPDATE rw_view14 SET ctid=null WHERE a=3; UPDATE rw_view14 SET b='ROW 3' WHERE a=3; SELECT * FROM base_tbl;
DELETE FROM rw_view14 WHERE a=3; INSERT INTO rw_view15 VALUES (3, 'ROW 3'); INSERT INTO rw_view15 (a) VALUES (3); INSERT INTO rw_view15 (a) VALUES (3) ON CONFLICT DO NOTHING; SELECT * FROM rw_view15;
INSERT INTO rw_view15 (a) VALUES (3) ON CONFLICT (a) DO NOTHING; SELECT * FROM rw_view15;
INSERT INTO rw_view15 (a) VALUES (3) ON CONFLICT (a) DO UPDATE set a = excluded.a; SELECT * FROM rw_view15;
INSERT INTO rw_view15 (a) VALUES (3) ON CONFLICT (a) DO UPDATE set upper = 'blarg'; SELECT * FROM rw_view15;
SELECT * FROM rw_view15;
ALTER VIEW rw_view15 ALTER COLUMN upper SET DEFAULT 'NOT SET';
INSERT INTO rw_view15 (a) VALUES (4); UPDATE rw_view15 SET upper='ROW 3' WHERE a=3; UPDATE rw_view15 SET upper=DEFAULT WHERE a=3; UPDATE rw_view15 SET a=4 WHERE a=3; SELECT * FROM base_tbl;
DELETE FROM rw_view15 WHERE a=4; INSERT INTO rw_view16 VALUES (3, 'Row 3', 3); INSERT INTO rw_view16 (a, b) VALUES (3, 'Row 3'); UPDATE rw_view16 SET a=3, aa=-3 WHERE a=3; UPDATE rw_view16 SET aa=-3 WHERE a=3; SELECT * FROM base_tbl;
DELETE FROM rw_view16 WHERE a=-3; INSERT INTO ro_view17 VALUES (3, 'ROW 3');
...
INSERT INTO rw_view16 (a, b) VALUES (3, 'Row 3'); UPDATE rw_view16 SET b='ROW 2' WHERE a=2; DELETE FROM rw_view16 WHERE a=2; DROP TABLE base_tbl CASCADE;
...
CREATE TABLE base_tbl (a int PRIMARY KEY, b text DEFAULT 'Unspecified');
INSERT INTO base_tbl SELECT i, 'Row ' || i FROM generate_series(-2, 2) g(i);
CREATE VIEW rw_view1 AS SELECT * FROM base_tbl WHERE a>0 OFFSET 0; CREATE VIEW rw_view2 AS SELECT * FROM rw_view1 WHERE a<10;
...
SELECT table_name, column_name, is_updatable  FROM information_schema.columns WHERE table_name LIKE 'rw_view%' ORDER BY table_name, ordinal_position;
CREATE FUNCTION rw_view1_trig_fn()RETURNS trigger ASBEGIN  IF TG_OP = 'INSERT' THEN    INSERT INTO base_tbl VALUES (NEW.a, NEW.b);
    RETURN NEW;
...
SELECT * FROM base_tbl; SELECT * FROM rw_view1; SELECT * FROM rw_view2; INSERT INTO base_tbl VALUES (3, 'Row 3', 3.0); INSERT INTO rw_view1 VALUES ('Row 3', 3.0, 3); INSERT INTO rw_view2 VALUES ('Row 3', 3.0, 3); UPDATE base_tbl SET a=a, c=c; UPDATE base_tbl SET b=b; UPDATE rw_view1 SET bb=bb, cc=cc; UPDATE rw_view1 SET aa=aa; UPDATE rw_view2 SET aa=aa, cc=cc; UPDATE rw_view2 SET bb=bb; DELETE FROM base_tbl; DELETE FROM rw_view1; DELETE FROM rw_view2; RESET SESSION AUTHORIZATION;
SET SESSION AUTHORIZATION regress_view_user1;
GRANT INSERT, DELETE ON base_tbl TO regress_view_user2;
RESET SESSION AUTHORIZATION;
SET SESSION AUTHORIZATION regress_view_user2;
INSERT INTO base_tbl VALUES (3, 'Row 3', 3.0); INSERT INTO rw_view1 VALUES ('Row 4', 4.0, 4); INSERT INTO rw_view2 VALUES ('Row 4', 4.0, 4); DELETE FROM base_tbl WHERE a=1; DELETE FROM rw_view1 WHERE aa=2; DELETE FROM rw_view2 WHERE aa=2; SELECT * FROM base_tbl;
RESET SESSION AUTHORIZATION;
SET SESSION AUTHORIZATION regress_view_user1;
...
RESET SESSION AUTHORIZATION;
SET SESSION AUTHORIZATION regress_view_user2;
INSERT INTO base_tbl VALUES (5, 'Row 5', 5.0); INSERT INTO rw_view1 VALUES ('Row 5', 5.0, 5); INSERT INTO rw_view2 VALUES ('Row 6', 6.0, 6); DELETE FROM base_tbl WHERE a=3; DELETE FROM rw_view1 WHERE aa=3; DELETE FROM rw_view2 WHERE aa=4; SELECT * FROM base_tbl;
RESET SESSION AUTHORIZATION;
DROP TABLE base_tbl CASCADE;
CREATE TABLE base_tbl(a int, b text, c float);
INSERT INTO base_tbl VALUES (1, 'Row 1', 1.0);
...
SELECT * FROM rw_view1;  SELECT * FROM rw_view1 FOR UPDATE;  UPDATE rw_view1 SET b = 'foo' WHERE a = 1;  SET SESSION AUTHORIZATION regress_view_user2;
CREATE VIEW rw_view2 AS SELECT * FROM rw_view1;
SELECT * FROM rw_view2;  SELECT * FROM rw_view2 FOR UPDATE;  UPDATE rw_view2 SET b = 'bar' WHERE a = 1;  RESET SESSION AUTHORIZATION;
GRANT SELECT ON base_tbl TO regress_view_user1;
SET SESSION AUTHORIZATION regress_view_user1;
SELECT * FROM rw_view1;
SELECT * FROM rw_view1 FOR UPDATE;  UPDATE rw_view1 SET b = 'foo' WHERE a = 1;  SET SESSION AUTHORIZATION regress_view_user2;
SELECT * FROM rw_view2;  SELECT * FROM rw_view2 FOR UPDATE;  UPDATE rw_view2 SET b = 'bar' WHERE a = 1;  SET SESSION AUTHORIZATION regress_view_user1;
GRANT SELECT ON rw_view1 TO regress_view_user2;
SET SESSION AUTHORIZATION regress_view_user2;
SELECT * FROM rw_view2;
SELECT * FROM rw_view2 FOR UPDATE;  UPDATE rw_view2 SET b = 'bar' WHERE a = 1;  RESET SESSION AUTHORIZATION;
...
SET SESSION AUTHORIZATION regress_view_user2;
SELECT * FROM rw_view2;
SELECT * FROM rw_view2 FOR UPDATE;  UPDATE rw_view2 SET b = 'bar' WHERE a = 1;  SET SESSION AUTHORIZATION regress_view_user1;
...
INSERT INTO base_tbl VALUES (1, 'Row 1');
INSERT INTO base_tbl VALUES (2, 'Row 2');
CREATE FUNCTION rw_view1_trig_fn()RETURNS trigger ASBEGIN  IF TG_OP = 'INSERT' THEN    UPDATE base_tbl SET b=NEW.b WHERE a=1;
    RETURN NULL;
  END IF;
  RETURN NULL;
END;
...
INSERT INTO rw_view2 VALUES (null, null, null, 1.1, null); INSERT INTO rw_view2(s, c, base_a) VALUES (null, null, 1.1); INSERT INTO rw_view2(base_a) VALUES (1.1) RETURNING t; UPDATE rw_view2 SET s = s WHERE base_a = 1.1; UPDATE rw_view2 SET t = t WHERE base_a = 1.1; UPDATE rw_view2 SET base_a = 1.05 WHERE base_a = 1.1; DELETE FROM rw_view2 WHERE base_a = 1.05 RETURNING base_a, s, c, t; CREATE VIEW rw_view3 AS  SELECT s, c, s/c t, ctid  FROM rw_view1;
INSERT INTO rw_view3 VALUES (null, null, null, null); INSERT INTO rw_view3(s) VALUES (null); UPDATE rw_view3 SET s = s; DELETE FROM rw_view3 WHERE s = sin(0.1); SELECT * FROM base_tbl ORDER BY a;
...
INSERT INTO base_tbl (id, idplus1) VALUES (5, 6);  INSERT INTO rw_view1 (id, idplus1) VALUES (6, 7);  SELECT * FROM base_tbl;
...
UPDATE rw_view1 SET a = a*10 WHERE a IN (-1, 1); UPDATE ONLY rw_view1 SET a = a*10 WHERE a IN (-2, 2); UPDATE rw_view2 SET a = a*10 WHERE a IN (-3, 3); UPDATE ONLY rw_view2 SET a = a*10 WHERE a IN (-4, 4); DELETE FROM rw_view1 WHERE a IN (-5, 5); DELETE FROM ONLY rw_view1 WHERE a IN (-6, 6); DELETE FROM rw_view2 WHERE a IN (-7, 7); DELETE FROM ONLY rw_view2 WHERE a IN (-8, 8); SELECT * FROM ONLY base_tbl_parent ORDER BY a;
...
INSERT INTO rw_view1 VALUES(3,4); INSERT INTO rw_view1 VALUES(4,3); INSERT INTO rw_view1 VALUES(5,null); UPDATE rw_view1 SET b = 5 WHERE a = 3; UPDATE rw_view1 SET b = -5 WHERE a = 3; INSERT INTO rw_view1(a) VALUES (9); INSERT INTO rw_view1(a) VALUES (10); SELECT * FROM base_tbl;
DROP TABLE base_tbl CASCADE;
CREATE TABLE base_tbl (a int);
CREATE VIEW rw_view1 AS SELECT * FROM base_tbl WHERE a > 0;
CREATE VIEW rw_view2 AS SELECT * FROM rw_view1 WHERE a < 10  WITH CHECK OPTION; \d+ rw_view2SELECT * FROM information_schema.views WHERE table_name = 'rw_view2';
INSERT INTO rw_view2 VALUES (-5); INSERT INTO rw_view2 VALUES (5); INSERT INTO rw_view2 VALUES (15); SELECT * FROM base_tbl;
UPDATE rw_view2 SET a = a - 10; UPDATE rw_view2 SET a = a + 10; CREATE OR REPLACE VIEW rw_view2 AS SELECT * FROM rw_view1 WHERE a < 10  WITH LOCAL CHECK OPTION;
\d+ rw_view2SELECT * FROM information_schema.views WHERE table_name = 'rw_view2';
INSERT INTO rw_view2 VALUES (-10); INSERT INTO rw_view2 VALUES (20); SELECT * FROM base_tbl;
ALTER VIEW rw_view1 SET (check_option=here); ALTER VIEW rw_view1 SET (check_option=local);
INSERT INTO rw_view2 VALUES (-20); INSERT INTO rw_view2 VALUES (30); ALTER VIEW rw_view2 RESET (check_option);
\d+ rw_view2SELECT * FROM information_schema.views WHERE table_name = 'rw_view2';
INSERT INTO rw_view2 VALUES (30); SELECT * FROM base_tbl;
DROP TABLE base_tbl CASCADE;
CREATE TABLE base_tbl (a int);
...
INSERT INTO rw_view1 VALUES (5); INSERT INTO rw_view1 VALUES (15); UPDATE rw_view1 SET a = a + 5; UPDATE rw_view1 SET a = a + 5; EXPLAIN (costs off) INSERT INTO rw_view1 VALUES (5);
...
INSERT INTO rw_view1 VALUES (5,0); INSERT INTO rw_view1 VALUES (15, 20); UPDATE rw_view1 SET a = 20, b = 30; DROP TABLE base_tbl CASCADE;
DROP FUNCTION base_tbl_trig_fn();
CREATE TABLE base_tbl (a int, b int);
CREATE VIEW rw_view1 AS SELECT a FROM base_tbl WHERE a < b;
CREATE FUNCTION rw_view1_trig_fn()RETURNS trigger ASBEGIN  IF TG_OP = 'INSERT' THEN    INSERT INTO base_tbl VALUES (NEW.a, 10);
    RETURN NEW;
...
INSERT INTO rw_view2 VALUES (-5); INSERT INTO rw_view2 VALUES (5); INSERT INTO rw_view2 VALUES (50); UPDATE rw_view2 SET a = a - 10; SELECT * FROM base_tbl;
ALTER VIEW rw_view2 SET (check_option=cascaded);
INSERT INTO rw_view2 VALUES (100); UPDATE rw_view2 SET a = 200 WHERE a = 5; SELECT * FROM base_tbl;
...
INSERT INTO rw_view2 VALUES (-10); INSERT INTO rw_view2 VALUES (5); INSERT INTO rw_view2 VALUES (20); UPDATE rw_view2 SET a = 30 WHERE a = 5; INSERT INTO rw_view2 VALUES (5); UPDATE rw_view2 SET a = -5 WHERE a = 5; SELECT * FROM base_tbl;
DROP TABLE base_tbl CASCADE;
DROP FUNCTION rw_view1_trig_fn();
CREATE TABLE base_tbl (a int);
...
INSERT INTO rw_view2 VALUES (2,3); DROP TABLE base_tbl CASCADE;
...
SELECT * FROM v1 WHERE a=3; SELECT * FROM v1 WHERE a=8;
EXPLAIN (VERBOSE, COSTS OFF)UPDATE v1 SET a=100 WHERE snoop(a) AND leakproof(a) AND a < 7 AND a != 6;
UPDATE v1 SET a=100 WHERE snoop(a) AND leakproof(a) AND a < 7 AND a != 6;
SELECT * FROM v1 WHERE a=100; SELECT * FROM t1 WHERE a=100; EXPLAIN (VERBOSE, COSTS OFF)UPDATE v1 SET a=a+1 WHERE snoop(a) AND leakproof(a) AND a = 8;
UPDATE v1 SET a=a+1 WHERE snoop(a) AND leakproof(a) AND a = 8;
SELECT * FROM v1 WHERE b=8;
DELETE FROM v1 WHERE snoop(a) AND leakproof(a); TABLE t1; DROP TABLE t1, t11, t12, t111 CASCADE;
...
INSERT INTO v2 VALUES (2, 'two', 20); INSERT INTO v2 VALUES (-2, 'minus two', 20); INSERT INTO v2 VALUES (3, 'three', 30); UPDATE v2 SET b = 'ONE' WHERE a = 1; UPDATE v2 SET a = -1 WHERE a = 1; UPDATE v2 SET c = 30 WHERE a = 1; DELETE FROM v2 WHERE a = 2; SELECT * FROM v2;
DROP VIEW v2;
DROP VIEW v1;
DROP TABLE t2;
DROP TABLE t1;
...
INSERT INTO v1 VALUES (1, 'ok'); INSERT INTO v1 VALUES (-1, 'invalid'); DROP VIEW v1;
DROP TABLE t1;
...
set session authorization regress_view_user2;
create view rw_view2 as select b as bb, c as cc, a as aa from base_tbl;
insert into rw_view2 (aa,bb) values (1,'xxx')  on conflict (aa) do update set bb = excluded.bb; create view rw_view3 as select b as bb, a as aa from base_tbl;
insert into rw_view3 (aa,bb) values (1,'xxx')  on conflict (aa) do update set bb = excluded.bb; reset session authorization;
select * from base_tbl;
set session authorization regress_view_user2;
create view rw_view4 as select aa, bb, cc FROM rw_view1;
insert into rw_view4 (aa,bb) values (1,'yyy')  on conflict (aa) do update set bb = excluded.bb; create view rw_view5 as select aa, bb FROM rw_view1;
insert into rw_view5 (aa,bb) values (1,'yyy')  on conflict (aa) do update set bb = excluded.bb; reset session authorization;
select * from base_tbl;
drop view rw_view5;
drop view rw_view4;
drop view rw_view3;
