...
ALTER CONVERSION alt_conv1 RENAME TO alt_conv2;  ALTER CONVERSION alt_conv1 RENAME TO alt_conv3;  ALTER CONVERSION alt_conv2 OWNER TO regress_alter_generic_user2;  ALTER CONVERSION alt_conv2 OWNER TO regress_alter_generic_user3;  ALTER CONVERSION alt_conv2 SET SCHEMA alt_nsp2;  SET SESSION AUTHORIZATION regress_alter_generic_user2;
CREATE CONVERSION alt_conv1 FOR 'LATIN1' TO 'UTF8' FROM iso8859_1_to_utf8;
CREATE CONVERSION alt_conv2 FOR 'LATIN1' TO 'UTF8' FROM iso8859_1_to_utf8;
ALTER CONVERSION alt_conv3 RENAME TO alt_conv4;  ALTER CONVERSION alt_conv1 RENAME TO alt_conv4;  ALTER CONVERSION alt_conv3 OWNER TO regress_alter_generic_user2;  ALTER CONVERSION alt_conv2 OWNER TO regress_alter_generic_user3;  ALTER CONVERSION alt_conv3 SET SCHEMA alt_nsp2;  ALTER CONVERSION alt_conv2 SET SCHEMA alt_nsp2;  RESET SESSION AUTHORIZATION;
...
ALTER FOREIGN DATA WRAPPER alt_fdw1 RENAME TO alt_fdw2;  ALTER FOREIGN DATA WRAPPER alt_fdw1 RENAME TO alt_fdw3;  ALTER SERVER alt_fserv1 RENAME TO alt_fserv2;   ALTER SERVER alt_fserv1 RENAME TO alt_fserv3;   SELECT fdwname FROM pg_foreign_data_wrapper WHERE fdwname like 'alt_fdw%';
SELECT srvname FROM pg_foreign_server WHERE srvname like 'alt_fserv%';
CREATE LANGUAGE alt_lang1 HANDLER plpgsql_call_handler;
CREATE LANGUAGE alt_lang2 HANDLER plpgsql_call_handler;
ALTER LANGUAGE alt_lang1 OWNER TO regress_alter_generic_user1;  ALTER LANGUAGE alt_lang2 OWNER TO regress_alter_generic_user2;  SET SESSION AUTHORIZATION regress_alter_generic_user1;
ALTER LANGUAGE alt_lang1 RENAME TO alt_lang2;   ALTER LANGUAGE alt_lang2 RENAME TO alt_lang3;   ALTER LANGUAGE alt_lang1 RENAME TO alt_lang3;   ALTER LANGUAGE alt_lang2 OWNER TO regress_alter_generic_user3;  ALTER LANGUAGE alt_lang3 OWNER TO regress_alter_generic_user2;  ALTER LANGUAGE alt_lang3 OWNER TO regress_alter_generic_user3;  RESET SESSION AUTHORIZATION;
...
ALTER OPERATOR @+@(int4, int4) OWNER TO regress_alter_generic_user2;  ALTER OPERATOR @+@(int4, int4) OWNER TO regress_alter_generic_user3;  ALTER OPERATOR @-@(int4, int4) SET SCHEMA alt_nsp2;           SET SESSION AUTHORIZATION regress_alter_generic_user2;
CREATE OPERATOR @-@ ( leftarg = int4, rightarg = int4, procedure = int4mi );
ALTER OPERATOR @+@(int4, int4) OWNER TO regress_alter_generic_user2;  ALTER OPERATOR @-@(int4, int4) OWNER TO regress_alter_generic_user3;  ALTER OPERATOR @+@(int4, int4) SET SCHEMA alt_nsp2;   RESET SESSION AUTHORIZATION;
...
ROLLBACK;
CREATE OPERATOR FAMILY alt_opf4 USING btree;
ALTER OPERATOR FAMILY alt_opf4 USING invalid_index_method ADD  OPERATOR 1 < (int4, int2); ALTER OPERATOR FAMILY alt_opf4 USING btree ADD OPERATOR 6 < (int4, int2); ALTER OPERATOR FAMILY alt_opf4 USING btree ADD OPERATOR 0 < (int4, int2); ALTER OPERATOR FAMILY alt_opf4 USING btree ADD OPERATOR 1 < ; ALTER OPERATOR FAMILY alt_opf4 USING btree ADD FUNCTION 0 btint42cmp(int4, int2); ALTER OPERATOR FAMILY alt_opf4 USING btree ADD FUNCTION 6 btint42cmp(int4, int2); ALTER OPERATOR FAMILY alt_opf4 USING btree ADD STORAGE invalid_storage; DROP OPERATOR FAMILY alt_opf4 USING btree;
BEGIN TRANSACTION;
...
ALTER TEXT SEARCH DICTIONARY alt_ts_dict1 RENAME TO alt_ts_dict2;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict1 RENAME TO alt_ts_dict3;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict2 OWNER TO regress_alter_generic_user2;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict2 OWNER TO regress_alter_generic_user3;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict2 SET SCHEMA alt_nsp2;  SET SESSION AUTHORIZATION regress_alter_generic_user2;
CREATE TEXT SEARCH DICTIONARY alt_ts_dict1 (template=simple);
CREATE TEXT SEARCH DICTIONARY alt_ts_dict2 (template=simple);
ALTER TEXT SEARCH DICTIONARY alt_ts_dict3 RENAME TO alt_ts_dict4;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict1 RENAME TO alt_ts_dict4;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict3 OWNER TO regress_alter_generic_user2;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict2 OWNER TO regress_alter_generic_user3;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict3 SET SCHEMA alt_nsp2;  ALTER TEXT SEARCH DICTIONARY alt_ts_dict2 SET SCHEMA alt_nsp2;  RESET SESSION AUTHORIZATION;
...
ALTER TEXT SEARCH CONFIGURATION alt_ts_conf1 RENAME TO alt_ts_conf2;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf1 RENAME TO alt_ts_conf3;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf2 OWNER TO regress_alter_generic_user2;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf2 OWNER TO regress_alter_generic_user3;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf2 SET SCHEMA alt_nsp2;  SET SESSION AUTHORIZATION regress_alter_generic_user2;
CREATE TEXT SEARCH CONFIGURATION alt_ts_conf1 (copy=english);
CREATE TEXT SEARCH CONFIGURATION alt_ts_conf2 (copy=english);
ALTER TEXT SEARCH CONFIGURATION alt_ts_conf3 RENAME TO alt_ts_conf4;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf1 RENAME TO alt_ts_conf4;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf3 OWNER TO regress_alter_generic_user2;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf2 OWNER TO regress_alter_generic_user3;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf3 SET SCHEMA alt_nsp2;  ALTER TEXT SEARCH CONFIGURATION alt_ts_conf2 SET SCHEMA alt_nsp2;  RESET SESSION AUTHORIZATION;
...
ALTER TEXT SEARCH TEMPLATE alt_ts_temp1 RENAME TO alt_ts_temp2; ALTER TEXT SEARCH TEMPLATE alt_ts_temp1 RENAME TO alt_ts_temp3; ALTER TEXT SEARCH TEMPLATE alt_ts_temp2 SET SCHEMA alt_nsp2;    CREATE TEXT SEARCH TEMPLATE alt_ts_temp2 (lexize=dsimple_lexize);
ALTER TEXT SEARCH TEMPLATE alt_ts_temp2 SET SCHEMA alt_nsp2;    CREATE TEXT SEARCH TEMPLATE tstemp_case ("Init" = init_function);
...
ALTER TEXT SEARCH PARSER alt_ts_prs2 SET SCHEMA alt_nsp2;   CREATE TEXT SEARCH PARSER tspars_case ("Start" = start_function);
