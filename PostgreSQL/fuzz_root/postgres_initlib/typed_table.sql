...
CREATE TABLE personsx OF person_type (myname WITH OPTIONS NOT NULL); CREATE TABLE persons2 OF person_type (    id WITH OPTIONS PRIMARY KEY,    UNIQUE (name));
...
CREATE TABLE persons5 OF stuff; DROP TABLE stuff;
CREATE TYPE person_type AS (id int, name text);
CREATE TABLE persons OF person_type;
