...
SELECT '20500710 173201 Europe/Helsinki'::timestamptz; SELECT '20500110 173201 Europe/Helsinki'::timestamptz; SELECT '205000-07-10 17:32:01 Europe/Helsinki'::timestamptz; SELECT '205000-01-10 17:32:01 Europe/Helsinki'::timestamptz; INSERT INTO TIMESTAMPTZ_TBL VALUES ('1997-06-10 18:32:01 PDT');
INSERT INTO TIMESTAMPTZ_TBL VALUES ('Feb 10 17:32:01 1997');
...
SELECT '4714-11-23 23:59:59+00 BC'::timestamptz;  SELECT '' AS "48", d1 FROM TIMESTAMPTZ_TBL   WHERE d1 > timestamp with time zone '1997-01-02';
...
SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'Australia/Sydney') as sydney_trunc;  SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'GMT') as gmt_trunc;  SELECT '' AS date_trunc_at_tz, date_trunc('day', timestamp with time zone '2001-02-16 20:38:40+00', 'VET') as vet_trunc;  SELECT '' AS "54", d1 - timestamp with time zone '1997-01-02' AS diff  FROM TIMESTAMPTZ_TBL  WHERE d1 BETWEEN timestamp with time zone '1902-01-01' AND timestamp with time zone '2038-01-01';
...
SELECT d1 as timestamptz,   date_part( 'decade', d1) AS decade,   date_part( 'century', d1) AS century,   date_part( 'millennium', d1) AS millennium,   round(date_part( 'julian', d1)) AS julian   FROM TIMESTAMPTZ_TBL;
...
SELECT '' AS to_char_7, to_char(d1, 'HH24   FROM TIMESTAMPTZ_TBL;
...
SELECT to_timestamp(         0);          SELECT to_timestamp( 946684800);          SELECT to_timestamp(1262349296.7890123);  SELECT to_timestamp(-210866803200);       SELECT to_timestamp(' Infinity'::float);
