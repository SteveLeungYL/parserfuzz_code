...
SELECT COUNT(*) FROM pg_class WHERE relnamespace =    (SELECT oid FROM pg_namespace WHERE nspname = 'test_ns_schema_1');
CREATE SCHEMA test_ns_schema_renamed; CREATE SCHEMA IF NOT EXISTS test_ns_schema_renamed; CREATE SCHEMA IF NOT EXISTS test_ns_schema_renamed        CREATE TABLE abc (              a serial,              b int UNIQUE       );
