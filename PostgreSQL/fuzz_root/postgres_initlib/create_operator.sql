...
;
SELECT true<>-1 BETWEEN 1 AND 1;  SELECT false<=-1 BETWEEN 1 AND 1;
...
REVOKE USAGE ON TYPE type_op3 FROM PUBLIC;  SET ROLE regress_rol_op3;
...
REVOKE USAGE ON TYPE type_op4 FROM PUBLIC;  SET ROLE regress_rol_op4;
...
REVOKE USAGE ON TYPE type_op6 FROM PUBLIC;  SET ROLE regress_rol_op6;
