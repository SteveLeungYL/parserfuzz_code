...
insert into inserttest (f3.if1, f3.if2) values (1,default);  insert into inserttest (f3.if2[1], f3.if2[2]) values ('foo', 'bar');
...
insert into mlparted values (1, 40, 'a', 1);  insert into mlparted values (1, 45, 'b', 1);  insert into mlparted values (1, 45, 'c', 1);  insert into mlparted values (1, 45, 'f', 1);  select tableoid::regclass, * from mlparted order by a, b, c, d;
...
insert into mcrparted4 values (30, 21, 20);	select tableoid::regclass::text, * from mcrparted order by 1;
