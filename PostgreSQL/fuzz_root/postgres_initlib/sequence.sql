...
CREATE SEQUENCE sequence_testx OWNED BY nobody;  CREATE SEQUENCE sequence_testx OWNED BY pg_class_oid_index.oid;  CREATE SEQUENCE sequence_testx OWNED BY pg_class.relname;  CREATE TABLE sequence_test_table (a int);
CREATE SEQUENCE sequence_testx OWNED BY sequence_test_table.b;  DROP TABLE sequence_test_table;
...
ALTER SEQUENCE serialTest1 CYCLE;  CREATE SEQUENCE sequence_test2 START WITH 32;
CREATE SEQUENCE sequence_test4 INCREMENT BY -1;
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test4');
ALTER SEQUENCE sequence_test2 RESTART;
SELECT nextval('sequence_test2');
ALTER SEQUENCE sequence_test2 RESTART WITH 0;  ALTER SEQUENCE sequence_test4 RESTART WITH 40;  ALTER SEQUENCE sequence_test2 RESTART WITH 24  INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');  ALTER SEQUENCE sequence_test2 RESTART WITH 24  NO CYCLE;
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');  ALTER SEQUENCE sequence_test2 RESTART WITH -24 START WITH -24  INCREMENT BY -4 MINVALUE -36 MAXVALUE -5 CYCLE;
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
...
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');
SELECT nextval('sequence_test2');  ALTER SEQUENCE IF EXISTS sequence_test2 RESTART WITH 32 START WITH 32  INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;
SELECT setval('sequence_test2', -100);  SELECT setval('sequence_test2', 100);  SELECT setval('sequence_test2', 5);
CREATE SEQUENCE sequence_test3;  SELECT * FROM information_schema.sequences  WHERE sequence_name ~ ANY(ARRAY['sequence_test', 'serialtest'])  ORDER BY sequence_name ASC;
...
SELECT nextval('sequence_test_temp1');  SELECT nextval('sequence_test2');  ROLLBACK;
START TRANSACTION READ ONLY;
SELECT setval('sequence_test_temp1', 1);  SELECT setval('sequence_test2', 1);  ROLLBACK;
