...
ALTER FUNCTION functest_B_3(int) COST 100;	SELECT proname, provolatile FROM pg_proc       WHERE oid in ('functest_B_1'::regproc,                     'functest_B_2'::regproc,                     'functest_B_3'::regproc,		     'functest_B_4'::regproc) ORDER BY proname;
...
ALTER FUNCTION functest_C_1(int) IMMUTABLE;	ALTER FUNCTION functest_C_2(int) SECURITY INVOKER;
...
ALTER FUNCTION functest_E_2(int) STABLE;	SELECT proname, proleakproof FROM pg_proc       WHERE oid in ('functest_E_1'::regproc,                     'functest_E_2'::regproc) ORDER BY proname;
ALTER FUNCTION functest_E_2(int) NOT LEAKPROOF;	SELECT proname, proleakproof FROM pg_proc       WHERE oid in ('functest_E_1'::regproc,                     'functest_E_2'::regproc) ORDER BY proname;
...
CREATE FUNCTION functest_E_3(int) RETURNS bool LANGUAGE 'sql'       LEAKPROOF AS 'SELECT $1 < 200';	RESET SESSION AUTHORIZATION;
...
ALTER FUNCTION functest_F_1(int) IMMUTABLE;	ALTER FUNCTION functest_F_2(int) STRICT;
...
DROP FUNCTION functest_b_1;  DROP FUNCTION functest_b_2;  CREATE FUNCTION functest1(a int) RETURNS int LANGUAGE SQL AS 'SELECT $1';
