...
select string_agg(distinct f1, ',' order by f1) from varchar_tbl;  select string_agg(distinct f1::text, ',' order by f1) from varchar_tbl;  select string_agg(distinct f1, ',' order by f1::text) from varchar_tbl;  select string_agg(distinct f1::text, ',' order by f1::text) from varchar_tbl;  create table bytea_test_table(v bytea);
