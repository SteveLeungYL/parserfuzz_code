...
SELECT * FROM test_extdep_commands \gexecALTER FUNCTION test_ext.b() DEPENDS ON EXTENSION test_ext5;
...
SELECT * FROM test_extdep_commands \gexecDROP TABLE test_ext.a;		DROP TABLE test_ext.a CASCADE;
...
DROP EXTENSION test_ext5;
DROP SCHEMA test_ext CASCADE;
SELECT * FROM test_extdep_commands \gexecSET search_path TO test_ext;
DROP TRIGGER c ON a;
DROP FUNCTION b();
