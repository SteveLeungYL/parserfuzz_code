...
INSERT INTO gtest1 VALUES (3, 33);  SELECT * FROM gtest1 ORDER BY a;
UPDATE gtest1 SET b = DEFAULT WHERE a = 1;
UPDATE gtest1 SET b = 11 WHERE a = 1;  SELECT * FROM gtest1 ORDER BY a;
...
SELECT * FROM gtest1v;
INSERT INTO gtest1v VALUES (4, 8);  DROP VIEW gtest1v;
...
SELECT * FROM gtest_normal;
CREATE TABLE gtestx (x int, b int GENERATED ALWAYS AS (a * 22) STORED) INHERITS (gtest1);  CREATE TABLE gtestx (x int, b int DEFAULT 10) INHERITS (gtest1);  CREATE TABLE gtestx (x int, b int GENERATED ALWAYS AS IDENTITY) INHERITS (gtest1);  CREATE TABLE gtestxx_1 (a int NOT NULL, b int);
ALTER TABLE gtestxx_1 INHERIT gtest1;  CREATE TABLE gtestxx_2 (a int NOT NULL, b int GENERATED ALWAYS AS (a * 22) STORED);
ALTER TABLE gtestxx_2 INHERIT gtest1;  CREATE TABLE gtestxx_3 (a int NOT NULL, b int GENERATED ALWAYS AS (a * 2) STORED);
ALTER TABLE gtestxx_3 INHERIT gtest1;  CREATE TABLE gtestxx_4 (b int GENERATED ALWAYS AS (a * 2) STORED, a int NOT NULL);
ALTER TABLE gtestxx_4 INHERIT gtest1;  CREATE TABLE gtesty (x int, b int);
CREATE TABLE gtest1_2 () INHERITS (gtest1, gtesty);  DROP TABLE gtesty;
CREATE TABLE gtesty (x int, b int GENERATED ALWAYS AS (x * 22) STORED);
CREATE TABLE gtest1_2 () INHERITS (gtest1, gtesty);  DROP TABLE gtesty;
CREATE TABLE gtesty (x int, b int DEFAULT 55);
CREATE TABLE gtest1_2 () INHERITS (gtest0, gtesty);  DROP TABLE gtesty;
...
SELECT a, b FROM gtest11s;  SELECT a, c FROM gtest11s;  SELECT gf1(10);  SELECT a, c FROM gtest12s;  RESET ROLE;
...
INSERT INTO gtest20 (a) VALUES (10);  INSERT INTO gtest20 (a) VALUES (30);  CREATE TABLE gtest20a (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a * 2) STORED);
INSERT INTO gtest20a (a) VALUES (10);
INSERT INTO gtest20a (a) VALUES (30);
ALTER TABLE gtest20a ADD CHECK (b < 50);  CREATE TABLE gtest20b (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a * 2) STORED);
INSERT INTO gtest20b (a) VALUES (10);
INSERT INTO gtest20b (a) VALUES (30);
ALTER TABLE gtest20b ADD CONSTRAINT chk CHECK (b < 50) NOT VALID;
ALTER TABLE gtest20b VALIDATE CONSTRAINT chk;  CREATE TABLE gtest21a (a int PRIMARY KEY, b int GENERATED ALWAYS AS (nullif(a, 0)) STORED NOT NULL);
INSERT INTO gtest21a (a) VALUES (1);  INSERT INTO gtest21a (a) VALUES (0);  CREATE TABLE gtest21b (a int PRIMARY KEY, b int GENERATED ALWAYS AS (nullif(a, 0)) STORED);
ALTER TABLE gtest21b ALTER COLUMN b SET NOT NULL;
INSERT INTO gtest21b (a) VALUES (1);  INSERT INTO gtest21b (a) VALUES (0);  ALTER TABLE gtest21b ALTER COLUMN b DROP NOT NULL;
INSERT INTO gtest21b (a) VALUES (0);  CREATE TABLE gtest22a (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a / 2) STORED UNIQUE);
...
CREATE TABLE gtest23x (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a * 2) STORED REFERENCES gtest23a (x) ON UPDATE CASCADE);  CREATE TABLE gtest23x (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a * 2) STORED REFERENCES gtest23a (x) ON DELETE SET NULL);  CREATE TABLE gtest23b (a int PRIMARY KEY, b int GENERATED ALWAYS AS (a * 2) STORED REFERENCES gtest23a (x));
\d gtest23bINSERT INTO gtest23b VALUES (1);  INSERT INTO gtest23b VALUES (5);  DROP TABLE gtest23b;
DROP TABLE gtest23a;
...
INSERT INTO gtest23q VALUES (1, 2);  INSERT INTO gtest23q VALUES (2, 5);  CREATE DOMAIN gtestdomain1 AS int CHECK (VALUE < 10);
CREATE TABLE gtest24 (a int PRIMARY KEY, b gtestdomain1 GENERATED ALWAYS AS (a * 2) STORED);
INSERT INTO gtest24 (a) VALUES (4);  INSERT INTO gtest24 (a) VALUES (6);  CREATE TYPE gtest_type AS (f1 integer, f2 text, f3 bigint);
CREATE TABLE gtest28 OF gtest_type (f1 WITH OPTIONS GENERATED ALWAYS AS (f2 *2) STORED);
DROP TYPE gtest_type CASCADE;
CREATE TABLE gtest_parent (f1 date NOT NULL, f2 text, f3 bigint) PARTITION BY RANGE (f1);
CREATE TABLE gtest_child PARTITION OF gtest_parent (    f3 WITH OPTIONS GENERATED ALWAYS AS (f2 * 2) STORED) FOR VALUES FROM ('2016-07-01') TO ('2016-08-01'); DROP TABLE gtest_parent;
...
ALTER TABLE gtest25 ADD COLUMN x int GENERATED ALWAYS AS (b * 4) STORED;  ALTER TABLE gtest25 ADD COLUMN x int GENERATED ALWAYS AS (z * 4) STORED;  ALTER TABLE gtest25 ADD COLUMN c int DEFAULT 42,  ADD COLUMN x int GENERATED ALWAYS AS (c * 4) STORED;
...
ALTER TABLE gtest27 ALTER COLUMN a TYPE text;  ALTER TABLE gtest27 ALTER COLUMN x TYPE numeric;
\d gtest27SELECT * FROM gtest27;
ALTER TABLE gtest27 ALTER COLUMN x TYPE boolean USING x <> 0;  ALTER TABLE gtest27 ALTER COLUMN x DROP DEFAULT;  ALTER TABLE gtest27  DROP COLUMN x,  ALTER COLUMN a TYPE bigint,  ALTER COLUMN b TYPE bigint,  ADD COLUMN x bigint GENERATED ALWAYS AS ((a + b) * 2) STORED;
\d gtest27ALTER TABLE gtest27  ALTER COLUMN a TYPE float8,  ALTER COLUMN b TYPE float8;  \d gtest27SELECT * FROM gtest27;
CREATE TABLE gtest29 (    a int,    b int GENERATED ALWAYS AS (a * 2) STORED);
INSERT INTO gtest29 (a) VALUES (3), (4);
ALTER TABLE gtest29 ALTER COLUMN a DROP EXPRESSION;  ALTER TABLE gtest29 ALTER COLUMN a DROP EXPRESSION IF EXISTS;  ALTER TABLE gtest29 ALTER COLUMN b DROP EXPRESSION;
INSERT INTO gtest29 (a) VALUES (5);
INSERT INTO gtest29 (a, b) VALUES (6, 66);
SELECT * FROM gtest29;
\d gtest29ALTER TABLE gtest29 DROP COLUMN a;  \d gtest29CREATE TABLE gtest30 (    a int,    b int GENERATED ALWAYS AS (a * 2) STORED);
...
CREATE TABLE gtest30_1 () INHERITS (gtest30);
ALTER TABLE ONLY gtest30 ALTER COLUMN b DROP EXPRESSION;  \d gtest30\d gtest30_1ALTER TABLE gtest30_1 ALTER COLUMN b DROP EXPRESSION;  CREATE TABLE gtest26 (    a int PRIMARY KEY,    b int GENERATED ALWAYS AS (a * 2) STORED);
