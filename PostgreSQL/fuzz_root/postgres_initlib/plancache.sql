...
select f1 from abc;
execute p1;
alter table s1.abc add column f2 float8;   execute p1;
...
execute test_mode_pp(1); execute test_mode_pp(1); execute test_mode_pp(1); execute test_mode_pp(1); execute test_mode_pp(1); explain (costs off) execute test_mode_pp(2);
