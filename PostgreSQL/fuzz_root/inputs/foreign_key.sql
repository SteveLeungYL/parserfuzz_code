...
INSERT INTO FKTABLE VALUES(42);		INSERT INTO FKTABLE VALUES(43);		UPDATE FKTABLE SET ftest1 = ftest1;	UPDATE FKTABLE SET ftest1 = ftest1 + 1;	DROP TABLE FKTABLE;
...
SET CONSTRAINTS ALL IMMEDIATE;
INSERT INTO pktable VALUES (2000, 3); COMMIT;
DROP TABLE fktable, pktable;
CREATE TABLE pktable (	id		INT4 PRIMARY KEY,	other	INT4);
CREATE TABLE fktable (	id		INT4 PRIMARY KEY,	fk		INT4 REFERENCES pktable DEFERRABLE INITIALLY DEFERRED);
BEGIN;
...
select * from defc;
delete from defp where f1 = 0; alter table defc alter column f1 set default 1;
delete from defp where f1 = 0;
select * from defc;
delete from defp where f1 = 1; create temp table pp (f1 int primary key);
...
update pp set f1=f1+1;
update pp set f1=f1+1; delete from pp where f1 = 13; drop table pp, cc;
...
\d fk_notpartitioned_pkALTER TABLE fk_partitioned_fk DROP CONSTRAINT fk_partitioned_fk_a_b_fkey;
...
ALTER TABLE fk_partitioned_fk_full ADD FOREIGN KEY (x, y) REFERENCES fk_notpartitioned_pk MATCH FULL;  TRUNCATE fk_partitioned_fk_full;
ALTER TABLE fk_partitioned_fk_full ADD FOREIGN KEY (x, y) REFERENCES fk_notpartitioned_pk MATCH FULL;
INSERT INTO fk_partitioned_fk_full VALUES (1, NULL);  DROP TABLE fk_partitioned_fk_full;
...
ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_2 FOR VALUES IN (1500,1502);
\d fk_partitioned_fk_2DROP TABLE fk_partitioned_fk_2;
...
ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_5 FOR VALUES IN (4500);
\d fk_partitioned_fk_5ALTER TABLE fk_partitioned_fk_5 DETACH PARTITION fk_partitioned_fk_5_1;
ALTER TABLE fk_partitioned_fk_5 ATTACH PARTITION fk_partitioned_fk_5_1 FOR VALUES FROM (0) TO (10);
\d fk_partitioned_fk_5_1CREATE TABLE fk_partitioned_fk_2 (a int, b int) PARTITION BY RANGE (b);
...
\d fkpart0.fk_part_1	\\ alter table fkpart0.fk_part_1 drop constraint fk_part_1_a_fkey;
\d fkpart0.fk_part_23	\\ \d fkpart0.fk_part_23_2	\\ alter table fkpart0.fk_part_23 drop constraint fk_part_23_a_fkey;
...
\d fkpart0.fk_part_4alter table fkpart0.fk_part_4 drop constraint fk_part_a_fkey;
...
\d fkpart0.fk_part_56alter table fkpart0.fk_part_56 drop constraint fk_part_a_fkey;
...
insert into fkpart1.fk_part values (1);		insert into fkpart1.pkey values (1);
insert into fkpart1.fk_part values (1);
delete from fkpart1.pkey where a = 1;		alter table fkpart1.fk_part detach partition fkpart1.fk_part_1;
create table fkpart1.fk_part_1_2 partition of fkpart1.fk_part_1 for values in (2);
insert into fkpart1.fk_part_1 values (2);	delete from fkpart1.pkey where a = 1;
...
COMMIT;							CREATE TABLE pt(f1 int, f2 int, f3 int, PRIMARY KEY(f1,f2));
...
INSERT INTO pt VALUES(1,2,3);
INSERT INTO ref VALUES(1,2,3);
ALTER TABLE ref22 ALTER CONSTRAINT ref_f1_f2_fkey  DEFERRABLE INITIALLY IMMEDIATE;	ALTER TABLE ref ALTER CONSTRAINT ref_f1_f2_fkey  DEFERRABLE INITIALLY DEFERRED;
BEGIN;
DELETE FROM pt;
DELETE FROM ref;
ABORT;
...
CREATE TABLE ref(f1 int, f2 int, f3 int);
ALTER TABLE ref ADD FOREIGN KEY(f1,f2) REFERENCES pt;
ALTER TABLE ref ALTER CONSTRAINT ref_f1_f2_fkey1  DEFERRABLE INITIALLY DEFERRED;	ALTER TABLE ref ALTER CONSTRAINT ref_f1_f2_fkey  DEFERRABLE INITIALLY DEFERRED;
INSERT INTO pt VALUES(1,2,3);
INSERT INTO ref VALUES(1,2,3);
BEGIN;
DELETE FROM pt;
