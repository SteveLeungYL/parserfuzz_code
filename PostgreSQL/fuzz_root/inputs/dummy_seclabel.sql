...
SECURITY LABEL ON TABLE dummy_seclabel_tbl1 IS 'classified';			SECURITY LABEL ON COLUMN dummy_seclabel_tbl1.a IS 'unclassified';		SECURITY LABEL ON COLUMN dummy_seclabel_tbl1 IS 'unclassified';	SECURITY LABEL ON TABLE dummy_seclabel_tbl1 IS '...invalid label...';	SECURITY LABEL FOR 'dummy' ON TABLE dummy_seclabel_tbl1 IS 'unclassified';	SECURITY LABEL FOR 'unknown_seclabel' ON TABLE dummy_seclabel_tbl1 IS 'classified';	SECURITY LABEL ON TABLE dummy_seclabel_tbl2 IS 'unclassified';	SECURITY LABEL ON TABLE dummy_seclabel_tbl1 IS 'secret';		SECURITY LABEL ON TABLE dummy_seclabel_tbl3 IS 'unclassified';	SET SESSION AUTHORIZATION regress_dummy_seclabel_user2;
SECURITY LABEL ON TABLE dummy_seclabel_tbl1 IS 'unclassified';		SECURITY LABEL ON TABLE dummy_seclabel_tbl2 IS 'classified';			SET SESSION AUTHORIZATION regress_dummy_seclabel_user1;
SECURITY LABEL ON ROLE regress_dummy_seclabel_user1 IS 'classified';			SECURITY LABEL ON ROLE regress_dummy_seclabel_user1 IS '...invalid label...';	SECURITY LABEL FOR 'dummy' ON ROLE regress_dummy_seclabel_user2 IS 'unclassified';	SECURITY LABEL FOR 'unknown_seclabel' ON ROLE regress_dummy_seclabel_user1 IS 'unclassified';	SECURITY LABEL ON ROLE regress_dummy_seclabel_user1 IS 'secret';	SECURITY LABEL ON ROLE regress_dummy_seclabel_user3 IS 'unclassified';	SET SESSION AUTHORIZATION regress_dummy_seclabel_user2;
SECURITY LABEL ON ROLE regress_dummy_seclabel_user2 IS 'unclassified';	RESET SESSION AUTHORIZATION;
RESET SESSION AUTHORIZATION;
SECURITY LABEL ON TABLE dummy_seclabel_tbl1 IS 'top secret';			SECURITY LABEL ON VIEW dummy_seclabel_view1 IS 'classified';			SECURITY LABEL ON FUNCTION dummy_seclabel_four() IS 'classified';		SECURITY LABEL ON DOMAIN dummy_seclabel_domain IS 'classified';		CREATE SCHEMA dummy_seclabel_test;
SECURITY LABEL ON SCHEMA dummy_seclabel_test IS 'unclassified';		SET client_min_messages = error;
