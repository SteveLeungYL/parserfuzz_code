...
create aggregate least_agg(int4) (  stype = int8, sfunc = least_accum);  drop function least_accum(int8, int8);
create function least_accum(anycompatible, anycompatible)returns anycompatible language sql as  'select least( 1,  2)';
create aggregate least_agg(int4) (  stype = int8, sfunc = least_accum);  create aggregate least_agg(int8) (  stype = int8, sfunc = least_accum);
