...
#line 1 "libpg_query/grammar/statements/alter_table.y"
/*****************************************************************************
 *
...
opt_set_data: SET DATA_P							{ $$ = 1; }
			...
			| /*EMPTY*/								{ $$ = 0; }
		;
#line 1 "libpg_query/grammar/statements/deallocate.y"
/*****************************************************************************
 *
 *		QUERY:
...
DeallocateStmt: DEALLOCATE name
		...
		;
#line 1 "libpg_query/grammar/statements/common.y"
/*
...
#line 1 "libpg_query/grammar/statements/rename.y"
/*****************************************************************************
 *
...
opt_column: COLUMN									{ $$ = COLUMN; }
			| /*EMPTY*/								{ $$ = 0; }
		;
#line 1 "libpg_query/grammar/statements/insert.y"
/*****************************************************************************
 *
 *		QUERY:
 *				INSERT STATEMENTS
...
set_target:
		...
		;
#line 1 "libpg_query/grammar/statements/create_type.y"
/*****************************************************************************
 *
...
#line 1 "libpg_query/grammar/statements/pragma.y"
/*****************************************************************************
 *
 * PRAGMA stmt
 *
...
#line 1 "libpg_query/grammar/statements/create_sequence.y"
/*****************************************************************************
 *
 *		QUERY :
...
OptSeqOptList: SeqOptList							{ $$ = $1; }
			| /*EMPTY*/								{ $$ = NIL; }
		;
#line 1 "libpg_query/grammar/statements/execute.y"
/*****************************************************************************
 *
...
execute_param_clause: '(' execute_param_list ')'				{ $$ = $2; }
					| /* EMPTY */					{ $$ = NIL; }
					;
#line 1 "libpg_query/grammar/statements/alter_sequence.y"
/*****************************************************************************
 *
 *		QUERY :
 *				CREATE SEQUENCE seqname
...
SignedIconst: Iconst								{ $$ = $1; }
			...
			| '-' Iconst							{ $$ = - $2; }
		;
#line 1 "libpg_query/grammar/statements/transaction.y"
TransactionStmt:
...
opt_transaction:	WORK							{}
			...
			| /*EMPTY*/								{}
		;
#line 1 "libpg_query/grammar/statements/use.y"
UseStmt:
		...
		;
#line 1 "libpg_query/grammar/statements/create.y"
/*****************************************************************************
 *
 *		QUERY :
...
generated_when:
		...
		;
#line 1 "libpg_query/grammar/statements/drop.y"
/*****************************************************************************
 *
 *		QUERY:
 *
...
type_name_list:
			...
			;
#line 1 "libpg_query/grammar/statements/create_function.y"
/*****************************************************************************
 *
...
param_list:
	...
	;
#line 1 "libpg_query/grammar/statements/update.y"
/*****************************************************************************
 *
 *		QUERY:
 *				PGUpdateStmt (UPDATE)
...
UpdateStmt: opt_with_clause UPDATE relation_expr_opt_alias
		...
		;
#line 1 "libpg_query/grammar/statements/copy.y"
...
copy_generic_opt_list:
		...
		;
#line 1 "libpg_query/grammar/statements/select.y"
...
ColLabelOrString:	ColLabel						{ $$ = $1; }
					| SCONST						{ $$ = $1; }
		;
#line 1 "libpg_query/grammar/statements/prepare.y"
/*****************************************************************************
 *
 *		QUERY:
...
PreparableStmt:
		...
		;
#line 1 "libpg_query/grammar/statements/create_schema.y"
/*****************************************************************************
 *
 * Manipulate a schema
 *
...
schema_stmt:
			...
			| ViewStmt
		;
#line 1 "libpg_query/grammar/statements/index.y"
/*****************************************************************************
 *
 *		QUERY: CREATE INDEX
 *
...
opt_unique:
			...
			| /*EMPTY*/								{ $$ = false; }
		;
#line 1 "libpg_query/grammar/statements/alter_schema.y"
/*****************************************************************************
 *
...
AlterObjectSchemaStmt:
		...
		;
#line 1 "libpg_query/grammar/statements/checkpoint.y"
/*
...
opt_col_id:
	ColId 						{ $$ = $1; }
	| /* empty */ 				{ $$ = NULL; }
#line 1 "libpg_query/grammar/statements/export.y"
/*****************************************************************************
 *
 * EXPORT/IMPORT stmt
 *
...
ImportStmt:
		...
		;
#line 1 "libpg_query/grammar/statements/explain.y"
/*****************************************************************************
 *
 *		QUERY:
...
explain_option_name:
		...
		;
#line 1 "libpg_query/grammar/statements/variable_set.y"
/*****************************************************************************
 *
...
var_list:	var_value								{ $$ = list_make1($1); }
		...
		;
#line 1 "libpg_query/grammar/statements/load.y"
/*****************************************************************************
 *
 *		QUERY:
 *				LOAD "filename"
...
repo_path:	Sconst								{ $$ = $1; } |
            ColId                               { $$ = $1; };
#line 1 "libpg_query/grammar/statements/vacuum.y"
/*****************************************************************************
 *
 *		QUERY:
 *				VACUUM
...
opt_freeze: FREEZE									{ $$ = true; }
			| /*EMPTY*/								{ $$ = false; }
		;
#line 1 "libpg_query/grammar/statements/delete.y"
/*****************************************************************************
 *
 *		QUERY:
 *				DELETE STATEMENTS
...
using_clause:
			...
			| /*EMPTY*/								{ $$ = NIL; }
		;
#line 1 "libpg_query/grammar/statements/analyze.y"
/*****************************************************************************
 *
 *		QUERY:
 *				VACUUM
...
AnalyzeStmt:
		...
		;
#line 1 "libpg_query/grammar/statements/attach.y"
/*****************************************************************************
 *
 * Attach Statement
 *
...
ident_list:
		...
		;
#line 1 "libpg_query/grammar/statements/variable_reset.y"
VariableResetStmt:
			RESET reset_rest
			{
...
reset_rest:
		...
		;
#line 1 "libpg_query/grammar/statements/variable_show.y"
...
table_id:	ColId								{ $$ = psprintf("\"%s\"", $1); }
			| table_id '.' ColId
				{ $$ = psprintf("%s.\"%s\"", $1, $3); }
		;
#line 1 "libpg_query/grammar/statements/call.y"
/*****************************************************************************
 *
...
CallStmt: CALL_P func_application
		...
		;
#line 1 "libpg_query/grammar/statements/view.y"
/*****************************************************************************
 *
 *	QUERY:
...
opt_check_option:
		...
		;
#line 1 "libpg_query/grammar/statements/create_as.y"
/*****************************************************************************
 *
 *		QUERY :
