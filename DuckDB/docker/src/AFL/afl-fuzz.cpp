...
static u8 fuzz_one(char **argv) {
  ...
  int skip_count;
  string all_inputs, all_valid_inputs;
...
int main(int argc, char **argv) {
  ...
  while ((opt = getopt(argc, argv, "+i:o:f:m:t:T:dnCB:S:M:x:QDF:c:O:s:wXRr")) >
         0)
