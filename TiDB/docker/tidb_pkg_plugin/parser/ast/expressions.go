...
func (n *BetweenExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	rNode := n.Left.LogCurrentNode(depth + 1)
...
func LogCurrentNodeBinaryOpWithSpacesAround(depth int, op opcode.Op) *sql_ir.SqlRsgIR {

	prefix := " "
	lNode := op.LogCurrentNode(depth + 1)
	midfix := " "
...
func (n *WhenClause) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {

	prefix := "WHEN "
	lNode := n.Expr.LogCurrentNode(depth + 1)
	midfix := " THEN "
	rNode := n.Result.LogCurrentNode(depth + 1)
	...
	rootNode.IRType = sql_ir.TypeWhenClause
...
func (n *CaseExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	if n.Value != nil {
		prefix += " "
		lNode = n.Value.LogCurrentNode(depth + 1)
	}
	...
	for _, clause := range n.WhenClauses {
		midfix := " "
		rNode := clause.LogCurrentNode(depth + 1)
	...
	if n.ElseClause != nil {
		midfix := " ELSE "
		rNode := n.ElseClause.LogCurrentNode(depth + 1)
...
func (n *SubqueryExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {

	prefix := " ("
	lNode := n.Query.LogCurrentNode(depth + 1)
	midfix := ")"
...
func (n *CompareSubqueryExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *ColumnName) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	rootNode.IRType = sql_ir.TypeColumnName
...
func (n *ExistsSubqueryExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	lNode := n.Sel.LogCurrentNode(depth + 1)
...
func (n *PatternInExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	if n.Sel != nil {
		rNode := n.Sel.LogCurrentNode(depth + 1)
		rootNode = &sql_ir.SqlRsgIR{
			IRType:   sql_ir.TypeUnknown,
			DataType: sql_ir.DataNone,
			LNode:    rootNode,
		...
		for i, expr := range n.List {
			...
			exprNode := expr.LogCurrentNode(depth + 1)

			if i == 0 {
				tmpRootNode.LNode = exprNode
			} else { // i > 0
				tmpRootNode = &sql_ir.SqlRsgIR{
					IRType:   sql_ir.TypeUnknown,
					DataType: sql_ir.DataNone,
...
func (n *IsNullExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *IsTruthExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *PatternLikeExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	rNode := n.Pattern.LogCurrentNode(depth + 1)
...
func (n *ParenthesesExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *PositionExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {

	lNode := &sql_ir.SqlRsgIR{
		IRType:   sql_ir.TypeUnknown,
		DataType: sql_ir.DataNone,
		IValue:   int64(n.N),
		Str:      strconv.FormatInt(int64(n.N), 10),
		Depth:    depth,
	}
...
func (n *PatternRegexpExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *RowExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *UnaryOperationExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {

	lNode := n.Op.LogCurrentNode(depth + 1)
	rNode := n.V.LogCurrentNode(depth + 1)
...
func (n *ValuesExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *VariableExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
...
func (n *MaxValueExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	rootNode.IRType = sql_ir.TypeMaxValueExpr
	return rootNode
...
func (n *MatchAgainst) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
	...
	midfix := " ) AGAINST ( "
	rNode := n.Against.LogCurrentNode(depth + 1)
	rootNode = &sql_ir.SqlRsgIR{
		IRType:   sql_ir.TypeUnknown,
		DataType: sql_ir.DataNone,
		LNode:    rootNode,
	...
	if n.Modifier.IsBooleanMode() {
		midfix += " IN BOOLEAN MODE"
	} else if n.Modifier.WithQueryExpansion() {
		midfix += " WITH QUERY EXPANSION"
	}
	midfix += ")"
...
func (n *SetCollationExpr) LogCurrentNode(depth int) *sql_ir.SqlRsgIR {
