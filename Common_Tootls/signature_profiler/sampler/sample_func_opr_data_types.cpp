...
// DBMS. Read all the function signatures from the mysql_func_type_lib and
// mysql_opr_type_lib, test them in the DBMS, and retrieve the testing information
// into a JSON file.
...
char *FUNC_TYPE_LIB_PATH = "./mysql_func_type_lib";
char *OPR_TYPE_LIB_PATH = "./mysql_opr_type_lib";
