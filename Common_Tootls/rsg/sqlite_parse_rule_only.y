...
exprnorecursive ::= ID LP STAR RP.
expr ::= ID LP distinct exprlistnorecursive RP filter_over.
expr ::= FUNC LP distinct exprlistnorecursive RP filter_over.
...
expr ::= exprnorecursive in_op LP selectwith RP.
