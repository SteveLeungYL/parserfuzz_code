...
mysql_root_dir = "/home/luy70/Desktop/SQLRight_DBMS/MySQL/mysql_test/mysql-server/bld"
mysql_src_data_dir = os.path.join(mysql_root_dir, "data_all/data_ori")
current_workdir = os.getcwd()

starting_core_id = 0
parallel_num = 1
port_starting_num = 5580
...
for cur_inst_id in range(starting_core_id, starting_core_id + parallel_num, 1):
    ...
    cur_mysql_data_dir_str = os.path.join(mysql_root_dir, "data_all/data_" + str(cur_inst_id-starting_core_id))
    ...
    mysql_command = "__AFL_SHM_ID=" + cur_shm_str + " " + mysql_bin_dir + " --basedir=" + mysql_root_dir + " --datadir=" + cur_mysql_data_dir_str + " --port=" + str(cur_port_num) + " & "
