...
insert into t1(d) values (9.22337203685479e18), (1.84e19);
update t1 set u = d;
select u from t1;
drop table t1;
...
select concat((truncate((-1.7976931348623157E+307),(0x1e))), (99999999999999999999999999999999999999999999999999999999999999999)) into @a;
