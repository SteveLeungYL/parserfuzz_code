...
INSERT INTO t1 VALUES(_utf16 0x30FC), (_utf16 0x30A230FC), (_utf16 0x304230FC), (_utf16 0x65E5672C8A9E), (_utf16 0x30443059309E), (_utf16 0x30443059305A), (_utf16 0x30A430B930FE), (_utf16 0x30A430B930BA), (_utf16 0x65E5672C8A9E30CB30DB30F330B4);
SELECT HEX(CONVERT(a USING utf16)), HEX(WEIGHT_STRING(a)) FROM t1 ORDER BY a;
DROP TABLE t1;
CREATE TABLE t1(a VARCHAR(20), KEY a (a)) COLLATE utf8mb4_ja_0900_as_cs_ks PARTITION BY KEY (a) PARTITIONS 3;
INSERT INTO t1 VALUES(_utf16 0x30FC), (_utf16 0x30A230FC), (_utf16 0x304230FC), (_utf16 0x65E5672C8A9E), (_utf16 0x30443059309E), (_utf16 0x30443059305A), (_utf16 0x30A430B930FE), (_utf16 0x30A430B930BA), (_utf16 0x65E5672C8A9E30CB30DB30F330B4);
...
INSERT INTO t1 VALUES(_utf16 0x2E87), (_utf16 0x2E8D), (_utf16 0x2F17), (_utf16 0x3038), (_utf16 0x24B6), (_utf32 0x1F150), (_utf16 0x4E2D), (_utf16 0x3197), (_utf32 0x1F22D), ('A'), ('a'), ('Z'), ('z'), (_utf16 0x3082), (_utf16 0x30E2), (_utf16 0x2E31), (_utf16 0x33E8), (_utf32 0x1F229), (_utf32 0x1F241), (_utf16 0xFA56);
SELECT HEX(CONVERT(a USING utf32)), HEX(WEIGHT_STRING(a)) FROM t1 ORDER BY a, HEX(a);
DROP TABLE t1;
CREATE TABLE t1(a VARCHAR(10)) COLLATE utf8mb4_zh_0900_as_cs;
INSERT INTO t1 VALUES(_utf16 0x6C88), (_utf16 0x5F1E), (_utf16 0x9633), (_utf16 0x6C889633), (_utf16 0x5F1E9633);
SELECT HEX(CONVERT(a USING utf32)), HEX(WEIGHT_STRING(a)) FROM t1 ORDER BY a, HEX(a);
DROP TABLE t1;
CREATE TABLE t1(a VARCHAR(10), b VARCHAR(10)) COLLATE utf8mb4_zh_0900_as_cs;
INSERT INTO t1 VALUES(_utf16 0xF902, _utf16 0x2F9E), (_utf16 0xF907, _utf16 0x2FD4), (_utf16 0xF908, _utf16 0x2FD4), (_utf16 0xF9D1, _utf16 0x3285);
