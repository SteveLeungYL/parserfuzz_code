...
CREATE USER user1@localhost, user2@localhost, user3@localhost, user4@localhost, user5@localhost;
...
FLUSH TABLE db1.t1 FOR EXPORT;
show session status;
DROP USER user1@localhost, user2@localhost, user3@localhost, user4@localhost, user5@localhost;
DROP TABLE db1.t1;
DROP DATABASE db1;
CREATE TABLE t1 (a INT) engine= InnoDB;
CREATE TABLE t2 (a INT) engine= InnoDB;
