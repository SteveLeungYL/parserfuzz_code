...
select a+0, b+0 from t1;
drop table t1, t2;
create table t1 (a int, b time, c tinyint, d bool, e char(10), f bit(1), g bit(1) NOT NULL default 1, h char(1) default 'a');
insert into t1 set a=1;
select hex(g), h from t1;
drop table t1;
create table t1 (a int, b time, c tinyint, d bool, e char(10), f bit(1), g bit(1) NOT NULL default 1);
insert into t1 set a=1;
select hex(g) from t1;
drop table t1;
create table t1 (a int, b time, c tinyint, d bool, e char(10), f bit(1), h char(1) default 'a') engine=myisam;
insert into t1 set a=1;
select h from t1;
drop table t1;
...
create algorithm=undefined view v1 as select b1+0, b2+0 from t1, t2 where id1 = id2 and b1 = 0 union select b1+0, b2+0 from t1, t2 where id1 = id2 and b2 = 1;
select * from v1;
drop table t1, t2;
drop view v1;
...
INSERT INTO t2 VALUES (3, 2, 'two'), (2, 3, 'three'), (2, 0, 'zero'), (3, 2, 'two'), (3, 1, 'one');
SELECT COUNT(DISTINCT b,c) FROM t2 GROUP BY a;
DROP TABLE t2;
CREATE TABLE t1(a BIT(13), KEY(a));
INSERT IGNORE INTO t1(a) VALUES (65535),(65525),(65535),(65535),(65535), (65535),(65535),(65535),(65535),(65535), (65535),(65525),(65535),(65535),(65535), (65535),(65535),(65535),(65535),(65535);
...
DROP TABLE t1, t2;
CREATE TABLE IF NOT EXISTS t1 ( f1 bit(2) NOT NULL default b'10', f2 bit(14) NOT NULL default b'11110000111100' ) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
DROP TABLE t1;
CREATE TABLE IF NOT EXISTS t1 ( f1 bit(2) NOT NULL ) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
INSERT INTO t1 VALUES (b'');
SELECT bin(f1) FROM t1;
DROP TABLE t1;
CREATE TABLE t1(a POINT) ENGINE=InnoDB;
INSERT INTO t1 VALUES();
CREATE TEMPORARY TABLE t2(a BIT(60)) ENGINE=InnoDB SELECT a FROM t1 GROUP BY a HAVING a IS NULL ORDER BY a DESC;
