...
INSERT INTO t2 VALUES (1, 'desk organiser', '2003-10-15'), (2, 'CD player', '1993-11-05'), (3, 'TV set', '1996-03-10'), (4, 'bookcase', '1982-01-10'), (5, 'exercise bike', '2004-05-09'), (6, 'sofa', '1987-06-05'), (7, 'popcorn maker', '2001-11-22'), (8, 'acquarium', '1992-08-04'), (9, 'study desk', '1984-09-16'), (10, 'lava lamp', '1998-12-25');
...
SELECT d,a,b,c FROM t1 partition (p1,p9,p11,p17) ORDER BY d  FOR SHARE SKIP LOCKED;
SELECT d,a,b,c FROM t1 ORDER BY d FOR SHARE SKIP LOCKED;
ANALYZE TABLE t3;
SELECT d,a,b,c FROM t3 ORDER BY d FOR SHARE SKIP LOCKED;
explain SELECT d,a,b,c FROM t3 ORDER BY d  FOR SHARE SKIP LOCKED;
...
SELECT d,a,b,c FROM t1 partition (p1,p9,p11,p17) ORDER BY d  FOR UPDATE SKIP LOCKED;
