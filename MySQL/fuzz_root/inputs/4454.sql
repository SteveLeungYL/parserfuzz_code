...
CREATE TABLE t1 (f1 INTEGER, f2 INTEGER);
INSERT INTO t1 VALUES (1,2);
CREATE ALGORITHM=MERGE VIEW view_merge AS SELECT (SELECT MAX(t1.f1) AS dt_f1 FROM (t1) WHERE t1.f2 > table1.f2 OR t1.f2 != 2) FROM (SELECT * FROM t1)  AS table1 ;
SELECT * FROM view_merge;
DROP TABLE t1;
DROP VIEW view_merge;
CREATE TABLE t1 (f1 INTEGER, f2 INTEGER, f3 INTEGER, PRIMARY KEY(f1), KEY(f2));
...
DROP TABLE t1,t2;
DROP VIEW v1,v2;
CREATE TABLE t1 (f1 INTEGER, f2 INTEGER, f3 INTEGER, f4 VARCHAR(1), PRIMARY KEY(f1));
CREATE VIEW v1 AS SELECT * FROM t1;
SELECT SUM(t2.f4), (SELECT COUNT(dt1.f2) FROM (t1 AS dt1) WHERE dt1.f3 = v1.f1 ) FROM ( v1 RIGHT OUTER JOIN( t1 AS t2 STRAIGHT_JOIN t1 AS t3 ON 1) ON 1);
set sql_mode="";
explain SELECT SUM(t2.f4), (SELECT COUNT(dt1.f2) FROM (t1 AS dt1) WHERE dt1.f3 = v1.f1 ) FROM ( v1 RIGHT OUTER JOIN( t1 AS t2 STRAIGHT_JOIN t1 AS t3 ON 1) ON 1);
SELECT SUM(t2.f4), (SELECT COUNT(dt1.f2) FROM (t1 AS dt1) WHERE dt1.f3 = v1.f1 ) FROM ( v1 RIGHT OUTER JOIN( t1 AS t2 STRAIGHT_JOIN t1 AS t3 ON 1) ON 1);
...
SELECT (SELECT SUM(dt2.f2) FROM (t1 AS dt1 STRAIGHT_JOIN t1  AS dt2 ON 1) WHERE dt1.f3 = table1.f3) AS field1, MAX(table2.f2) AS field4 FROM (view_t1 AS table1 RIGHT JOIN ((t1 AS table2 JOIN t1 AS table3 ON (table3 .f1 = table2.f2))) ON 1) WHERE table1 . f3 != 'x' ;
set sql_mode="";
explain SELECT (SELECT SUM(dt2.f2) FROM (t1 AS dt1 STRAIGHT_JOIN t1  AS dt2 ON 1) WHERE dt1.f3 = table1.f3) AS field1, MAX(table2.f2) AS field4 FROM (view_t1 AS table1 RIGHT JOIN ((t1 AS table2 JOIN t1 AS table3 ON (table3 .f1 = table2.f2))) ON 1) WHERE table1 . f3 != 'x' ;
SELECT (SELECT SUM(dt2.f2) FROM (t1 AS dt1 STRAIGHT_JOIN t1  AS dt2 ON 1) WHERE dt1.f3 = table1.f3) AS field1, MAX(table2.f2) AS field4 FROM (view_t1 AS table1 RIGHT JOIN ((t1 AS table2 JOIN t1 AS table3 ON (table3 .f1 = table2.f2))) ON 1) WHERE table1 . f3 != 'x' ;
set sql_mode=default;
DROP TABLE t1;
DROP view view_t1;
CREATE TABLE t1 ( f1 INTEGER, f2 INTEGER, f3 INTEGER, f4 INTEGER);
explain SELECT f1 FROM t1 AS table1 WHERE f2 <> (SELECT f1 FROM t1 WHERE table1.f3 = (SELECT f4 FROM t1));
...
explain SELECT (SELECT MIN(f2) FROM t1 AS t2 WHERE t2.f2 = ISNULL(dt.f1)) AS field1 FROM t1 AS dt GROUP BY field1;
SELECT (SELECT MIN(f2) FROM t1 AS t2 WHERE t2.f2 = ISNULL(dt.f1)) AS field1 FROM t1 AS dt GROUP BY field1;
DROP TABLE t1;
