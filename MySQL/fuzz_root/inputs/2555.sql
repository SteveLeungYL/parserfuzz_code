...
show index from t1;
show index from t1;
create table t3 ( a varchar(20) not null, b varchar(20) not null, key (a,b) ) charset latin1 engine=heap;
...
drop table t1;
CREATE TABLE t1(col1 VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,  col2 VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,  UNIQUE KEY key1 USING HASH (col1, col2)) ENGINE=MEMORY;
INSERT INTO t1 VALUES('A', 'A');
INSERT INTO t1 VALUES('A ', 'A ');
DROP TABLE t1;
CREATE TABLE t1(col1 VARCHAR(32) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,  col2 VARCHAR(32) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,  UNIQUE KEY key1 USING HASH (col1, col2)) ENGINE=MEMORY;
INSERT INTO t1 VALUES('A', 'A');
INSERT INTO t1 VALUES('A ', 'A ');
DROP TABLE t1;
CREATE TABLE t1 (col_int_nokey INT, col_int_key INT, INDEX(col_int_key) USING HASH) ENGINE = HEAP;
...
DROP TABLE t1;
CREATE TABLE t1 ( f1 int NOT NULL, f2 int NOT NULL, f3 date NOT NULL, KEY k1 (f2,f3) USING HASH ) ENGINE=MEMORY;
INSERT INTO t1 VALUES (1, 15409, '2019-02-25'), (2, 15911, '2019-02-25'), (3, 15929, '2019-02-25'), (4, 15936, '2019-02-25'), (5, 16004, '2019-02-25'), (6, 16005, '2019-02-25'), (7, 16007, '2019-02-25'),(8, 16029, '2019-02-25'), (9, 16031, '2019-02-25'), (10, 16052, '2019-02-25'), (11, 16054, '2019-02-25'), (12, 16040, '2019-02-25'), (13, 12485, '2019-02-25'), (14, 15892, '2019-02-25'), (15, 16035, '2019-02-25'), (16, 16060, '2019-02-25'), (17, 16066, '2019-02-25'), (18, 16093, '2019-02-25'), (19, 16057, '2019-02-25'), (20, 16027, '2019-02-25'), (21, 15988, '2019-02-25');
