...
ALTER TABLE mysql.user ADD COLUMN Password char(41) character set latin1 collate latin1_bin DEFAULT '' NOT NULL AFTER user;
...
INSERT INTO mysql.user VALUES  ('%','user_sha_pass_wp','','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','','','','',0,0,0,0,'sha256_password','$5$J=M`}N+i=%1o6z\'$Ns0lpHRzOCs9T4n5df6ZxAYsUaK1yFMnRGlp3T48AW/','N');
FLUSH PRIVILEGES;
