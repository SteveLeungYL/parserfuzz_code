...
select hex(s1) from t1;
drop table t1;
create table t1 (a text character set utf8mb4, primary key(a(371))) engine MyISAM ROW_FORMAT=COMPACT;
...
insert into t1 values ('ꪪꪪꪪ');
drop table t1;
create table t1 ( c char(10) character set utf8mb4, unique key a using hash (c(1)) ) engine=MyISAM;
show create table t1;
...
drop table t1;
create table t1 ( c char(10) character set utf8mb4, unique key a using btree (c(1)) ) engine=MyISAM;
show create table t1;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( c char(10) character set utf8mb4, unique key a (c(1)) ) engine=MyISAM;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
insert into t1 values ('б');
...
insert into t1 values ('ꪪꪪꪪ');
drop table t1;
create table t1 ( c char(10) character set utf8mb4 collate utf8mb4_bin, unique key a using hash (c(1)) ) engine=MyISAM;
show create table t1;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( c char(10) character set utf8mb4 collate utf8mb4_bin, unique key a using btree (c(1)) ) engine=MyISAM;
show create table t1;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( c char(10) character set utf8mb4 collate utf8mb4_bin, unique key a (c(1)) ) engine=MyISAM;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
insert into t1 values ('б');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( str varchar(255) character set utf8mb4 not null, key str  (str(2)) ) engine=MyISAM;
...
select * from t1 where str='str';
drop table t1;
create table t1 ( str varchar(255) character set utf8mb4 not null, key str using btree (str(2)) ) engine=MyISAM;
INSERT INTO t1 VALUES ('str');
INSERT INTO t1 VALUES ('str2');
select * from t1 where str='str';
drop table t1;
create table t1 ( str varchar(255) character set utf8mb4 not null, key str using hash (str(2)) ) engine=MyISAM;
INSERT INTO t1 VALUES ('str');
INSERT INTO t1 VALUES ('str2');
select * from t1 where str='str';
drop table t1;
...
DROP TABLE t1;
SET NAMES utf8mb4;
CREATE TABLE t1 ( subject varchar(255) character set utf8mb4 collate utf8mb4_unicode_ci, p varchar(15) character set utf8mb4 ) ENGINE= MyISAM DEFAULT CHARSET=latin1;
...
DROP TABLE t1;
CREATE TABLE t1 ( id       int unsigned NOT NULL auto_increment, list_id  smallint unsigned NOT NULL, term     TEXT NOT NULL, PRIMARY KEY(id), INDEX(list_id, term(4)) ) ENGINE=MyISAM CHARSET=utf8mb4;
...
DROP TABLE t1;
set names utf8mb4;
create table t1 ( a int primary key, b varchar(6), index b3(b(3)) ) engine=MyISAM character set=utf8mb4;
insert into t1 values(1,'foo'),(2,'foobar');
select * from t1 where b like 'foob%';
alter table t1 engine=innodb;
select * from t1 where b like 'foob%';
drop table t1;
create table t1 ( a enum('петя','вася','анюта') character set utf8mb4 not null default 'анюта', b set('петя','вася','анюта') character set utf8mb4 not null default 'анюта' ) engine MyISAM;
...
drop table t1;
create table t1 ( id int not null, city varchar(20) not null, key (city(7),id) ) character set=utf8mb4 engine MyISAM;
...
CREATE TABLE t2 ( `msisdn` varchar(15) NOT NULL default '', `operator_id` int(11) NOT NULL default '0', `created` datetime NOT NULL default '0000-00-00 00:00:00', UNIQUE KEY `PK_user` (`msisdn`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
...
drop table t1;
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
CREATE TABLE t1 ( a varchar(255) NOT NULL default '', KEY a (a) ) ENGINE=MyISAM ROW_FORMAT=DYNAMIC DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;
...
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
SET NAMES utf8mb4;
CREATE TABLE t1(a VARCHAR(255), KEY(a)) ENGINE=MyISAM ROW_FORMAT=DYNAMIC DEFAULT CHARSET=utf8mb4;
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=MyISAM default character set utf8mb4 collate utf8mb4_general_ci;
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=MyISAM default character set utf8mb4 collate utf8mb4_unicode_ci;
insert into t1 values ('あいうえおかきくけこさしすせそ');
insert into t1 values ('さしすせそかきくけこあいうえお');
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=MyISAM default character set utf8mb4 collate utf8mb4_bin;
insert into t1 values ('あいうえおかきくけこさしすせそ');
insert into t1 values ('さしすせそかきくけこあいうえお');
...
drop table t1;
SET NAMES utf8mb4;
CREATE TABLE t1 (id int PRIMARY KEY, a varchar(16) collate utf8mb4_unicode_ci NOT NULL default '', b int, f varchar(128) default 'XXX', INDEX (a(4)) ) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE t1;
SET NAMES utf8mb4;
CREATE TABLE t1 ( a CHAR(13) DEFAULT '', INDEX(a) ) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
SELECT * FROM t1 WHERE a LIKE 'Käli Käli 2%';
DROP TABLE t1;
CREATE TABLE t1 ( a char(255) DEFAULT '' ) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
INSERT INTO t1 VALUES ('Käli Käli 2-4');
INSERT INTO t1 VALUES ('Käli Käli 2-4');
SELECT * FROM t1 WHERE a LIKE 'Käli Käli 2%';
...
DROP TABLE t1;
SET NAMES latin2;
CREATE TABLE t1 ( id int(11) NOT NULL default '0', tid int(11) NOT NULL default '0', val text NOT NULL, INDEX idx(tid, val(10)) ) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
...
SELECT * FROM t1 WHERE tid=72 and val LIKE 'VOLN� ADSL';
DROP TABLE t1;
create table t1(a char(200) collate utf8mb4_unicode_ci NOT NULL default '') default charset=utf8mb4 collate=utf8mb4_unicode_ci engine MyISAM;
...
DROP TABLE t1;
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
create table t1 ( a varchar(26) not null ) default character set utf8mb4 ENGINE MyISAM;
...
select * from t1;
drop table t1;
create table t1 ( a varchar(4000) not null ) default character set utf8mb4 engine MyISAM;
...
drop table t1;
CREATE TABLE t1 ( colA int(11) NOT NULL, colB varchar(255) character set utf8mb4 NOT NULL, PRIMARY KEY  (colA) ) ENGINE=MyISAM DEFAULT CHARSET=latin1;
INSERT INTO t1 (colA, colB) VALUES (1, 'foo'), (2, 'foo bar');
CREATE TABLE t2 ( colA int(11) NOT NULL, colB varchar(255) character set utf8mb4 NOT NULL, KEY bad  (colA,colB(3)) ) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
DROP TABLE t1;
DROP TABLE IF EXISTS t1;
CREATE TABLE t1 ( predicted_order int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE MyISAM;
...
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
CREATE TABLE t1 ( clipid INT NOT NULL, Tape TINYTEXT, PRIMARY KEY (clipid), KEY tape(Tape(255)) ) CHARACTER SET=utf8mb4 ROW_FORMAT=DYNAMIC ENGINE=MyISAM;
ALTER TABLE t1 ADD mos TINYINT DEFAULT 0 AFTER clipid;
SHOW CREATE TABLE t1;
DROP TABLE t1;
SET sql_mode = default;
DROP TABLE IF EXISTS t1;
CREATE TABLE t1 ( u_decimal int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE MyISAM;
...
CREATE TABLE t2 ( u_decimal int NOT NULL, utf8mb3_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb3 ENGINE MyISAM;
...
CREATE TABLE t3 ( u_decimal int NOT NULL, utf8mb3_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8 ENGINE MyISAM;
INSERT INTO t3 SELECT * FROM t1;
DROP TABLE IF EXISTS t4;
CREATE TABLE t4 ( u_decimal int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE MyISAM;
