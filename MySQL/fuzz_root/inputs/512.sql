...
EXPLAIN  SELECT *  FROM t1 JOIN t2 ON t1.col1_idx=t2.col1_idx WHERE t2.col3=5;
EXPLAIN  SELECT * FROM t1 JOIN t2 ON t1.col1_idx=t2.col1_idx WHERE t1.col3=t2.col3;
EXPLAIN  SELECT * FROM t1 JOIN t2 ON t1.col1_idx=t2.col1_idx WHERE t1.col2_idx=1 AND t2.col2_idx=1;
EXPLAIN  SELECT *  FROM t1 JOIN t2 ON t1.col1_idx=t2.col1_idx WHERE t1.col2_idx>1 AND t2.col2_idx>1;
EXPLAIN  SELECT *  FROM t1 JOIN t2 ON t1.col1_idx>t2.col1_idx WHERE t1.col2_idx>1 AND t2.col2_idx>1;
EXPLAIN  SELECT *  FROM t1 JOIN t2 ON t1.col1_idx>t2.col1_idx WHERE t1.col1_idx>1 AND t2.col1_idx>1;
EXPLAIN  SELECT *  FROM t1 JOIN t2 ON t1.col1_idx>t2.col1_idx WHERE t1.col1_idx!=1 AND t2.col1_idx>4;
