...
select * from t1;
drop table t1;
create table t1 ( skey tinyint unsigned NOT NULL auto_increment PRIMARY KEY, sval char(20) );
...
CHECK TABLE t1;
DROP TABLE IF EXISTS t1;
CREATE TABLE `t1` ( t1_name VARCHAR(255) DEFAULT NULL, t1_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT, KEY (t1_name), PRIMARY KEY (t1_id) ) charset latin1 AUTO_INCREMENT = 1000;
...
insert into t1 values (NULL);
insert into t2 values (NULL, LAST_INSERT_ID()), (NULL, LAST_INSERT_ID()), (NULL, LAST_INSERT_ID());
insert into t1 values (NULL);
insert into t2 values (NULL, LAST_INSERT_ID()), (NULL, LAST_INSERT_ID()), (NULL, LAST_INSERT_ID()), (NULL, LAST_INSERT_ID());
select * from t2;
drop table t1, t2;
...
select * from t1;
drop table t1;
create table t1 (rowid int not null auto_increment, val int not null,primary key (rowid), unique(val));
...
SELECT * FROM t1;
DELETE FROM t1;
INSERT INTO t1 VALUES (0x7FFFFFFFFFFFFFFD, 2), (NULL, 3);
SELECT * FROM t1;
DROP TABLE t1;
SET sql_mode = '';
CREATE TABLE t1 (c1 DOUBLE NOT NULL AUTO_INCREMENT, c2 INT, PRIMARY KEY (c1)) ENGINE=InnoDB;
