...
select * FROM t1;
select t1.* FROM t1;
CREATE TABLE t2 ( auto int, fld1 int(6) unsigned zerofill DEFAULT '000000' NOT NULL, companynr tinyint(2) unsigned zerofill DEFAULT '00' NOT NULL, fld3 char(30) DEFAULT '' NOT NULL, fld4 char(35) DEFAULT '' NOT NULL, fld5 char(35) DEFAULT '' NOT NULL, fld6 char(4) DEFAULT '' NOT NULL ) ENGINE=archive;
...
CREATE TABLE `t5` ( `a` int(11) NOT NULL auto_increment, b char(12), PRIMARY KEY  (`a`) )  DEFAULT CHARSET=latin1;
...
DROP TABLE t5;
CREATE TABLE `t5` ( `a` int(11) NOT NULL auto_increment, b char(12), KEY  (`a`) )  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5;
INSERT INTO t5 VALUES (NULL, "foo");
INSERT INTO t5 VALUES (NULL, "foo");
INSERT INTO t5 VALUES (NULL, "foo");
INSERT INTO t5 VALUES (NULL, "foo");
...
SELECT * FROM t5 WHERE a=3;
DROP TABLE t5;
CREATE TABLE `t5` ( `a` int(11) NOT NULL auto_increment, b blob(12), KEY  (`a`) )  DEFAULT CHARSET=latin1;
INSERT INTO t5 VALUES (NULL, "foo");
...
DROP TABLE t5;
CREATE TABLE `t5` ( `a` int(11) NOT NULL auto_increment, b blob(12), c blob(12), KEY  (`a`) )  DEFAULT CHARSET=latin1;
...
select * from t1;
DROP TABLE t5;
CREATE TABLE `t5` ( `a` int(11) NOT NULL auto_increment, b varchar(250), c varchar(800), KEY  (`a`) )  DEFAULT CHARSET=latin1;
INSERT INTO t5 VALUES (NULL, "foo", "grok this!");
INSERT INTO t5 VALUES (NULL, "We the people", NULL);
INSERT INTO t5 VALUES (NULL, "in order to form a more peefect union", "secure the blessing of liberty");
INSERT INTO t5 VALUES (NULL, "establish justice", "to ourselves and");
...
SELECT * FROM t5;
CREATE TABLE `t6` ( `a` int(11) NOT NULL auto_increment, b blob(12), c int, KEY  (`a`) )  DEFAULT CHARSET=latin1;
SELECT * FROM t6;
...
analyze table t1;
SELECT DATA_LENGTH, AVG_ROW_LENGTH FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='t1' AND TABLE_SCHEMA='test';
...
INSERT INTO t1 VALUES('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'), ('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'), ('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa');
...
CREATE TABLE t1(a INT, b CHAR(255), c CHAR(255), d CHAR(255), e CHAR(255), f INT) ENGINE=ARCHIVE DEFAULT CHARSET utf8;
...
DELETE FROM v;
DELETE t1, t2 FROM archive_table AS t1, innodb_table AS t2 WHERE t1.id = t2.id;
DELETE t1 FROM v AS t1, innodb_table AS t2 WHERE t1.id = t2.id;
UPDATE archive_table SET x = 1000;
UPDATE archive_table AS t1, innodb_table AS t2 SET t1.x = 1000, t2.x = 2000 WHERE t1.id = t2.id;
UPDATE v SET x = 1000;
UPDATE v AS t1, innodb_table AS t2 SET t1.x = 1000, t2.x = 2000 WHERE t1.id = t2.id;
...
UPDATE archive_table AS t1, innodb_table AS t2 SET t1.x = 1, t2.x = 2 WHERE t1.id = t2.id AND t1.id = 1;
UPDATE v SET x = 1 WHERE id = 1;
UPDATE v AS t1, innodb_table AS t2 SET t1.x = 1, t2.x = 2 WHERE t1.id = t2.id AND t1.id = 1;
UPDATE archive_table SET x = x + 1;
UPDATE archive_table SET x = NULL;
UPDATE archive_table AS t1, innodb_table AS t2 SET t1.x = t1.x + 1, t2.x = t2.x + 1 WHERE t1.id = t2.id AND t1.id = 1;
UPDATE v SET x = x + 1 WHERE id = 1;
UPDATE v AS t1, innodb_table AS t2 SET t1.x = t1.x + 1, t2.x = t2.x + 1 WHERE t1.id = t2.id AND t1.id = 1;
SELECT * FROM archive_table ORDER BY id;
SELECT * FROM innodb_table ORDER BY id;
UPDATE archive_table AS t1, innodb_table AS t2 SET t2.x = t2.x + 1 WHERE t1.id = t2.id;
SELECT * FROM archive_table ORDER BY id;
SELECT * FROM innodb_table ORDER BY id;
DELETE FROM archive_table;
DELETE FROM v;
