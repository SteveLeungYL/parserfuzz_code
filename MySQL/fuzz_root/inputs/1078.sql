...
insert into t1 (a, b, c) values (1, 0, '2001-01-01 01:01:01'), (2, 0, '2002-02-02 02:02:02'), (3, 0, '2003-03-03 03:03:03');
select * from t1;
...
select * from t1;
insert into t1 (a, c) values (4, '2004-04-04 00:00:00'), (6, '2006-06-06 06:06:06') on duplicate key update b = 4;
select * from t1;
drop table t1;
set time_zone= @@global.time_zone;
CREATE TABLE t1 ( f1 INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, f2 TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, f3 TIMESTAMP NOT NULL default '0000-00-00 00:00:00');
...
DROP TABLE t1;
DROP TABLE t2;
CREATE TABLE t1( c1 TIMESTAMP NOT NULL, c2 TIMESTAMP NOT NULL DEFAULT '2001-01-01 01:01:01', c3 INT NOT NULL DEFAULT 42);
SHOW CREATE TABLE t1;
...
CREATE TABLE t1( dummy INT, i1_null_const INT NULL DEFAULT 42, t1_null_now TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP, t1_null_const TIMESTAMP NULL DEFAULT '2001-01-01 03:03:03', i2_not_null_const INT NOT NULL DEFAULT 42, t2_not_null_now TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, t2_not_null_const TIMESTAMP NOT NULL DEFAULT '2001-01-01 03:03:03', i3_null INT NULL, t3_null TIMESTAMP NULL, i4_not_null INT NOT NULL, t4_not_null TIMESTAMP NOT NULL);
SHOW CREATE TABLE t1;
DROP TABLE t1;
