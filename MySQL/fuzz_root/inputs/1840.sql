...
CREATE TABLE test_repair_table4 ( num int not null, magic_no int(4) unsigned zerofill DEFAULT '0000' NOT NULL, company_name char(30) DEFAULT '' NOT NULL, founded char(4) DEFAULT '' NOT NULL ) ENGINE = CSV;
...
CREATE TABLE test_repair_table5 ( num int not null, magic_no int(4) unsigned zerofill DEFAULT '0000' NOT NULL, company_name char(30) DEFAULT '' NOT NULL, founded char(4) DEFAULT '' NOT NULL ) ENGINE = CSV;
...
set names latin1;
create table t1 ( c varchar(1) not null, name varchar(64) not null ) character set latin1 engine=csv;
