...
CREATE TABLE t1 ( status enum('active','passive') character set utf16 collate utf16_general_ci  NOT NULL default 'passive' );
SHOW CREATE TABLE t1;
...
SET NAMES latin1;
CREATE TABLE t1 ( s1 TINYTEXT CHARACTER SET utf16, s2 TEXT CHARACTER SET utf16, s3 MEDIUMTEXT CHARACTER SET utf16, s4 LONGTEXT CHARACTER SET utf16 );
