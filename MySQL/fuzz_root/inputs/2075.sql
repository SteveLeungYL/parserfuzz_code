...
CREATE DATABASE mysqltest2 DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_unicode_ci;
use mysqltest1;
CREATE EVENT ev1 ON SCHEDULE AT '2030-01-01 00:00:00' DO BEGIN DECLARE перем1 CHAR(10); SELECT COLLATION(перем1) AS c1, COLLATION('текст') AS c2, COLLATION(_utf8 'текст') AS c3, COLLATION(_koi8r    '�����') AS c4, @@collation_connection AS c5, @@character_set_client AS c6; END;
CREATE EVENT ev2 ON SCHEDULE AT '2030-01-01 00:00:00' DO BEGIN DECLARE перем1 CHAR(10) CHARACTER SET utf8; SELECT COLLATION(перем1) AS c1, COLLATION('текст') AS c2, COLLATION(_utf8 'текст') AS c3, COLLATION(_koi8r    '�����') AS c4, @@collation_connection AS c5, @@character_set_client AS c6; END;
CREATE EVENT mysqltest2.ev3 ON SCHEDULE AT '2030-01-01 00:00:00' DO BEGIN DECLARE перем1 CHAR(10) CHARACTER SET utf8; SELECT COLLATION(перем1) AS c1, COLLATION('текст') AS c2, COLLATION(_utf8 'текст') AS c3, COLLATION(_koi8r    '�����') AS c4, @@collation_connection AS c5, @@character_set_client AS c6; END;
CREATE EVENT mysqltest2.ev4 ON SCHEDULE AT '2030-01-01 00:00:00' DO BEGIN DECLARE перем1 CHAR(10) CHARACTER SET utf8; SELECT COLLATION(перем1) AS c1, COLLATION('текст') AS c2, COLLATION(_utf8 'текст') AS c3, COLLATION(_koi8r    '�����') AS c4, @@collation_connection AS c5, @@character_set_client AS c6; END;
