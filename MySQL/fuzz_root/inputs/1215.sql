...
CREATE TABLE t1 (a int unsigned auto_increment primary key, b varchar(64)) ENGINE = InnoDB DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/t1_dir';
CREATE TABLE t2 (a int unsigned auto_increment primary key, b varchar(64)) ENGINE = InnoDB PARTITION BY LIST (a) (PARTITION p1 VALUES IN (1,3,5,7,9) DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/p1_dir', PARTITION p2 VALUES IN (0,2,4,6,8) DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/p2_dir');
...
DROP TABLE t1, t2;
CREATE TABLE t1 (a int unsigned auto_increment primary key, b varchar(64)) ENGINE = InnoDB DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/t1_dir';
CREATE TABLE t2 (a int unsigned auto_increment primary key, b varchar(64)) ENGINE = InnoDB PARTITION BY range (a) (PARTITION p1 VALUES less than (10) DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/p1_dir', PARTITION p2 VALUES less than (20) DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/p2_dir');
INSERT INTO t1 VALUES (1, "t1"), (5, "t1");
...
SHOW CREATE TABLE t2;
DROP table t1,t2;
CREATE TABLE t1 (id INT, purchased DATE) ENGINE = InnoDB DATA DIRECTORY = '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/t1_dir';
CREATE TABLE t2 (id INT, purchased DATE) PARTITION BY RANGE( YEAR(purchased) ) SUBPARTITION BY HASH( TO_DAYS(purchased) ) ( PARTITION p0 VALUES LESS THAN (1990) ( SUBPARTITION s0 data directory='/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/sp0_dir', SUBPARTITION s1), PARTITION p1 VALUES LESS THAN (2000) ( SUBPARTITION s2, SUBPARTITION s3 data directory='/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/sp3_dir' ));
...
SET GLOBAL innodb_default_row_format=COMPACT;
CREATE TABLE t1 ( col1 INT UNSIGNED, col2 DATETIME ) ENGINE=INNODB PARTITION BY RANGE COLUMNS(col2) ( PARTITION p0 VALUES LESS THAN ('1960-01-01'), PARTITION p1 VALUES LESS THAN ('1980-01-01') );
...
SELECT NAME,ROW_FORMAT  FROM INFORMATION_SCHEMA.INNODB_TABLES WHERE NAME LIKE '%t1%' ORDER BY TABLE_ID;
CREATE TABLE t2 LIKE t1;
ALTER TABLE t2 REMOVE PARTITIONING;
