...
SELECT service_get_write_locks('holder_name_space', 'l1_2', 'middle', 'l3_2', 0) AS col1;
SELECT service_get_write_locks('holder_name_space', 'l1_3', 'l2_3', 'last', 0) AS col1;
SELECT service_get_write_locks('holder_name_space', 'l1_1', 'l2_1', 'l3_1', 'l1_2', 'l2_2', 'l3_2', 'l1_3', 'l2_3', 'l3_3', 0) AS col1;
SELECT service_release_locks('holder_name_space') AS col1;
SELECT service_release_locks('holder_name_space') AS col1;
SELECT COUNT(*) = 0 AS expect_1 FROM performance_schema.metadata_locks WHERE OBJECT_TYPE = 'LOCKING SERVICE';
...
SELECT COUNT(*) = 1 AS expect_1 FROM performance_schema.metadata_locks WHERE OBJECT_TYPE = 'LOCKING SERVICE';
SELECT service_get_write_locks('holder_name_space', 'l1', 0) AS col1, service_get_write_locks('holder_name_space', 'l2', 0);
SELECT COUNT(*) = 2 AS expect_1 FROM performance_schema.metadata_locks WHERE OBJECT_TYPE = 'LOCKING SERVICE';
SELECT service_release_locks('holder_name_space') AS col1;
SELECT service_release_locks('holder_name_space') AS col1;
