...
CREATE TRIGGER t1_ai AFTER INSERT ON t1 FOR EACH ROW BEGIN UPDATE t2 SET c2= c2 + 1; END;
LOCK TABLE t1 WRITE;
...
CREATE TRIGGER t1_au AFTER UPDATE ON t1 FOR EACH ROW INSERT INTO t2 VALUES (new.fld1, new.fld2);
