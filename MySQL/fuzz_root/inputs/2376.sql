...
DELETE FROM t1 WHERE ( EXISTS (SELECT * WHERE '520:33:32.77' < (c1 - INTERVAL(1) MONTH)) ) LIKE (c1);
DROP TABLE t1;
...
CREATE TABLE t(x VARCHAR(10), gc INTEGER GENERATED ALWAYS AS (x LIKE 'abba' ESCAPE 'b'));
...
DROP VIEW v;
DROP TABLE t;
SELECT _latin1'abc' LIKE _latin1'a\\bc' ESCAPE _latin1'' AS col1, _utf8mb4'abc' LIKE _utf8mb4'a\\bc' ESCAPE _utf8mb4'' AS col2, _latin1'abc' LIKE _latin1'a\\bc' ESCAPE _ascii'' AS col3;
