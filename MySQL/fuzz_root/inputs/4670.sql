...
SELECT * FROM t1;
DELETE FROM t1;
INSERT INTO t1 VALUES (-1, 2, 3, NULL), (NULL, 20, 30, NULL), (NULL, 200, 300, NULL);
INSERT INTO t1(a, b, c) VALUES (-2, 2, 3), (NULL, 20, 30), (NULL, 200, 300);
INSERT INTO t1(b, c) VALUES (2, 3), (20, 30), (200, 300);
INSERT INTO t1(a) VALUES (-3), (NULL), (NULL);
SELECT * FROM t1;
DELETE FROM t1;
REPLACE INTO t1 VALUES (-1, 2, 3, NULL), (NULL, 20, 30, NULL), (NULL, 200, 300, NULL);
REPLACE INTO t1(a, b, c) VALUES (-2, 2, 3), (NULL, 20, 30), (NULL, 200, 300);
REPLACE INTO t1(b, c) VALUES (2, 3), (20, 30), (200, 300);
REPLACE INTO t1(a) VALUES (-3), (NULL), (NULL);
SELECT * FROM t1;
...
INSERT INTO t1_data VALUES (11, 12), (NULL, 22), (31, NULL), (NULL, NULL);
CREATE TABLE t2_data(a INT, b INT, c INT, d INT);
INSERT INTO t2_data VALUES (11, 12, 13, 14), (NULL, 22, 23, 24), (31, NULL, 33, 34), (41, 42, NULL, 44), (51, 52, 53, NULL), (NULL, NULL, NULL, NULL);
...
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW UPDATE t1 SET a1 = 1 WHERE a1 IS NULL;
INSERT INTO t1 VALUES (NULL);
DROP TRIGGER t1_bi;
DROP TABLE t1;
CREATE TABLE t1(a1 INT NOT NULL);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW UPDATE t1 SET a1 = 1;
INSERT INTO t1 VALUES (NULL);
DROP TRIGGER t1_bi;
DROP TABLE t1;
...
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW BEGIN SET NEW.a1 = COALESCE(NEW.a1, 5); SET NEW.a2 = COALESCE(NEW.a2, 7); END; ;
INSERT INTO t1 VALUES (NULL, 3);
SELECT * FROM t1;
DROP TRIGGER t1_bi;
DROP TABLE t1;
CREATE TABLE t1 (a1 INT PRIMARY KEY);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = 2;
INSERT INTO t1 VALUES (NULL);
SELECT * FROM t1;
DROP TRIGGER t1_bi;
DROP TABLE t1;
CREATE TABLE t1 (a1 INT PRIMARY KEY);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = 1;
INSERT INTO t1 VALUES (NULL);
SELECT * FROM t1;
INSERT INTO t1 VALUES (NULL);
SELECT * FROM t1;
...
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = '2012-03-03', NEW.a2 = '2001-01-01 09:01:00';
INSERT INTO t1 VALUES (NULL, NULL);
SELECT * FROM t1;
DROP TRIGGER t1_bi;
DROP TABLE t1;
CREATE TABLE t1(a1 CHAR(10) NOT NULL, a2 VARCHAR(255) NOT NULL);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = 'MySQL' , NEW.a2 = 'Includes testing of MySQL';
INSERT INTO t1 VALUES (NULL, NULL);
SELECT * FROM t1;
DROP TRIGGER t1_bi;
DROP TABLE t1;
CREATE TABLE t1(a1 BINARY(10) NOT NULL, a2 VARBINARY(255) NOT NULL);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = '0x41', NEW.a2 = '0x42';
INSERT INTO t1 VALUES (NULL, NULL);
SELECT * FROM t1;
DROP TRIGGER t1_bi;
DROP TABLE t1;
...
CREATE TRIGGER t1_bu BEFORE UPDATE ON t1 FOR EACH ROW SET NEW.a1 = 2;
...
CREATE TABLE t1(a1 INT PRIMARY KEY, a2 INT);
INSERT INTO t1 VALUES (1, 1);
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = NULL;
...
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = NULL , NEW.a2 = NULL , NEW.a3 = NULL;
...
CREATE TRIGGER t1_bi BEFORE INSERT ON t1 FOR EACH ROW SET NEW.a1 = NULL , NEW.a2 = NULL;
...
CREATE TRIGGER t1_bu BEFORE UPDATE ON t1 FOR EACH ROW SET NEW.a1 = NULL;
