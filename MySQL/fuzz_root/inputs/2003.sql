...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( c char(10) character set utf8mb4, unique key a (c(1)) ) engine=heap;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
insert into t1 values ('б');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( c char(10) character set utf8mb4 collate utf8mb4_bin, unique key a (c(1)) ) engine=heap;
insert into t1 values ('a'),('b'),('c'),('d'),('e'),('f');
insert into t1 values ('aa');
insert into t1 values ('aaa');
insert into t1 values ('б');
...
select c as c_a from t1 where c='б';
drop table t1;
create table t1 ( str varchar(255) character set utf8mb4 not null, key str  (str(2)) ) engine=heap;
...
DROP TABLE t1;
SET NAMES utf8mb4;
CREATE TABLE t1 ( subject varchar(255) character set utf8mb4 collate utf8mb4_unicode_ci, p varchar(15) character set utf8mb4 ) ENGINE= heap DEFAULT CHARSET=latin1;
...
DROP TABLE t1;
set names utf8mb4;
create table t1 ( a int primary key, b varchar(6), index b3(b(3)) ) engine=heap character set=utf8mb4;
insert into t1 values(1,'foo'),(2,'foobar');
select * from t1 where b like 'foob%';
alter table t1 engine=innodb;
select * from t1 where b like 'foob%';
drop table t1;
create table t1 ( a enum('петя','вася','анюта') character set utf8mb4 not null default 'анюта', b set('петя','вася','анюта') character set utf8mb4 not null default 'анюта' ) engine heap;
...
select c1 as c2h from t1 where c1 like 'ab#_def' escape '#';
drop table t1;
CREATE TABLE t1 ( user varchar(255) NOT NULL default '' ) ENGINE=heap DEFAULT CHARSET=latin1;
...
drop table t1;
create table t1 ( id int not null, city varchar(20) not null, key (city(7),id) ) character set=utf8mb4 engine heap;
...
CREATE TABLE t2 ( `msisdn` varchar(15) NOT NULL default '', `operator_id` int(11) NOT NULL default '0', `created` datetime NOT NULL default '0000-00-00 00:00:00', UNIQUE KEY `PK_user` (`msisdn`) ) ENGINE=heap DEFAULT CHARSET=utf8mb4;
...
drop table t1;
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
CREATE TABLE t1 ( a varchar(255) NOT NULL default '', KEY a (a) ) ENGINE=heap ROW_FORMAT=DYNAMIC DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;
...
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
SET NAMES utf8mb4;
CREATE TABLE t1(a VARCHAR(255), KEY(a)) ENGINE=heap ROW_FORMAT=DYNAMIC DEFAULT CHARSET=utf8mb4;
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=heap default character set utf8mb4 collate utf8mb4_general_ci;
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=heap default character set utf8mb4 collate utf8mb4_unicode_ci;
insert into t1 values ('あいうえおかきくけこさしすせそ');
insert into t1 values ('さしすせそかきくけこあいうえお');
...
drop table t1;
set names utf8mb4;
create table t1 (a varchar(30) not null primary key) engine=heap default character set utf8mb4 collate utf8mb4_bin;
insert into t1 values ('あいうえおかきくけこさしすせそ');
insert into t1 values ('さしすせそかきくけこあいうえお');
...
drop table t1;
SET NAMES utf8mb4;
CREATE TABLE t1 (id int PRIMARY KEY, a varchar(16) collate utf8mb4_unicode_ci NOT NULL default '', b int, f varchar(128) default 'XXX', INDEX (a(4)) ) ENGINE=heap DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE t1;
SET NAMES utf8mb4;
CREATE TABLE t1 ( a CHAR(13) DEFAULT '', INDEX(a) ) ENGINE=heap DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
INSERT INTO t1 VALUES  ('Käli Käli 2-4'), ('Käli Käli 2-4'), ('Käli Käli 2+4'), ('Käli Käli 2+4'), ('Käli Käli 2-6'), ('Käli Käli 2-6');
INSERT INTO t1 SELECT * FROM t1;
CREATE TABLE t2 ( a CHAR(13) DEFAULT '', INDEX(a) ) ENGINE=heap DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
DROP TABLE t1,t2;
CREATE TABLE t1 ( a char(255) DEFAULT '',  KEY(a(10)) ) ENGINE=heap DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
INSERT INTO t1 VALUES ('Käli Käli 2-4');
SELECT * FROM t1 WHERE a LIKE 'Käli Käli 2%';
INSERT INTO t1 VALUES ('Käli Käli 2-4');
SELECT * FROM t1 WHERE a LIKE 'Käli Käli 2%';
DROP TABLE t1;
CREATE TABLE t1 ( a char(255) DEFAULT '' ) ENGINE=heap DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
INSERT INTO t1 VALUES ('Käli Käli 2-4');
INSERT INTO t1 VALUES ('Käli Käli 2-4');
SELECT * FROM t1 WHERE a LIKE 'Käli Käli 2%';
...
DROP TABLE t1;
SET NAMES latin2;
create table t1(a char(200) collate utf8mb4_unicode_ci NOT NULL default '') default charset=utf8mb4 collate=utf8mb4_unicode_ci engine heap;
...
DROP TABLE t1;
SET sql_mode = 'NO_ENGINE_SUBSTITUTION';
create table t1 ( a varchar(26) not null ) default character set utf8mb4 ENGINE heap;
...
select * from t1;
drop table t1;
create table t1 ( a varchar(4000) not null ) default character set utf8mb4 engine heap;
...
drop table t1;
CREATE TABLE t1 ( colA int(11) NOT NULL, colB varchar(255) character set utf8mb4 NOT NULL, PRIMARY KEY  (colA) ) ENGINE=heap DEFAULT CHARSET=latin1;
INSERT INTO t1 (colA, colB) VALUES (1, 'foo'), (2, 'foo bar');
CREATE TABLE t2 ( colA int(11) NOT NULL, colB varchar(255) character set utf8mb4 NOT NULL, KEY bad  (colA,colB(3)) ) ENGINE=heap DEFAULT CHARSET=latin1;
...
DROP TABLE t1;
DROP TABLE IF EXISTS t1;
CREATE TABLE t1 ( predicted_order int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE heap;
...
SET sql_mode = default;
DROP TABLE IF EXISTS t1;
CREATE TABLE t1 ( u_decimal int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE heap;
...
CREATE TABLE t2 ( u_decimal int NOT NULL, utf8mb3_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb3 ENGINE heap;
...
CREATE TABLE t3 ( u_decimal int NOT NULL, utf8mb3_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8 ENGINE heap;
INSERT INTO t3 SELECT * FROM t1;
DROP TABLE IF EXISTS t4;
CREATE TABLE t4 ( u_decimal int NOT NULL, utf8mb4_encoding VARCHAR(10) NOT NULL ) CHARACTER SET utf8mb4 ENGINE heap;
