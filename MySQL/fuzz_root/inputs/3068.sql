...
CREATE TABLE t1 (a INT);
INSERT INTO t1 VALUES (289), (298), (234), (456), (789);
CREATE DEFINER = u1@localhost PROCEDURE p1() BEGIN SET @A= 20; SELECT 1; SELECT 2, 3 UNION SELECT 4, 5; SELECT 6, 7, 8;  END ;;
CREATE DEFINER = u1@localhost FUNCTION f1 () RETURNS int BEGIN SET NAMES 'big5'; RETURN (SELECT COUNT(*) FROM t1); END ;;
...
CREATE DEFINER = u1@localhost PROCEDURE p2(x int) INSERT INTO t1 VALUES (x) ;;
DROP DATABASE db1_extended;
