...
SELECT * FROM t2;
DROP TABLE t2;
CREATE TABLE t2 ( id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, a DATETIME NOT NULL ) AUTO_INCREMENT = 1;
...
SELECT TIMEDIFF( '2000:01:01 00:00:00+02:00', '2000:01:01 00:00:00.000001+01:00' );
