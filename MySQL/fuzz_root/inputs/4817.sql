...
INSERT INTO t1 VALUES(1, _binary '2012-05-19 09:06:07', 20120519090607), (1, _binary '2012-05-19 09:06:07', 20120519090607), (2, _binary '12012-05-19 09:06:07', 120120519090607), (2, _binary '12012-05-19 09:06:07', 120120519090607);
...
SELECT d + (vb | vb) , f + (vb | vb), dd + (vb | vb), CAST((vb | vb) AS DECIMAL(10,2)), d + (i | i) , f + (i | i), dd + (i | i), CAST((i | i) AS DECIMAL(10,2)) FROM t1 WHERE gid = 1;
SELECT d * (vb | vb) , f * (vb | vb), dd * (vb | vb), (vb | vb) / d , (vb | vb) / f, (vb | vb) / dd, d * (i | i) , f * (i | i), dd * (i | i), (i | i) / d , (i | i) / f, (i | i) / dd FROM t1 WHERE gid = 2;
SET sql_mode='';
SELECT d + BIT_OR(vb), f + BIT_OR(vb), dd + BIT_OR(vb), CAST(BIT_OR(vb) AS DECIMAL(10,2)), d + BIT_OR(i), f + BIT_OR(i), dd + BIT_OR(i), CAST(BIT_OR(i) AS DECIMAL(10,2)) FROM t1 WHERE gid= 1;
SELECT d * BIT_OR(vb), f * BIT_OR(vb), dd * BIT_OR(vb), BIT_OR(vb) / d, CAST(BIT_OR(vb) AS DECIMAL(10,2)), BIT_OR(vb) / f, BIT_OR(vb) / dd, d * BIT_OR(i), f * BIT_OR(i), dd * BIT_OR(i), BIT_OR(i) / d, CAST(BIT_OR(i) AS DECIMAL(10,2)), BIT_OR(i) / f, BIT_OR(i) / dd FROM t1 WHERE gid= 2;
SELECT d + BIT_OR(vb), f + BIT_OR(vb), dd + BIT_OR(vb), d + BIT_OR(i), f + BIT_OR(i), dd + BIT_OR(i) FROM t1 WHERE gid= 1 GROUP BY gid;
SELECT d * BIT_OR(vb), f * BIT_OR(vb), dd * BIT_OR(vb),  BIT_OR(vb) / d, BIT_OR(vb) / f, BIT_OR(vb) / dd, d * BIT_OR(i), f * BIT_OR(i), dd * BIT_OR(i),  BIT_OR(i) / d, BIT_OR(i) / f, BIT_OR(i) / dd FROM t1 WHERE gid= 2 GROUP BY gid;
drop table t1;
