...
CREATE TABLE t1 ( status enum('active','passive') character set utf32 collate utf32_general_ci  NOT NULL default 'passive' );
SHOW CREATE TABLE t1;
...
SET sql_mode = '';
create table t1 (a varchar(333) character set utf32, key(a)) row_format=dynamic;
...
SET NAMES latin1;
CREATE TABLE t1 ( s1 TINYTEXT CHARACTER SET utf32, s2 TEXT CHARACTER SET utf32, s3 MEDIUMTEXT CHARACTER SET utf32, s4 LONGTEXT CHARACTER SET utf32 );
