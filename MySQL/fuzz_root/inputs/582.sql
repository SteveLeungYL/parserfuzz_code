...
SELECT * FROM t2;
DROP TABLE t1, t2;
CREATE TABLE t1 ( a TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, b DATETIME ON UPDATE CURRENT_TIMESTAMP, c INT, d INT );
CREATE TABLE t2 ( a TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, b DATETIME ON UPDATE CURRENT_TIMESTAMP, c INT KEY, d INT );
...
SELECT * FROM t2;
DROP TABLE t1, t2;
CREATE TABLE t1 ( a TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, b DATETIME ON UPDATE CURRENT_TIMESTAMP, c INT );
...
SHOW CREATE TABLE t1;
DROP TABLE t1;
CREATE TABLE t1 ( a TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, b TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, c DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, d DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP );
CREATE TABLE t2 ( placeholder1 INT, placeholder2 INT, placeholder3 INT, placeholder4 INT, a TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, b TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00', c DATETIME, d DATETIME );
...
SELECT * FROM t11;
CREATE TABLE t12 ( k TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, l TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, m TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, n TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, o TIMESTAMP NOT NULL DEFAULT '1986-09-27 03:00:00.098765', p TIMESTAMP NULL, q DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, r DATETIME DEFAULT CURRENT_TIMESTAMP, s DATETIME ON UPDATE CURRENT_TIMESTAMP, t DATETIME NULL, u DATETIME DEFAULT '1986-09-27 03:00:00.098765' ) SELECT * FROM t1;
...
CREATE TABLE t1 ( a DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, b DATETIME DEFAULT CURRENT_TIMESTAMP, c DATETIME ON UPDATE CURRENT_TIMESTAMP, d DATETIME NULL, e DATETIME DEFAULT '1986-09-27 03:00:00.098765' );
INSERT INTO t1 VALUES ();
...
CREATE TABLE t1 ( dummy INT, a DATETIME NULL DEFAULT NULL, b DATETIME NULL DEFAULT "2011-11-18", like_b DATETIME NULL DEFAULT CURRENT_TIMESTAMP, c DATETIME NOT NULL DEFAULT "2011-11-18", like_c DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, d TIMESTAMP NULL DEFAULT "2011-05-03" ON UPDATE CURRENT_TIMESTAMP, e TIMESTAMP NOT NULL DEFAULT "2011-05-03", f TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, g TIMESTAMP NULL DEFAULT NULL, h INT NULL, i INT NOT NULL DEFAULT 42 );
SHOW CREATE TABLE t1;
...
DROP VIEW v1;
DROP TABLE t1;
CREATE TABLE t1 ( a TIMESTAMP NOT NULL DEFAULT '1973-08-14 09:11:22.089786' ON UPDATE CURRENT_TIMESTAMP, c INT KEY );
SET TIMESTAMP = 114167482.534231;
INSERT INTO t1 ( c ) VALUES ( 1 );
...
DROP VIEW v1;
DROP TABLE t1;
CREATE TABLE t1 ( a INT, b INT, ts TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY ( a, ts ) );
...
SELECT * FROM t1;
DROP TABLE t1;
CREATE TABLE t1 ( a TIMESTAMP NOT NULL DEFAULT '1999-12-01 11:22:33' ON UPDATE CURRENT_TIMESTAMP, b DATETIME DEFAULT '1999-12-01 11:22:33' );
INSERT INTO t1 VALUES ();
