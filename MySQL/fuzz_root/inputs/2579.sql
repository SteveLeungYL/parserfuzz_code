...
CREATE TRIGGER post_insert_t1 AFTER INSERT ON t1 FOR EACH ROW BEGIN INSERT INTO t3 VALUES(5); END;
...
CREATE TRIGGER post_insert_t1 AFTER INSERT ON t1 FOR EACH ROW BEGIN INSERT IGNORE INTO t3 VALUES (5),(6); END;
CREATE TRIGGER post_update_t1 AFTER UPDATE ON t1 FOR EACH ROW BEGIN INSERT IGNORE INTO t3 VALUES(4); END;
...
SET sql_mode= @org_mode;
SET sql_mode='STRICT_TRANS_TABLES';
CREATE PROCEDURE p1() BEGIN # warning DECLARE too_few_records CONDITION FOR SQLSTATE '01000'; SIGNAL too_few_records SET MYSQL_ERRNO = 1261; END ;
CALL p1();
DROP PROCEDURE p1;
SET sql_mode= @org_mode;
CREATE TABLE t1(a INT);
