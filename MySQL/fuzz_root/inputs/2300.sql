...
EXECUTE s6;
truncate table t;
SELECT HEX(0xABCDEF & 0x123456 & 0x789123), HEX(0xABCDEF | 0x123456 | 0x789123), HEX(0xABCDEF ^ 0x123456 ^ 0x789123);
INSERT INTO t(group_id, a) VALUES (1, 0x34567101ABFF00F0F0), (2, NULL), (1, 0x34567102ABF0F0F0F0), (3, 0x34567104ABF0F0F0F0), (1, 0x34567103ABFF00F0F0), (5, 0xABCDEF), (5, 0x123456), (5, 0x789123), (1, 0x34567104ABF0F0F0F0), (4, 0x34567100ABF0F0F0F0), (4, NULL), (4, 0x34567101ABFF00F0F0);
SELECT group_id, HEX(BIT_AND(a)), HEX(BIT_OR(a)), HEX(BIT_XOR(a)) FROM t GROUP BY group_id;
SELECT SQL_BUFFER_RESULT group_id, HEX(BIT_AND(a)), HEX(BIT_OR(a)), HEX(BIT_XOR(a)) FROM t GROUP BY group_id;
...
DROP TABLE t2;
INSERT INTO t(group_id, a) VALUES (1, NULL), (1, 0x312E35), (1, 0x312E35), (4, 0x312E38), (4, NULL), (4, 0x312E38), (5, 0x31), (5, 0x31);
SELECT group_id, 1.0 * BIT_AND(a), 1.0 * BIT_OR(a) FROM t WHERE group_id != 5 GROUP BY group_id;
SELECT group_id, 0x30 << BIT_AND(a), 0x30 << BIT_OR(a) FROM t WHERE group_id = 5 GROUP BY group_id;
SELECT group_id, CONCAT('My', BIT_AND(a)), CONCAT('My', BIT_OR(a)) FROM t GROUP BY group_id;
SELECT group_id, 0x30 << BIT_XOR(a) FROM t GROUP BY group_id;
SELECT group_id, 1.0 * BIT_XOR(a) FROM t GROUP BY group_id;
TRUNCATE TABLE t;
INSERT INTO t(group_id, a) VALUES (1, 0x7BAFBF), (1, 0x4A818A), (4, 0xFFFEFF), (4, NULL), (4, 0xCED0C7), (5, 0xFB), (5, 0xCA);
SELECT group_id, 1.0 * BIT_XOR(a), CONCAT('My', BIT_XOR(a)) FROM t GROUP BY group_id;
SELECT group_id, 0x30 << BIT_XOR(a) FROM t WHERE group_id = 5 GROUP BY group_id;
SELECT group_id, 1.0 * BIT_AND(a) FROM t GROUP BY group_id;
SELECT group_id, 0x30 << BIT_AND(a) FROM t GROUP BY group_id;
SELECT group_id, 1.0 * BIT_OR(a) FROM t GROUP BY group_id;
SELECT group_id, 0x30 << BIT_OR(a) FROM t GROUP BY group_id;
DROP table t;
...
INSERT INTO r SELECT 96, HEX(@a << 96), HEX(@a >> 96);
INSERT INTO r SELECT 95, HEX(@a << 95), HEX(@a >> 95);
INSERT INTO r SELECT 94, HEX(@a << 94), HEX(@a >> 94);
INSERT INTO r SELECT 93, HEX(@a << 93), HEX(@a >> 93);
INSERT INTO r SELECT 92, HEX(@a << 92), HEX(@a >> 92);
INSERT INTO r SELECT 91, HEX(@a << 91), HEX(@a >> 91);
INSERT INTO r SELECT 90, HEX(@a << 90), HEX(@a >> 90);
INSERT INTO r SELECT 89, HEX(@a << 89), HEX(@a >> 89);
INSERT INTO r SELECT 88, HEX(@a << 88), HEX(@a >> 88);
INSERT INTO r SELECT 87, HEX(@a << 87), HEX(@a >> 87);
INSERT INTO r SELECT 86, HEX(@a << 86), HEX(@a >> 86);
INSERT INTO r SELECT 85, HEX(@a << 85), HEX(@a >> 85);
INSERT INTO r SELECT 84, HEX(@a << 84), HEX(@a >> 84);
INSERT INTO r SELECT 83, HEX(@a << 83), HEX(@a >> 83);
INSERT INTO r SELECT 82, HEX(@a << 82), HEX(@a >> 82);
INSERT INTO r SELECT 81, HEX(@a << 81), HEX(@a >> 81);
INSERT INTO r SELECT 80, HEX(@a << 80), HEX(@a >> 80);
INSERT INTO r SELECT 79, HEX(@a << 79), HEX(@a >> 79);
INSERT INTO r SELECT 78, HEX(@a << 78), HEX(@a >> 78);
INSERT INTO r SELECT 77, HEX(@a << 77), HEX(@a >> 77);
INSERT INTO r SELECT 76, HEX(@a << 76), HEX(@a >> 76);
INSERT INTO r SELECT 75, HEX(@a << 75), HEX(@a >> 75);
INSERT INTO r SELECT 74, HEX(@a << 74), HEX(@a >> 74);
INSERT INTO r SELECT 73, HEX(@a << 73), HEX(@a >> 73);
INSERT INTO r SELECT 72, HEX(@a << 72), HEX(@a >> 72);
INSERT INTO r SELECT 71, HEX(@a << 71), HEX(@a >> 71);
INSERT INTO r SELECT 70, HEX(@a << 70), HEX(@a >> 70);
INSERT INTO r SELECT 69, HEX(@a << 69), HEX(@a >> 69);
INSERT INTO r SELECT 68, HEX(@a << 68), HEX(@a >> 68);
INSERT INTO r SELECT 67, HEX(@a << 67), HEX(@a >> 67);
INSERT INTO r SELECT 66, HEX(@a << 66), HEX(@a >> 66);
INSERT INTO r SELECT 65, HEX(@a << 65), HEX(@a >> 65);
INSERT INTO r SELECT 64, HEX(@a << 64), HEX(@a >> 64);
INSERT INTO r SELECT 63, HEX(@a << 63), HEX(@a >> 63);
INSERT INTO r SELECT 62, HEX(@a << 62), HEX(@a >> 62);
INSERT INTO r SELECT 61, HEX(@a << 61), HEX(@a >> 61);
INSERT INTO r SELECT 60, HEX(@a << 60), HEX(@a >> 60);
INSERT INTO r SELECT 59, HEX(@a << 59), HEX(@a >> 59);
INSERT INTO r SELECT 58, HEX(@a << 58), HEX(@a >> 58);
INSERT INTO r SELECT 57, HEX(@a << 57), HEX(@a >> 57);
INSERT INTO r SELECT 56, HEX(@a << 56), HEX(@a >> 56);
INSERT INTO r SELECT 55, HEX(@a << 55), HEX(@a >> 55);
INSERT INTO r SELECT 54, HEX(@a << 54), HEX(@a >> 54);
INSERT INTO r SELECT 53, HEX(@a << 53), HEX(@a >> 53);
INSERT INTO r SELECT 52, HEX(@a << 52), HEX(@a >> 52);
INSERT INTO r SELECT 51, HEX(@a << 51), HEX(@a >> 51);
INSERT INTO r SELECT 50, HEX(@a << 50), HEX(@a >> 50);
INSERT INTO r SELECT 49, HEX(@a << 49), HEX(@a >> 49);
INSERT INTO r SELECT 48, HEX(@a << 48), HEX(@a >> 48);
INSERT INTO r SELECT 47, HEX(@a << 47), HEX(@a >> 47);
INSERT INTO r SELECT 46, HEX(@a << 46), HEX(@a >> 46);
INSERT INTO r SELECT 45, HEX(@a << 45), HEX(@a >> 45);
INSERT INTO r SELECT 44, HEX(@a << 44), HEX(@a >> 44);
INSERT INTO r SELECT 43, HEX(@a << 43), HEX(@a >> 43);
INSERT INTO r SELECT 42, HEX(@a << 42), HEX(@a >> 42);
INSERT INTO r SELECT 41, HEX(@a << 41), HEX(@a >> 41);
INSERT INTO r SELECT 40, HEX(@a << 40), HEX(@a >> 40);
INSERT INTO r SELECT 39, HEX(@a << 39), HEX(@a >> 39);
INSERT INTO r SELECT 38, HEX(@a << 38), HEX(@a >> 38);
INSERT INTO r SELECT 37, HEX(@a << 37), HEX(@a >> 37);
INSERT INTO r SELECT 36, HEX(@a << 36), HEX(@a >> 36);
INSERT INTO r SELECT 35, HEX(@a << 35), HEX(@a >> 35);
INSERT INTO r SELECT 34, HEX(@a << 34), HEX(@a >> 34);
INSERT INTO r SELECT 33, HEX(@a << 33), HEX(@a >> 33);
INSERT INTO r SELECT 32, HEX(@a << 32), HEX(@a >> 32);
INSERT INTO r SELECT 31, HEX(@a << 31), HEX(@a >> 31);
INSERT INTO r SELECT 30, HEX(@a << 30), HEX(@a >> 30);
INSERT INTO r SELECT 29, HEX(@a << 29), HEX(@a >> 29);
INSERT INTO r SELECT 28, HEX(@a << 28), HEX(@a >> 28);
INSERT INTO r SELECT 27, HEX(@a << 27), HEX(@a >> 27);
INSERT INTO r SELECT 26, HEX(@a << 26), HEX(@a >> 26);
INSERT INTO r SELECT 25, HEX(@a << 25), HEX(@a >> 25);
INSERT INTO r SELECT 24, HEX(@a << 24), HEX(@a >> 24);
INSERT INTO r SELECT 23, HEX(@a << 23), HEX(@a >> 23);
INSERT INTO r SELECT 22, HEX(@a << 22), HEX(@a >> 22);
INSERT INTO r SELECT 21, HEX(@a << 21), HEX(@a >> 21);
INSERT INTO r SELECT 20, HEX(@a << 20), HEX(@a >> 20);
INSERT INTO r SELECT 19, HEX(@a << 19), HEX(@a >> 19);
INSERT INTO r SELECT 18, HEX(@a << 18), HEX(@a >> 18);
INSERT INTO r SELECT 17, HEX(@a << 17), HEX(@a >> 17);
INSERT INTO r SELECT 16, HEX(@a << 16), HEX(@a >> 16);
INSERT INTO r SELECT 15, HEX(@a << 15), HEX(@a >> 15);
INSERT INTO r SELECT 14, HEX(@a << 14), HEX(@a >> 14);
INSERT INTO r SELECT 13, HEX(@a << 13), HEX(@a >> 13);
INSERT INTO r SELECT 12, HEX(@a << 12), HEX(@a >> 12);
INSERT INTO r SELECT 11, HEX(@a << 11), HEX(@a >> 11);
INSERT INTO r SELECT 10, HEX(@a << 10), HEX(@a >> 10);
INSERT INTO r SELECT 9, HEX(@a << 9), HEX(@a >> 9);
INSERT INTO r SELECT 8, HEX(@a << 8), HEX(@a >> 8);
INSERT INTO r SELECT 7, HEX(@a << 7), HEX(@a >> 7);
INSERT INTO r SELECT 6, HEX(@a << 6), HEX(@a >> 6);
INSERT INTO r SELECT 5, HEX(@a << 5), HEX(@a >> 5);
INSERT INTO r SELECT 4, HEX(@a << 4), HEX(@a >> 4);
INSERT INTO r SELECT 3, HEX(@a << 3), HEX(@a >> 3);
INSERT INTO r SELECT 2, HEX(@a << 2), HEX(@a >> 2);
INSERT INTO r SELECT 1, HEX(@a << 1), HEX(@a >> 1);
...
insert into t values(1,''), (1,NULL), (2,NULL), (2, ''), (3, ''), (3, 'x'), (4, 'x'), (4, '');
...
INSERT INTO t VALUES (0x6BC7CECF8B98558D7AA6048D0EBCF9FE, 1), (0x7BB1512989AB38A2E91A9B17A268BE16, 1), (0xDB502FB16FDED188FEF1EA604820EB41, 1), (0xD78F9D9F1730AB1AF54C091A1D79F3FC, 2), (0xF762A25313567145D235362F44D17C2C, 2), (0xB6A05F62DFBDA311FDE3D4C09041D682, 2);
...
CREATE TABLE t( a BINARY(2) NOT NULL, b BINARY(1) NOT NULL ) engine=innodb;
