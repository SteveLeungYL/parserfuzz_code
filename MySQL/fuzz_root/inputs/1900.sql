...
SELECT * FROM `����һ`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FROM `����һ`;;
...
CREATE TABLE `�����` LIKE `����һ`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `�����` CHARACTER SET gb18030;;
SELECT COUNT(*) AS `Expect 3` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id AND (`����һ`.c <> `�����`.c OR `����һ`.b <> `�����`.b OR `����һ`.v <> `�����`.v);;
DROP TABLE `�����`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY '5C' ENCLOSED BY '"' FROM `����һ`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `�����` LIKE `����һ`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `�����` CHARACTER SET gb18030 FIELDS TERMINATED BY '5C' ENCLOSED BY '"';;
SELECT COUNT(*) AS `Expect 3` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id AND (`����һ`.c <> `�����`.c OR `����һ`.b <> `�����`.b OR `����һ`.v <> `�����`.v);;
DROP TABLE `�����`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY '5C' ENCLOSED BY '0' LINES TERMINATED BY '1' FROM `����һ`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `�����` LIKE `����һ`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `�����` CHARACTER SET gb18030 FIELDS TERMINATED BY '5C' ENCLOSED BY '0' LINES TERMINATED BY '1';;
SELECT COUNT(*) AS `Expect 3` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id AND (`����һ`.c <> `�����`.c OR `����һ`.b <> `�����`.b OR `����һ`.v <> `�����`.v);;
DROP TABLE `�����`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY 'd' FROM `����һ`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `�����` LIKE `����һ`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `�����` CHARACTER SET gb18030 FIELDS TERMINATED BY 'd';;
SELECT COUNT(*) AS `Expect 3` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `����һ`, `�����` WHERE `����һ`.id = `�����`.id AND (`����һ`.c <> `�����`.c OR `����һ`.b <> `�����`.b OR `����һ`.v <> `�����`.v);;
DROP TABLE `�����`, `����һ`;
