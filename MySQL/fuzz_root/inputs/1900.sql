...
SELECT * FROM `表格一`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FROM `表格一`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `表格二` LIKE `表格一`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `表格二` CHARACTER SET gb18030;;
SELECT COUNT(*) AS `Expect 3` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id AND (`表格一`.c <> `表格二`.c OR `表格一`.b <> `表格二`.b OR `表格一`.v <> `表格二`.v);;
DROP TABLE `表格二`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY '5C' ENCLOSED BY '"' FROM `表格一`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `表格二` LIKE `表格一`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `表格二` CHARACTER SET gb18030 FIELDS TERMINATED BY '5C' ENCLOSED BY '"';;
SELECT COUNT(*) AS `Expect 3` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id AND (`表格一`.c <> `表格二`.c OR `表格一`.b <> `表格二`.b OR `表格一`.v <> `表格二`.v);;
DROP TABLE `表格二`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY '5C' ENCLOSED BY '0' LINES TERMINATED BY '1' FROM `表格一`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `表格二` LIKE `表格一`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `表格二` CHARACTER SET gb18030 FIELDS TERMINATED BY '5C' ENCLOSED BY '0' LINES TERMINATED BY '1';;
SELECT COUNT(*) AS `Expect 3` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id AND (`表格一`.c <> `表格二`.c OR `表格一`.b <> `表格二`.b OR `表格一`.v <> `表格二`.v);;
DROP TABLE `表格二`;
SELECT * INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' FIELDS TERMINATED BY 'd' FROM `表格一`;;
SELECT LOAD_FILE('/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt');;
CREATE TABLE `表格二` LIKE `表格一`;;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/gb18030_encoding.txt' INTO TABLE `表格二` CHARACTER SET gb18030 FIELDS TERMINATED BY 'd';;
SELECT COUNT(*) AS `Expect 3` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id;;
SELECT COUNT(*) AS `Expect 0` FROM `表格一`, `表格二` WHERE `表格一`.id = `表格二`.id AND (`表格一`.c <> `表格二`.c OR `表格一`.b <> `表格二`.b OR `表格一`.v <> `表格二`.v);;
DROP TABLE `表格二`, `表格一`;
