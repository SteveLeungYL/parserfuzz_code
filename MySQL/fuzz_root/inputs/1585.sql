...
CREATE TABLE t1 ( a VARCHAR(255) NOT NULL, b VARCHAR(255) NOT NULL, c1 VARCHAR(255) DEFAULT NULL, d VARCHAR(255) NOT NULL, PRIMARY KEY (a,b,d) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
SELECT * FROM (SELECT COUNT(DISTINCT t1.a), t1.b FROM t1 RIGHT JOIN t2 ON t1.a=t2.a GROUP BY t1.b) as tt;
DROP TABLE t1,t2;
CREATE DATABASE db1;
...
SELECT (EXISTS (SELECT 1 FROM t1 GROUP BY (NOT EXISTS (SELECT 1 FROM (SELECT 1 FROM t1 GROUP BY a)r)))) FROM t1;
DROP TABLE t1;
...
DROP TABLE v0;
WITH RECURSIVE v0 ( c1 ) AS ( SELECT 0 UNION SELECT c1 + 1 FROM v0 ) SELECT * FROM v0, v0 AS v1 NATURAL JOIN v0 AS v2;
WITH RECURSIVE v0 ( c1 ) AS ( SELECT 0 UNION SELECT 1 FROM v0 ) SELECT * FROM v0, v0 AS v1 NATURAL JOIN v0 AS v2;
