...
drop table t1;
drop table t2;
create table t1 ( ujis varchar(1) character set ujis, name varchar(64), ucs2 varchar(1) character set ucs2, ujis2 varchar(1) character set ujis );
...
drop table t1;
create table t1 ( ujis char(1) character set ujis, ucs2 char(1) character set ucs2, name char(64) );
