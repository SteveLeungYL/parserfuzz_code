...
DELETE FROM t2;
INSERT INTO t2 VALUES (INET6_ATON('1.2.3.4')), (INET6_ATON('255.255.255.255')), (INET6_ATON('::1.2.3.4')), (INET6_ATON('::ffff:255.255.255.255')), (INET6_ATON('::')), (INET6_ATON('::1')), (INET6_ATON('1020:3040:5060:7080:90A0:B0C0:D0E0:F010'));
SELECT INET6_NTOA(ip), HEX(ip), LENGTH(ip) FROM t2;
DELETE FROM t2;
...
SHOW CREATE TABLE t1;
DROP TABLE t1;
CREATE TABLE t1 ( pk INTEGER PRIMARY KEY, col_time TIME DEFAULT NULL, col_varchar VARCHAR(1) DEFAULT NULL, KEY (col_varchar) );
