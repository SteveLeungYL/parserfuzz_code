...
DROP TABLE t1;
CREATE TEMPORARY TABLE tmp_t1(CHECK((f1 + f2) > 10), f1 int CHECK (f1 < 12), f2 int);
SHOW CREATE TABLE tmp_t1;
SELECT * FROM INFORMATION_SCHEMA.CHECK_CONSTRAINTS;
DROP TABLE tmp_t1;
CREATE TABLE t1(f1 INT CHECK (f1 < 10), f2 INT, CHECK (f2 < 10), CONSTRAINT min CHECK (f1 + f2 > 10), CONSTRAINT max CHECK (f1 + f2 < 929));
SHOW CREATE TABLE t1;
...
INSERT INTO t2 VALUES(3,20);
SELECT * FROM t2;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp2.xml" INTO TABLE t1;;
SELECT * FROM t1;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp2.xml" IGNORE INTO TABLE t1;;
SELECT * FROM t1;
DROP TABLE t1,t2;
CREATE TABLE t1(f1 INT PRIMARY KEY, f2 INT CHECK (f2 < 10));
INSERT INTO t1 VALUES (1, 1);
...
DROP TABLE t1, t2;
CREATE TABLE t1 ( `f1` int(10) unsigned NOT NULL auto_increment, `f2` int(11) NOT NULL default '0', PRIMARY KEY  (`f1`) );
INSERT INTO t1 VALUES (4433,5424);
CREATE TABLE t2 ( `f3` int(10) unsigned NOT NULL default '0', `f4` int(10) unsigned NOT NULL default '0' CHECK (f4 <= 500), PRIMARY KEY  (`f3`,`f4`) );
...
ALTER TABLE t1 ADD COLUMN c3 INT, ADD CONSTRAINT ck3 CHECK (c3 < 10);
ALTER TABLE t1 DROP CHECK ck3, DROP COLUMN c3, ADD COLUMN c4 INT, ADD CONSTRAINT ck4 CHECK( c4 > 10);
SHOW CREATE TABLE t1;
DROP TABLE t1;
...
ALTER TABLE t1 ADD CONSTRAINT ck11 CHECK(c1 > 1), ADD CONSTRAINT ck12 CHECK(c1 < 1), ADD CONSTRAINT ck21 CHECK(c2 > 1), ADD CONSTRAINT ck22 CHECK(c2 < 1), ADD CONSTRAINT ck31 CHECK(c3 > 1), ADD CONSTRAINT ck32 CHECK(c3 < 1), ADD CONSTRAINT ck41 CHECK(c4 > 1), ADD CONSTRAINT ck42 CHECK(c4 < 1);
SHOW CREATE TABLE t1;
ALTER TABLE t1 DROP CHECK ck21, ADD CONSTRAINT ck21 CHECK (c1 > 10), DROP CHECK ck22, ADD CONSTRAINT ck22 CHECK (c1 < 10), DROP CHECK ck31, ADD CONSTRAINT ck31 CHECK (c1 > 10), DROP CHECK ck32, ADD CONSTRAINT ck32 CHECK (c1 < 10), DROP CHECK ck41, ADD CONSTRAINT ck41 CHECK (c1 > 10), DROP CHECK ck42, ADD CONSTRAINT ck42 CHECK (c1 < 10), ALTER CHECK ck11 NOT ENFORCED, ALTER CHECK ck12 NOT ENFORCED, ALTER CHECK ck11 ENFORCED;
ALTER TABLE t1 DROP CHECK ck11, ALTER CHECK ck11 NOT ENFORCED, ADD CONSTRAINT ck11 CHECK (c1 > 10);
SHOW CREATE TABLE t1;
DROP TABLE t1;
CREATE TABLE t1 (f1 INT check (f1 < 10), f2 INT);
SHOW CREATE TABLE t1;
ALTER TABLE t1 DROP COLUMN f1;
ALTER TABLE t1 ADD COLUMN f1 INT check(f1 < 10), ADD CONSTRAINT check(f1 + f2 < 10), ADD CONSTRAINT check(f2 < 10);
SHOW CREATE TABLE t1;
ALTER TABLE t1 DROP COLUMN f1;
...
CREATE TABLE t1 ( c1 BIT(7) CHECK(c1 < B'1111100'), c2 BOOLEAN CHECK(c2 > 0), c3 TINYINT CHECK(c3 > 10), c4 SMALLINT CHECK(c4 > 10), c5 MEDIUMINT CHECK(c5 > 10), c6 INT CHECK(c6 > 10), c7 BIGINT CHECK(c7 > 10), c8 DECIMAL(6,2) CHECK(c8 > 10.1), c9 FLOAT(6,2) CHECK(c9 > 10.1), c10 DOUBLE(6,2) CHECK(c10 > 10.1));
SHOW CREATE TABLE t1;
...
DROP TABLE t1;
CREATE TABLE t1(c1 CHAR(1) CHECK(c1 > 'a'), c2 VARCHAR(1) CHECK(c2 > 'a'), c3 BINARY(1) CHECK(c3 > 'a'), c4 VARBINARY(1) CHECK(c4 > 'a'), c5 TINYBLOB CHECK(c5 > 'a'), c6 TINYTEXT CHECK(c6 > 'a'), c7 BLOB CHECK(c7 > 'a'), c8 TEXT CHECK(c8 > 'a'), c9 MEDIUMBLOB CHECK(c9 > 'a'), c10 MEDIUMTEXT CHECK(c10 > 'a'), c11 LONGBLOB CHECK(c11 > 'a'), c12 LONGTEXT CHECK(c12 > 'a'));
SHOW CREATE TABLE t1;
INSERT INTO t1(c1) VALUES('a');
...
DROP TABLE t1;
CREATE TABLE t1 (c1 DATE CHECK(c1 > '2007-01-01'), c2 DATETIME CHECK(c2 > '2007-01-01 12:00:01'), c3 TIMESTAMP CHECK(c3 > '2007-01-01 00:00:01.000000'), c4 TIME CHECK(c4 > '12:00:01.000000'), c5 YEAR CHECK(c5 > '2007'));
...
INSERT INTO t1(c1,c2,c3,c4,c5) VALUES('2008-01-01','2007-01-01 12:00:02','2007-01-01 00:00:02.000000', '12:00:02.000000','2008');
DROP TABLE t1;
...
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON DELETE SET NULL, CHECK (b IS NOT NULL) );
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON DELETE SET NULL );
ALTER TABLE child ADD CONSTRAINT CHECK (b IS NOT NULL);
ALTER TABLE child DROP FOREIGN KEY child_ibfk_1;
ALTER TABLE child ADD CONSTRAINT FOREIGN KEY (b) REFERENCES parent(a) ON DELETE SET NULL, ADD CONSTRAINT CHECK (b IS NOT NULL);
DROP TABLE child;
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE SET NULL, CHECK (b IS NOT NULL) );
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE SET NULL );
ALTER TABLE child ADD CONSTRAINT CHECK (b IS NOT NULL);
ALTER TABLE child DROP FOREIGN KEY child_ibfk_1;
ALTER TABLE child ADD CONSTRAINT FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE SET NULL, ADD CONSTRAINT CHECK (b IS NOT NULL);
DROP TABLE child;
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE CASCADE, CHECK (b IS NOT NULL) );
CREATE TABLE child ( b INT, c INT CHECK (c < 10), INDEX(b), FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE CASCADE );
ALTER TABLE child ADD CONSTRAINT CHECK (b IS NOT NULL);
ALTER TABLE child DROP FOREIGN KEY child_ibfk_1;
ALTER TABLE child ADD CONSTRAINT FOREIGN KEY (b) REFERENCES parent(a) ON UPDATE CASCADE, ADD CONSTRAINT CHECK (b IS NOT NULL);
DROP TABLE child;
DROP TABLE parent;
CREATE TABLE t1(c1 INT, c2 INT CHECK (c2 < 10));
CREATE TABLE t2(c1 INT, c2 INT);
CREATE TRIGGER before_t2_insert BEFORE INSERT ON t2 FOR EACH ROW BEGIN INSERT INTO t1 VALUES(NEW.c1,NEW.c2); END ;
INSERT INTO t2 VALUES(1,20);
SELECT * FROM t1;
SELECT * FROM t2;
DROP TRIGGER before_t2_insert;
CREATE TRIGGER after_t2_insert AFTER INSERT ON t2 FOR EACH ROW BEGIN INSERT INTO t1 VALUES(NEW.c1,NEW.c2); END ;
...
CREATE TRIGGER before_t2_update BEFORE UPDATE ON t2 FOR EACH ROW BEGIN UPDATE t1 SET c2=NEW.c2 WHERE c1=NEW.c1; END ;
UPDATE t2 SET c2=20 WHERE c1=1;
SELECT * FROM t1;
SELECT * FROM t2;
DROP TRIGGER before_t2_update;
CREATE TRIGGER after_t2_update AFTER UPDATE ON t2 FOR EACH ROW BEGIN UPDATE t1 SET c2=NEW.c2 WHERE c1=NEW.c1; END ;
UPDATE t2 SET c2=20 WHERE c1=1;
SELECT * FROM t1;
SELECT * FROM t2;
DROP TRIGGER after_t2_update;
CREATE TRIGGER before_t1_insert BEFORE INSERT ON t1 FOR EACH ROW BEGIN IF (NEW.c2 >= 10) THEN SET NEW.c2 = 0; END IF; END ;
CREATE TRIGGER before_t1_update BEFORE UPDATE ON t1 FOR EACH ROW BEGIN IF (NEW.c2 >= 10) THEN SET NEW.c2 = 0; END IF; END ;
...
CREATE PROCEDURE proc1 (IN val1 INT) BEGIN IF val1 < 10 THEN SIGNAL SQLSTATE '45000'       SET MESSAGE_TEXT = 'check constraint on c1 failed'; END IF; END ;
CREATE TRIGGER before_t1_insert BEFORE INSERT ON t1 FOR EACH ROW BEGIN CALL proc1(new.c1); END ;
...
CREATE DATABASE test1;
USE test1;
CREATE TABLE t1 ( c1 BIT(7) CHECK(c1 < B'1111100') NOT ENFORCED, c2 BOOLEAN CHECK(c2 > 0) NOT ENFORCED, c3 TINYINT CHECK(c3 > 10) NOT ENFORCED, c4 SMALLINT CHECK(c4 > 10) NOT ENFORCED, c5 MEDIUMINT CHECK(c5 > 10) NOT ENFORCED, c6 INT CHECK(c6 > 10), c7 BIGINT CHECK(c7 > 10), c8 DECIMAL(6,2) CHECK(c8 > 10.1), c9 FLOAT(6,2) CHECK(c9 > 10.1), c10 DOUBLE(6,2) CHECK(c10 > 10.1), c11 CHAR(6) CHECK (c11 IS NULL));
SHOW CREATE TABLE t1;
DROP DATABASE test1;
USE test1;
SHOW CREATE TABLE t1;
INSERT INTO t1(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10) VALUES(B'1111111',0,5,5,5,1,1,1.2,1.2,1.2);
INSERT INTO t1(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10) VALUES(B'1111111',0,5,5,5,11,11,10.2,10.2,10.2);
SELECT * FROM t1;
DROP TABLE t1;
DROP DATABASE test1;
CREATE DATABASE test2;
USE test2;
CREATE TABLE t2 ( c1 BIT(7) CHECK(c1 < B'1111100'), c2 BOOLEAN CHECK(c2 > 0), c3 TINYINT CHECK(c3 > 10), c4 SMALLINT CHECK(c4 > 10), c5 MEDIUMINT CHECK(c5 > 10), c6 INT CHECK(c6 > 10) NOT ENFORCED, c7 BIGINT CHECK(c7 > 10) NOT ENFORCED, c8 DECIMAL(6,2) CHECK(c8 > 10.1) NOT ENFORCED, c9 FLOAT(6,2) CHECK(c9 > 10.1) NOT ENFORCED, c10 DOUBLE(6,2) CHECK(c10 > 10.1) NOT ENFORCED);
SHOW CREATE TABLE t2;
DROP DATABASE test2;
USE test2;
SHOW CREATE TABLE t2;
INSERT INTO t2(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10) VALUES(B'1111000',0,10,10,10,5,5,9.1,9.1,9.1);
INSERT INTO t2(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10) VALUES(B'1111000',1,11,11,11,5,5,9.1,9.1,9.1);
SELECT * FROM t2;
DROP TABLE t2;
DROP DATABASE test2;
USE test;
...
SET AUTOCOMMIT = ON;
DROP TABLE t1,t2;
CREATE TABLE t1( d DATE NOT NULL CHECK(YEAR(d) > '1950') ) PARTITION BY RANGE( YEAR(d) ) ( PARTITION p0 VALUES LESS THAN (1960), PARTITION p1 VALUES LESS THAN (1970), PARTITION p2 VALUES LESS THAN (1980), PARTITION p3 VALUES LESS THAN (1990) );
SHOW CREATE TABLE t1;
INSERT INTO t1 VALUES('1940-01-01');
INSERT INTO t1 VALUES('1960-01-01');
SELECT * FROM t1;
DROP TABLE t1;
CREATE TABLE t1( id INT NOT NULL CHECK(id BETWEEN 10 AND 50), name VARCHAR(10) ) PARTITION BY LIST(id) ( PARTITION p0 VALUES IN (10,19), PARTITION p1 VALUES IN (20,29), PARTITION p2 VALUES IN (30,39), PARTITION p3 VALUES IN (40,49) );
SHOW CREATE TABLE t1;
INSERT INTO t1 VALUES(60,'aaa');
INSERT INTO t1 VALUES(30,'aaa');
SELECT * FROM t1;
DROP TABLE t1;
CREATE TABLE t1(id INT NOT NULL CHECK(id > 10), name VARCHAR(40) ) PARTITION BY HASH(id) PARTITIONS 4;
SHOW CREATE TABLE t1;
INSERT INTO t1 VALUES(1,'aaa');
INSERT INTO t1 VALUES(60,'aaa');
SELECT * FROM t1;
DROP TABLE t1;
CREATE TABLE t1(id INT PRIMARY KEY NOT NULL CHECK(id > 10), name VARCHAR(40) ) PARTITION BY KEY() PARTITIONS 4;
SHOW CREATE TABLE t1;
INSERT INTO t1 VALUES(1,'aaa');
INSERT INTO t1 VALUES(60,'aaa');
SELECT * FROM t1;
...
CREATE TABLE tst ( id INT, start_date DATE, end_date DATE, PRIMARY KEY (id), CONSTRAINT chk_dat CHECK (end_date > start_date) );
...
SHOW CREATE TABLE t1;
DROP TABLE t1;
CREATE TABLE tst ( id INT, start_date DATE, end_date DATE, created DATE DEFAULT (CURDATE()), PRIMARY KEY (id), CONSTRAINT chk_dat CHECK (start_date >= created) );
INSERT INTO tst (id, start_date) VALUES (1, CURDATE());
INSERT INTO tst (id, start_date) VALUES (2, '2019-04-25');
DROP TABLE tst;
SET TIME_ZONE = "+00:00";
SET TIMESTAMP=1557251462;
CREATE TABLE tst (id INT PRIMARY KEY, scol DATE DEFAULT(CURDATE()), col DATE, CHECK ( scol < col));
...
SELECT * FROM tmp INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt';;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt' INTO TABLE tst(id, col);;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.xml" INTO TABLE tst(id, col);;
DROP TABLE tmp;
DELETE FROM tst;
...
DROP TABLE tmp;
DELETE FROM tst;
ALTER TABLE tst MODIFY COLUMN scol timestamp DEFAULT(CURRENT_TIMESTAMP()), MODIFY COLUMN col  timestamp;
SHOW CREATE TABLE tst;
...
DELETE FROM tst1;
SET TIMESTAMP=1557251462;
ALTER TABLE tst MODIFY COLUMN scol datetime DEFAULT(CURRENT_TIMESTAMP()), MODIFY COLUMN col  datetime;
SHOW CREATE TABLE tst;
INSERT INTO tst(id, col) VALUES (1, '2019-05-20 12:12:12');
INSERT INTO tst(id, col) VALUES (1, '2019-05-06 12:12:12');
REPLACE INTO tst(id, col) VALUES (2, '2019-05-06 12:12:12');
...
CREATE TABLE tst (id INT PRIMARY KEY, scol INT DEFAULT(col * col), col INT, CHECK ( scol < col));
SHOW CREATE TABLE tst;
...
INSERT INTO t2 VALUES (1);
SELECT * FROM t2 INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt';;
DELETE FROM t1 WHERE f1 = 1;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt' INTO TABLE v1(f1);;
DELETE FROM t1 WHERE f1 = 1;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.xml" INTO TABLE v1(f1);;
DELETE FROM t2;
...
SELECT * FROM t2 INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt';;
LOAD DATA INFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt' IGNORE INTO TABLE t1;;
SHOW WARNINGS;
SELECT * FROM t1;
DELETE FROM t1;
SELECT * FROM t2 INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt' FIELDS TERMINATED BY '' ENCLOSED BY '';;
LOAD DATA INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.txt" IGNORE INTO TABLE t1 FIELDS TERMINATED BY '' ENCLOSED BY '';;
SHOW WARNINGS;
SELECT * FROM t1;
DELETE FROM t1;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.xml" IGNORE INTO TABLE t1;;
SHOW WARNINGS;
SELECT * FROM t1;
DELETE FROM t1;
CREATE VIEW v1 AS SELECT f1, f2 FROM t1 WHERE f1 < 10 WITH CHECK OPTION;
LOAD XML INFILE "/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/tmp1.xml" IGNORE INTO TABLE v1;;
SHOW WARNINGS;
SELECT * FROM v1;
DROP VIEW v1;
DROP TABLE t1, t2;
...
SHOW CREATE TABLE t1;
DROP TABLE t1;
CREATE TABLE t1 (f1 INT, f2 INT, f3 INT, f4 FLOAT AS (f3 * 0.01), f5 INT, CHECK (f1 < f2));
SHOW CREATE TABLE t1;
ALTER TABLE t1 DROP COLUMN f1;
...
SHOW CREATE TABLE t1;
ALTER TABLE t1 DROP CONSTRAINT t1_chk_1, RENAME COLUMN f1 to f11, ADD CONSTRAINT t1_chk_1 CHECK (f11 < 10);
SHOW CREATE TABLE t1;
DROP TABLE t1;
