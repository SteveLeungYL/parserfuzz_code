...
ALTER TABLE t1 DROP CONSTRAINT f2_check;
CREATE PROCEDURE drop_constraint_proc() ALTER TABLE t1 DROP CONSTRAINT `primary`, DROP CONSTRAINT f2_unique, DROP CONSTRAINT fk, DROP CONSTRAINT f2_check;
CREATE PROCEDURE alter_constraint_proc() ALTER TABLE t1 ALTER CONSTRAINT f2_check NOT ENFORCED;
ALTER TABLE t1 ADD CONSTRAINT PRIMARY KEY (f1), ADD CONSTRAINT f2_unique UNIQUE(f2), ADD CONSTRAINT fk FOREIGN KEY (f1) REFERENCES t2(f1), ADD CONSTRAINT f2_check CHECK (f2 > 0);
SHOW CREATE TABLE t1;
...
DROP PROCEDURE drop_constraint_proc;
ALTER TABLE t1 ADD COLUMN f3 INT GENERATED ALWAYS AS (f1) STORED;
CREATE PROCEDURE alter_constraint_proc() ALTER TABLE t1 ALTER CONSTRAINT constraint_name NOT ENFORCED;
CREATE PROCEDURE test_alter_constraint() BEGIN DECLARE CONTINUE HANDLER FOR SQLEXCEPTION SELECT "Error ER_ALTER_CONSTRAINT_ENFORCEMENT_NOT_SUPPORTED is reported."     AS error_message; ALTER TABLE t1 ADD CONSTRAINT constraint_name UNIQUE(f2); call alter_constraint_proc(); ALTER TABLE t1 DROP CONSTRAINT constraint_name, ADD UNIQUE INDEX constraint_name (((COS(f3))) DESC); call alter_constraint_proc(); ALTER TABLE t1 DROP CONSTRAINT constraint_name, ADD CONSTRAINT constraint_name FOREIGN KEY (f1) REFERENCES t2(f1); call alter_constraint_proc(); ALTER TABLE t1 DROP CONSTRAINT constraint_name, ADD CONSTRAINT constraint_name CHECK (f2 > 0); call alter_constraint_proc(); ALTER TABLE t1 DROP CONSTRAINT constraint_name; END; ;
