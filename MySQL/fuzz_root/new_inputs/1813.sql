...
DROP TABLE t;
DROP VIEW v;
CREATE TABLE t1 ( a int(11) DEFAULT NULL, b int(11) DEFAULT NULL, c int(11) DEFAULT NULL ) ENGINE=InnoDB;
INSERT INTO t1 VALUES (1,1,1),(1,2,1),(1,3,0), (1,4,0),(2,1,1),(2,2,1),(2,3,0),(2,4,0);
set @previous_sql_mode_htnt542nh=@@sql_mode;
set sql_mode=(select replace(@@sql_mode,'ONLY_FULL_GROUP_BY',''));
SET @optimizer_switch_saved= @@optimizer_switch;
SET @@optimizer_switch="derived_merge=off";
SELECT DISTINCT a, b FROM (SELECT * FROM t1 ORDER BY a, b) AS f GROUP BY a,c;
SELECT DISTINCT a, b, 0 FROM (SELECT * FROM t1 ORDER BY a, b) AS f GROUP BY a,c;
SET @@optimizer_switch=@optimizer_switch_saved;
set @@sql_mode=@previous_sql_mode_htnt542nh;
DROP TABLE t1;
CREATE TABLE t1 ( pk INT NOT NULL, col_varchar_key VARCHAR(1), col_varchar_nokey VARCHAR(1), PRIMARY KEY (pk), KEY col_varchar_key (col_varchar_key) );
...
CREATE TABLE t2 ( pk INT NOT NULL, col_int_nokey INT, col_varchar_key VARCHAR(1), PRIMARY KEY (pk), KEY col_varchar_key (col_varchar_key) );
