...
SELECT user_id, my_median(value) FROM user_values GROUP BY user_id;
SELECT users.id, my_median(value) FROM users,user_values WHERE users.id = user_values.user_id GROUP BY users.id;
SELECT users.id, my_median(value) FROM users,user_values WHERE users.id = user_values.user_id GROUP BY users.id;
prepare ps from "SELECT users.id, my_median(value) FROM users,user_values WHERE users.id = user_values.user_id GROUP BY users.id";
execute ps;
execute ps;
