...
CREATE SQL SECURITY INVOKER VIEW test1.v1_none AS SELECT * FROM test1.t1;
CREATE SQL SECURITY INVOKER VIEW test1.v1_all AS SELECT * FROM test1.t1;
GRANT SELECT,INSERT,UPDATE,DELETE ON test1.v1_all TO user1@localhost;
CREATE SQL SECURITY INVOKER VIEW test1.v1_same AS SELECT * FROM test1.t1;
...
CREATE SQL SECURITY INVOKER VIEW test1.v1_cross AS SELECT * FROM test1.t1;
...
CREATE SQL SECURITY INVOKER VIEW test1.v1_middle AS SELECT * FROM test1.t1;
GRANT SELECT(cus) ON test1.v1_middle TO user1@localhost;
CREATE SQL SECURITY INVOKER VIEW test1.v1_multi AS SELECT * FROM test1.v1_middle;
...
CREATE SQL SECURITY INVOKER VIEW test1.v1_renamed AS SELECT cn AS cs, cn AS cx, cs AS cus, cs AS cy FROM test1.t1;
...
INSERT INTO test1.t1(ci) SELECT 'i' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
INSERT INTO test1.t1(ci) SELECT 'i' FROM test1.single ON DUPLICATE KEY UPDATE cn='u';
...
INSERT INTO test1.v1_none(ci) SELECT 'x' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
INSERT INTO test1.v1_all(ci) SELECT 'j' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
INSERT INTO test1.v1_all(cn) SELECT 'x' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
INSERT INTO test1.v1_all(ci) VALUES('x') ON DUPLICATE KEY UPDATE cn='u';
INSERT INTO test1.v1_all(ci) SELECT 'x' FROM test1.single ON DUPLICATE KEY UPDATE cn='u';
...
INSERT INTO test1.v1_same(ci) SELECT 'k' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
INSERT INTO test1.v1_cross(ci) SELECT 'k' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
INSERT INTO test1.v1_multi(ci) SELECT 'x' FROM test1.single ON DUPLICATE KEY UPDATE cu='u';
...
CREATE DEFINER=user1@localhost SQL SECURITY DEFINER VIEW test1.v1_none AS SELECT cs FROM test1.t1;
CREATE DEFINER=user1@localhost SQL SECURITY DEFINER VIEW test1.v1_middle AS SELECT cs FROM test1.t1;
CREATE DEFINER=user1@localhost SQL SECURITY DEFINER VIEW test1.v1_multi AS SELECT * FROM test1.v1_middle;
...
SELECT a INTO OUTFILE '/data/yu/Squirrel_DBMS_Fuzzing/MySQL_source/mysql-server-inst/bld/mysql-test/var/tmp/datadict.out' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' FROM v1;
show session status;
