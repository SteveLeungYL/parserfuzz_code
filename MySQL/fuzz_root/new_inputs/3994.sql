...
select json_extract(trace,"$.steps[*].statement_parameters") from information_schema.optimizer_trace;
CREATE TABLE articles ( title VARCHAR(200), body TEXT, FULLTEXT (title,body) );
...
select json_extract(trace,"$.steps[*].statement_parameters") from information_schema.optimizer_trace;
set @a=0b1111111111111111111111111111111111111111111111111111111111111111111111, @b=0b1111111111111111111111111111111111111111111111111111111111111111111111;
execute s using @a,@b;
set @a=0b1111111111111111111111111111111111111111111111111111111111111111111111, @b=31;
execute s using @a,@b;
set @a=31, @b=31;
execute s using @a,@b;
set @a=0b1111111111111111111111111111111111111111111111111111111111111111111111, @b=0b1111111111111111111111111111111111111111111111111111111111111111111111;
...
select json_extract(trace,"$.steps[*].statement_parameters") from information_schema.optimizer_trace;
set @a= '[{"a":"3"},{"a":2},{"b":1},{"a":0},{"a":[1,2]}]';
flush status;
execute s using @a;
show status like "Com_stmt_reprepare";
set @a= cast('[{"a":"3"},{"a":2},{"b":1},{"a":0},{"a":[1,2]}]' as json);
flush status;
execute s using @a;
show status like "Com_stmt_reprepare";
...
select json_extract(trace,"$.steps[*].statement_parameters") from information_schema.optimizer_trace;
DROP TABLE t1,t2;
CREATE TABLE t1 (i1 TINYINT, i2 SMALLINT, i3 MEDIUMINT, i4 INTEGER, i8 BIGINT, dc1 DECIMAL(6,0), dc2 DECIMAL(16,10) );
...
DROP TABLE t1;
CREATE TABLE t1 (pk INTEGER, i1 TINYINT, i2 SMALLINT, i3 MEDIUMINT, i4 INTEGER, i8 BIGINT, i1u TINYINT UNSIGNED, i2u SMALLINT UNSIGNED, i3u MEDIUMINT UNSIGNED, i4u INTEGER UNSIGNED, i8u BIGINT UNSIGNED, dc DECIMAL(16,10), f4 FLOAT, f8 DOUBLE, vc VARCHAR(10), fc CHAR(10), vb VARBINARY(10), fb BINARY(10), d DATE, t TIME(6), dt DATETIME(6), ts TIMESTAMP(6) );
...
CREATE TABLE t1 ( col1 VARCHAR(100) NOT NULL COLLATE latin1_swedish_ci, col2 VARCHAR(200) NOT NULL COLLATE utf8mb4_general_ci );
