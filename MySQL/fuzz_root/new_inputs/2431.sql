...
SELECT GREATEST(a, b), GREATEST(a, c), GREATEST(a, d), GREATEST(a, e), GREATEST(a, f) FROM t1;
SET @a=NULL;
DROP TABLE t1;
...
SELECT count(greatest(18446744073709551615, NULL)) FROM t0017;
DROP TABLE t0017;
SET sql_mode = default;
